...
SELECT  ID, Branch_name, Category, Product_description, Product_name,   
 ...
 FROM equipment  WHERE BRANCH_NAME = '#SESSION.branch#'
</cfquery>
<CFSET mylist ="0">
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#SESSION.branch#</cfoutput> Oil Change Log - <cfoutput>#get_oil_changes.recordcount#</cfoutput> Oil Changes </h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="active"> <cfoutput>#SESSION.branch#</cfoutput> Branch Oil Change Log</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
...
WHERE  ID =  #Equipment_ID#
                      ...
                      <td>#get_equipment_info_cache.equipment_id#</td>
