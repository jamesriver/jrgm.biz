...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#SESSION.branch#</cfoutput> Branch Employees Usernames &amp; Passwords</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="active"> <cfoutput>#SESSION.branch#</cfoutput> Branch Employees Usernames &amp; Passwords</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
  ...
  <div class="page-content">
    <div class="container-fluid"> 
      ...
      <table class="table table-striped table-bordered table-hover" id="sample_3">                <thead>
                  <tr>
                  <th>Last Name</th>
