...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Employees that answered "I do not agree" to injury signout question.</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
  ...
  <div class="page-content">
    <div class="container-fluid"> 
        ...
        SELECT * FROM 
       app_employee_payroll_clock WHERE CompleteHours =0  AND  ((Supervisor IN (#mylistsupers#)  OR  Supervisor = #SESSION.userid#)) 
