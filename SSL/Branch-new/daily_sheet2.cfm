      ...
      <div class="row">
        <div class="col-md-6">
          <table class="table large">
            ...
            <tr>
             <td><strong>Branch: <cfoutput>#SESSION.branch#</cfoutput></strong></td>
              ...
              <tr>
                ...
                <cfif ((ds_date LTE  yesterday) OR  ((ds_date EQ  todaydate_DS))  AND timenow GT today_3PM) AND get_open_workers.recordcount  EQ 0>
                  ...
                  <td ><cfif get_ds.ds_approved EQ 1>
                      <cfoutput><a href="daily_sheet2.cfm?dsid=#get_ds.ID#&email=yes&unapprove=yes" class="btn red">Unapprove</a></cfoutput>
                      <cfelse>
                      <cfoutput><a href="daily_sheet_edit2.cfm?dsid=#get_ds.ID#"  class="btn btn-primary">Edit </a><a href="daily_sheet2.cfm?dsid=#get_ds.ID#&email=yes&approve=yes" class="btn btn-success">Approve</a></cfoutput>
                    </cfif></td>
                </cfif>
              </tr>
            </tbody>
        ...
        <div class="col-md-6">
          <table class="table large">
            <tr>
              ...
              <td nowrap="nowrap"><strong>Branch : <cfoutput>#SESSION.branch#</cfoutput></strong></td>
