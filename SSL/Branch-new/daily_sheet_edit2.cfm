...
<CFSET dsid= get_ds.id>
<cfquery name="get_supervisor" dbtype="query">
SELECT   employee_id, fullname AS EMPLOYEENAME ,branch FROM get_all_employees WHERE employee_id=   #supervisor_id#    
</cfquery>
<cfquery name="get_crew_leader"  dbtype="query">
SELECT  employee_id, fullname AS EMPLOYEENAME  FROM get_all_employees WHERE employee_id=    #crew_leader_id#   
</cfquery>
...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
      ...
      <cfif IsDefined("url.message")>
        ...
        <br>
        <br>
        <h2 class="text-danger">Please add all employees to the new daily sheet first and then add jobs.</h2>
      </cfif>
      <!---<br>
        <br>
        <br>
  ...
  <div class="page-content">
    ...
    <div class="row">
      <div class="col-md-12">
     <h4 class="panel-title"><H4> Employee Time  </h4><br>
...
WHERE Employee_ID =#get_employees_for_Crew_Leader.Employee_ID# AND ds_id = #dsid# AND in_out_status =1
      ...
      <div class="row"><br>
        ...
        <div class="col-md-12"> 
          ...
          <h4 class="panel-title"><H4> Job Service Information </h4><br>
   ...
   It needs to loop through the each employee job_services  ---> 
      ...
      <cfif  get_this_job.recordcount GT 0 >
       <h4 class="panel-title"><H4> Job Service Detail Information </h4><br>
