<cfif IsDefined("form.ds_id") AND  IsDefined("form.submit")>
  <cfif  form.QUANTITY_USED  IS "">
    <cfoutput>
      <cflocation url="daily_sheet_edit_add_materials2.cfm?dsid=#ds_id#&job_clock_id=#form.job_clock_id#&error=qty">
    </cfoutput>
  </cfif>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <form   method="post" action="daily_sheet_edit_add_materials2.cfm" >
