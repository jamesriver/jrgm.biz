        ...
        <div class="col-md-12">
          <form action="inventory_list.cfm" method="post">
            <table class="table large" >
              <tbody>
                <tr>
                  <td colspan="4"><input type="text" name="criteria" class="form-control input-inline input-medium" placeholder="Search">
                    &nbsp;&nbsp;
                    <input type="submit" value="Search Equipment" class="btn btn-primary"></td>
                </tr>
                <tr>
                  <td nowrap="nowrap"><strong>Category:&nbsp;&nbsp;
                    <select name="Category" class="bs-select form-control input-small"  tabindex="5" onchange='this.form.submit()'>
                      ...
                      <option value="IT"  <cfif session.categorysearch EQ 'Weedeaters'> selected="selected"</cfif>>IT</option>
                    </select>
                    </strong></td>
                  <td><label class="control-label"><strong>Year:</strong></label>
                    <strong>
...
WHERE    APP_employees.Branch = '#session.branch#'
   ORDER by  Last_name ASC,first_name ASC
                    ...
                    <select name="crew_assignment_last"  class="bs-select form-control input-medium" tabindex="5"  onchange='this.form.submit()' >
                ...
                <table class="table table-striped table-hover" id="sample_5">
                  <thead>
                    <tr>
                      ...
                      <th>Serial #</th>
                      <th>Year</th>
                      <th><div align="center">Mileage/<br>
                          Hours</div></th>
                      <th>Branch</th>
                      <th>Status</th>
                      <th>History<br>
                  ...
                  <tbody>
                    <cfoutput query="getequipment">
                      <tr>
                        ...
                        <td><a href="history_allocation.cfm?ID=#ID#">Allocate</a></td>
