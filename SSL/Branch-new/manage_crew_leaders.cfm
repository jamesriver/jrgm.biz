...
Generally changing positions should not be done during the work day when crews have been timed into the APP. <br />
 Please try and make changes before or after the work day.<br>
<br>
     ...
     <table class="table table-striped table-hover" id="sample_5">
        ...
        <tr>
          <td valign="top"><span class="caption-subject font-green-sharp bold uppercase">Current Crew Leaders</span>
...
AND access_role = 2
 ORDER by  Lastname ASC,firstname ASC
      ...
      <td valign="top">
         <span class="caption-subject font-green-sharp bold uppercase">Current Non-Crew Leaders</span>  
                        <table class="table table-striped table-hover" id="sample_5">
                              <tr>
                                <th align="left" nowrap="nowrap">First Name</th>
                                <th align="left" nowrap="nowrap">Last Name</th>
