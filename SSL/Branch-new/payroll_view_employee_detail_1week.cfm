...
<cfset tomorrow = dateadd("d",1,somedate)>
 ...
 <cfquery name="get_employees_with_time" datasource="jrgm"  >
		...
		WHERE branch = '#SESSION.branch#'  AND (app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' AND app_employee_payroll_clock.Time_Out < '#DateFormat(pay_period_end_week_plusone, 'yyyy-mm-dd')#')   <!--- AND employee_id =2714  --->
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Payroll Period Week ###app_payroll_periods.pay_period_week#&nbsp; #DateFormat("#pay_period_start#", "mm/dd/yyyy")#-
...
SELECT  Employee_ID , SUM(time_worked) As sumdailytime, in_out_status,ds_date 
 ...
 GROUP by Employee_ID, ds_date, in_out_status
       ...
       AND payroll_approved IS NULL
         ...
         <td <cfif is_already_approved.recordcount  GT 0> </cfif>><div align="center">
