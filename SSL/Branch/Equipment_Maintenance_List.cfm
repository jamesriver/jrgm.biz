...
<div id="centrecontent">
  ...
  <div class="centrecontent_inner">
   ...
   <div class="header">Equipment Maintenance List</div>
...
FROM APP_employees WHERE [Employee ID] =#get_daily_sheets.supervisor_id#
            ...
            <tr>
              ...
              <td><a href="Equipment_Maintenance_Form.cfm" target="_blank">View</a></td>
            </tr>
            <tr>
              ...
              <td><a href="Equipment_Maintenance_Form.cfm" target="_blank">View</a><a href="Evening_Inspection_Form.cfm" target="_blank"></a></td>
            </tr>
            <tr>
