  ...
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
          <tr>
            <td align="left" class="dailysheetEdit"> Are you sure you want to delete <cfoutput>#get_employee.employeename#</cfoutput> from this daily sheet? <br />
              <cfoutput><a href="daily_sheet_edit_employee_time1.cfm?deleteme=yes&Employee_ID=#url.Employee_ID#&ds_id=#ds_id#" class="YesNoButton"> Yes</a> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_employee_time1.cfm?Employee_ID=#url.Employee_ID#&ds_id=#ds_id#" class="YesNoButton">No</a>
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
          <tr>
            <td align="left" class="dailysheetEdit"> Are you sure you want to delete this row for <cfoutput>#get_employee.employeename#</cfoutput> from this daily sheet? <br />
              <cfoutput><a href="daily_sheet_edit_employee_time1.cfm?deletemerow=yes&Employee_ID=#url.Employee_ID#&ds_id=#ds_id#&rowid=#rowid#" class="YesNoButton"> Yes</a> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_employee_time1.cfm?Employee_ID=#url.Employee_ID#&ds_id=#ds_id#" class="YesNoButton">No</a>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><table border="0" cellpadding="0" cellspacing="0" >
              ...
              <tr> </tr>
              <tr> <cfoutput>
                  <td colspan="6" align="left" nowrap="nowrap" class="greentype"><a href="daily_sheet_edit_employee_time1.cfm?addrow=yes&ds_id=#ds_id#&Employee_ID=#Employee_ID#"><img src="images/add.png" width="20" height="20" /></a>&nbsp;&nbsp;Add
      ...
      <table border="0" cellspacing="5" cellpadding="0">
        <tr> <cfoutput>
            <td><a href="daily_sheet_edit_employee_time1.cfm?ds_id=#ds_id#&Employee_ID=#Employee_ID#&delete=yes"  class="removebutton">Remove this Employee</a></td>
            <td>&nbsp;</td>
...
<!---  <cfif  Session.userid EQ 1433  OR  Session.userid EQ 1001026> --->
     ...
     <!---    </cfif> --->
        <br />
        <tr>
          <td colspan="5" align="center"><cfoutput><span class="redarial"><strong>#message#</strong></span></cfoutput>&nbsp;</td>
        </tr>
      </table>
    </div>
  </div>
