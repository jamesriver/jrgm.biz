...
FROM   get_all_employee_info WHERE employee_ID =#get_UA_daily_sheets_for_RM.Crew_Leader_ID#
 ...
 FROM app_pay_periods WHERE pay_period_week = #pay_period_week2#
		...
		WHERE branch = '#SESSION.branch#'  
        AND 
        (app_employee_payroll_clock.Time_In > '#app_payroll_periods2.pay_period_start# 00:00:00.000' AND app_employee_payroll_clock.Time_Out < '#DateFormat(pay_period_start_week2, "yyyy-mm-dd")# 00:00:00.000')
		ORDER by APP_employees.last_name
  </cfquery>
              <CFSET mylist ="0">
...
SELECT * FROM equipment WHERE  inventory_status = 2  AND Branch_name = '#SESSION.branch#' 
              ...
              <div class="alertsSub">Pending Repair <cfoutput>(#get_this_equipment_in_repair_pending.recordcount#)</cfoutput></div>
...
WHERE  employee_ID =  #Crew_assignment_last# 
                          ...
                          <td align="left">#get_branch_employees_cache.employee_name#</td>
                        </cfif>
...
ORDER by ID DESC
              ...
              <div class="alertsSub">Currently In Repair <cfoutput> (#get_this_equipment_in_repair.recordcount#)</cfoutput></div>
...
ORDER by repair_last_completed_date DESC
              ...
              <div class="alertsSub">Recently Completed Repairs with Status &quot;Completed Repair&quot; -&nbsp; These Need a Status Change <cfoutput>(#get_this_equipment_in_repair_recent.recordcount#)</cfoutput></div>
...
WHERE  employee_ID =  #Crew_assignment_last# 
            ...
            <div id="tabs-4">
              ...
              <span class="alertnofields">Employees that answered &quot;I do not agree&quot; to hours signout question</span>&nbsp; <br />
(Showing last 20 in 2015)<br />
              <div class="spacer10"></div>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sortable">
                <thead>
                  <tr>
...
FROM   get_all_employee_info WHERE employee_ID =#get_employees_CompleteHours.supervisor#
                    ...
                    <tr>
                      ...
                      <td nowrap="nowrap">#get_employees_name.employee_name#</td>
              ...
              <span class="alertnofields">Employees that answered &quot;I do not agree&quot; to injury signout question</span>&nbsp; <br />
(Showing last 20 in 2015)<br />
              <div class="spacer10"></div>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sortable">
                <thead>
...
FROM   get_all_employee_info WHERE employee_ID =#get_employees_injury.supervisor#
                    ...
                    <tr>
                      ...
                      <td nowrap="nowrap" align="left">#get_employees_name.employee_name#</td>
                      <td nowrap="nowrap">#get_info_S.last_name#</td>
                      <td nowrap="nowrap">#get_info_CL.last_name#</td>
                    </tr>
                  </cfoutput>
 ...
 > </p>
  ...
  WHERE  inventory_user =  #SESSION.userid#  AND  inventory_status = 0
              ...
              <cfif see_if_pended.recordcount EQ 0>
                <p><a href="inventory_report_printable_eversion1.cfm" target="_blank">Start an Equipment  Inventory Report </a>(Electronic)</p>
                <cfelse>
