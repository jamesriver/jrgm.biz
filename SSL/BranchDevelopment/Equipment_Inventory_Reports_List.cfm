      ...
      <table class="sortable" cellpadding="0" cellspacing="0" width="95%">
        ...
        <tbody>
          <cfoutput  query="get_einventories"  >
            <tr>
              <td><a href="inventory_list_printable_eversion1_output.cfm?ID=#ID#">#id#</a></td>
...
WHERE  employee_ID =  #inventory_filter# 
 ...
 <cfif  get_branch_employees_cache2.recordcount EQ 0>
              <td>All</td>
              <cfelse>
...
WHERE  employee_ID =  #inventory_user# 
               ...
               <td><a href="inventory_list_printable_eversion1_output.cfm?ID=#ID#" >View</a></td>
            </tr>
          </cfoutput>
        </tbody>
      </table>
