...
<!---    <cfquery name="delete_employee_time_NULL" datasource="jrgm">
  DELETE FROM app_employee_payroll_clock
   WHERE  DS_ID =#url.dsid# AND Time_in IS NULL
   </cfquery>
 --->
<!--- <CFIF REMOTE_HOST NEQ '127.0.0.1'>
 <cfif IsDefined("url.email")>
 <cfmail to="pat@1design.com" from="pat@429designs.com"  subject="JRGM Edit Branch DS-#SESSION.BRANCH#-#url.dsid#"  type="html">
Daily Sheet #url.dsid# is being Edited (#SESSION.BRANCH#).
  </cfmail>
  </cfif>
</CFIF> --->
