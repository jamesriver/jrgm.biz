...
SELECT [Employee ID] AS Employee_ID,position,[Name FirstLast] AS Employee_Name  FROM APP_employees WHERE   [Employee ID] IN (#mylist#)
            ...
            <td width="50"></td>
            <td>&nbsp;</td>
            <td valign="top"><cfquery name="get_all_employees_select" datasource="jrgm">
            ...
            <td valign="top"><input type="submit" name="submit" id="button" value="Add to Crew" class="bluebutton" />          </td>
          </tr>
          <cfoutput>
