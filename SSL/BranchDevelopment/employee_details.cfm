...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
      <tr>
      <td><span class="header">All Notes for <cfoutput>#get_employee_info.employeename#</cfoutput></span><br />
<br />
...
<cfif get_auth_info.EmployeeID NEQ 0>
     ...
     <cfelse> <td nowrap="nowrap">-</td>
     </cfif>
     <td align="left" >#note_content#</td>
    <td align="center" ><a href="employee_details.cfm?deleteme=notsure&employee_id=#employee_id#&work_date=#work_date#&noteid=#get_job_notes.ID#"><img src="images/del.png" width="12" height="12" /></a></td>
  </tr></cfoutput>
 </tbody>
</table>  
