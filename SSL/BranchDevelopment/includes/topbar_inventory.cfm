...
<div class="topbar">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="jobbutton"><div class="btn-group"> <a data-toggle="dropdown" data-hover="dropdown"><img src="images/icon_payroll.png" width="60" height="60" /> </a>
        ...
        <!-- .btn-group -->
        <div class="btn-group"> <a data-toggle="dropdown" data-hover="dropdown"><img src="images/icon_dailysheet.png" width="60" height="60"  class="icons10"/></a>
          <ul class="dropdown-menu">
