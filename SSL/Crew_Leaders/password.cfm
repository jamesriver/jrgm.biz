...
<div id="outerfull">
  ...
  <tr>
    <td class="details_desc">Enter Current Password</td>
    <td class="details_desc"><img src="images/clear.gif" width="20" height="1" /></td>
    <td class="details_desc"> <input name="current_password" type="text" class="textbox" id="current_password" placeholder="" size="30"  /></td>
  </tr>
  <td class="details_desc">New Password</td>
  <td class="details_desc"></td>
    <td class="details_desc"> <input name="new_password" type="text" class="textbox" id="new_password" placeholder="" size="30"  /></td>
  <tr>
    <td class="details_desc">Re-Enter New Password</td>
    <td class="details_desc"></td>
    <td class="details_desc"> <input name="new_password" type="text" class="textbox" id="new_password" placeholder="" size="30"  /></td>
      <tr>
        <td class="details_desc">&nbsp;</td>
        <td class="details_desc"></td>
        <td class="details_desc"> <input type="submit" name="password"   value="SUBMIT" class="bluebutton" /></td>
      </table>
