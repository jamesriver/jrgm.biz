								...
								<div class="form-body">
									<div class="form-group">
										...
										<!---<div class="col-md-8"><label class="control-label">
											<cfif getequipment_this.Crew_assignment_last  EQ 3> Spare
											<cfelseif getequipment_this.Crew_assignment_last  EQ 5>Seasonal
											<cfelseif getequipment_this.Crew_assignment_last  EQ 6>Lost
                                            <cfelse>
                  <cfoutput > #get_allocated_employee.fullname#</cfoutput></cfif></label>
										</div>--->
                                        
                                      <!---  <form action="history_allocation.cfm"  name="allocateform" method="post">    --->
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" nowrap="nowrap"><label class="control-label col-md-3">Allocated to:</label></td>
                <td>
                <cfif getequipment_this.Crew_assignment_last  EQ 3> Spare
				<cfelseif getequipment_this.Crew_assignment_last  EQ 5>Seasonal
                <cfelseif getequipment_this.Crew_assignment_last  EQ 6>Lost<cfelse>
