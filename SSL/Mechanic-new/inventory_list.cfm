...
ORDER by  ID ASC
      ...
      <div class="page-title">
        <h1><cfoutput>#branchlistalt#</cfoutput> Equipment List-<cfoutput>#getequipment.recordcount#</cfoutput> Records&nbsp; &nbsp;
          (
                ...
                <tr>
                  ...
                  <td><label class="control-label">Year:</label>
                    <select name="Equipment_year" class="bs-select form-control input-small" onchange='this.form.submit()'>
                      ...
                      <option value="2016"  <cfif session.yearsearch EQ '2015'> selected="selected"</cfif>>2016</option>
...
WHERE    APP_employees.Branch   IN   (#PreserveSingleQuotes(branchlist)#)
                ...
                <table class="table table-striped table-hover" id="sample_5">
                  <thead>
                    <tr>
                      ...
                      <th>Branch</th>
                      <th>Status</th>
                      <!---             <th>History<br>Allocate<br>Oil Change<br>Inspection</th>
 --->
                      <th>Repair</th>
                      <th>Allocate<br>
                        To</th>
