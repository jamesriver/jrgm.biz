 ...
 ORDER by  ID ASC
      ...
      <cfif   IsDefined("Form.Pend")  >
        <div class="inventory-message">Your Inventory Report is Pended.<br />
          <a href="index.cfm" class="bluebutton">Go to Home Screen</a> <a href="inventory_report_printable_eversion1.cfm?Inventory_Report_ID=<cfoutput>#Inventory_Report_ID#</cfoutput>" class="bluebutton">Continue With the Report</a></div>
        <cfabort>
      </cfif>
      <cfif   IsDefined("Form.submit")  >
        <div class="inventory-message">Your Inventory Report is Submitted. <br />
          <a href="index.cfm" class="bluebutton">Go to Home Screen</a></div>
        <cfabort>
      </cfif>
      <!-- BEGIN PAGE TITLE -->
