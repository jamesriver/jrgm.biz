...
SELECT ID,Product_name,repair_log_ip,date_sent_to_mechanic FROM equipment  WHERE ID = #ID#  
</cfquery>
<!--- <cfif  get_date_sent_to_mechanic.date_sent_to_mechanic NEQ "">
<CFSET  get_date_sent_to_mechanicx = #DateFormat(get_date_sent_to_mechanic.date_sent_to_mechanic ,"mm/dd/yyyy")#>
<cfelse>
<CFSET  get_date_sent_to_mechanicx = "">
</cfif>
 --->
...
vendorName, laborHours, totalLabor, totalParts, totalCost, completionDate, recommend_replace ,repair_log_ip,repair_log_user,date_sent_to_mechanic) 
...
UPDATE equipment SET  repair_log_ip =1 WHERE ID = #ID#
  ...
  <cfif IsDefined("form.recommend_replace")  AND  form.recommend_replace EQ 1>
    <cfmail to="jbatterson@jrgm.com"    FROM="JRGM Alerts <alerts@jrgm.com>"  subject="Equipment Recommended for Replacement " type="html">
      <style type="text/css">
       .arialfont {
