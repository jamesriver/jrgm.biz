...
vendorName, laborHours, totalLabor, totalParts, totalCost, completionDate, recommend_replace ,repair_log_ip,repair_log_user) 
...
UPDATE equipment SET  repair_log_ip =1 WHERE ID = #ID#
  ...
  <cfif IsDefined("form.recommend_replace")  AND  form.recommend_replace EQ 1>
    <cfmail to="pat@1design.com"    FROM="JRGM Alerts <alerts@jrgm.com>"  subject="Equipment Recommended for Replacement " type="html">
      <style type="text/css">
       .arialfont {
        ...
        <cfoutput query="get_this_equipment">
          <table width="95%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td class="performance">Started mower and engine started smoking. After cooling off, I noticed air filter burned off.</td>
            </tr>
            <cfif IsDefined("form.inventory_status") AND form.inventory_status EQ "Y">
              <cfquery name="do_update" datasource="jrgm">
UPDATE equipment SET  repair_log_ip =0, inventory_status =1  WHERE ID = #ID#
</cfquery>
              <tr>
                <td class="performance" colspan="4">The repair is completed and Repair Log is closed. Go to <a href="default.cfm">home</a> screen.</td>
              </tr>
              <cfabort>
            </cfif>
          </table>
        ...
        <form method="post" action="repairLog.cfm">
          <table width="95%" border="0" cellpadding="0" cellspacing="0">
            <!---   <tr>
              <td valign="middle" class="performance">In repair?</td>
                 <td valign="middle" class="performance"><div class="radio">
                  ...
                  <input id="repair_Y" type="radio" name="inventory_status"  value="Y"  <cfif Session.repair_log_ip EQ 1>checked="checked"</cfif>/>
                  <label for="repair_Y">Yes</label>
                  <input id="repair_N" type="radio" name="inventory_status"  value="N"  <cfif Session.repair_log_ip NEQ 1>checked="checked"</cfif>/>
            ...
            <tr>
              ...
              <td colspan="6" valign="middle" class="performance"><textarea name="repair_description" id="repair_description" cols="50" rows="5"><cfoutput>#Session.repair_description#</cfoutput></textarea></td>
            </tr>
            <tr>
