    ...
    <div class="centrecontent_inner">
      <div class="header">
         ...
         <cfoutput query="get_this_equipment">
          <table width="95%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <cfif    repair_log_ip EQ 0>
              <tr>
                <td class="performance" colspan="4"><strong>The repair is completed and Repair Log is Closed. </strong></td>
              </tr>
              </cfif>
           </table>
        </cfoutput>
       ...
       <tr>
              ...
              <td colspan="6" valign="middle" class="performance"><br />
...
#get_repair_log_p.parts1#, #get_repair_log_p.parts2#, #get_repair_log_p.parts3#, #get_repair_log_p.parts4#, #get_repair_log_p.parts5#, #get_repair_log_p.parts6#, #get_repair_log_p.parts7#, #get_repair_log_p.parts8#
            ...
            <tr>
             ...
             <tr>
              ...
              <td colspan="6" valign="middle" class="performance">#DateFormat(completionDate, "mm/dd/yyyy")#</td>
            </tr>
           </table></cfoutput><br />
<br />
<br />
