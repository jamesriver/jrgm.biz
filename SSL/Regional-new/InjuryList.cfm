    <cfdirectory action="list" directory="C:\inetpub\websites\jrgm.biz\forms\photos\injury_reports\" name="injury_reports" recurse="true">
<!DOCTYPE html>
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="active">Injury Reports</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
...
SELECT  * FROM Form_InjuryReport   ORDER  by  IR_ID DESC
 </cfquery>
 <tbody>  
<cfoutput query="get_IR_List">  
<tr>
    <td><div align="left">#IR_ID#</div></td>
	<td nowrap="nowrap">#DateFormat("#injuryrpt_Date#", "mm/dd/yyyy")#</td>
    <td><div align="left">#injurytime#</div></td>
    <td><div align="left">#NatureOfinjury#</div></td>
