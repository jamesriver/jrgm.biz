  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#regionname#</cfoutput> Region Oil Change Due - Date</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        ...
        <li> <a href="inventory_list.cfm">Equipment</a><i class="fa fa-circle"></i> </li>
          <li class="active"> <cfoutput>#regionname#</cfoutput> Region Oil Change Due - Date</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
...
SELECT     ID,   Category,  Product_name,   Equipment_ID, 
...
FROM         equipment where hours_mileage = 3  AND inventory_status > 0 <!---AND   oil_change_date_due IS NOT NULL ---> AND Branch_name IN   (#PreserveSingleQuotes(branchlist)#)
ORDER BY ID ASC
</cfquery>     
          <!-- BEGIN EXAMPLE TABLE PORTLET-->
...
WHERE  employee_ID =  #Crew_assignment_last# 
                              ...
                              <td>#dateformat(oil_change_date_due,"mm/dd/yy")#</td>
                               <cfif  oil_change_date_due LT todayDate>
                               <td>
