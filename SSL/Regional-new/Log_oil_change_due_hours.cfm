  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#regionname#</cfoutput> Region - Oil Change Due - Hours</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
         ...
         <li> <a href="inventory_list.cfm">Equipment</a><i class="fa fa-circle"></i> </li>
          <li class="active"> <cfoutput>#regionname#</cfoutput> Region Oil Change Due - Hours</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
...
FROM         equipment where hours_mileage = 1   AND inventory_status > 0 <!---AND   oil_change_date_due IS NOT NULL ---> AND Branch_name IN   (#PreserveSingleQuotes(branchlist)#)
ORDER BY ID ASC
</cfquery>
              <!-- BEGIN EXAMPLE TABLE PORTLET-->
