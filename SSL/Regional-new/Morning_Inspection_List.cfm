...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      <!-- BEGIN PAGE TITLE -->
      <cfquery name="get_morning_inspections" datasource="jrgm" maxrows="2000">
SELECT      Inspection_ID, Crew_LeaderID, Inspection_Date, Inspection_Type, Problem, Created_By, Created_On, Current_Mileage, vehicleSatisfactory, 
                      InspectionMode
FROM     app_Inspection_Master  WHERE Inspection_Type ='Morning'  AND  <!---Crew_LeaderID IN  (#myList2#)--->branch_code IN (#branchcodelist#)
