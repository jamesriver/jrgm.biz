...
SELECT   [Employee ID], [Name FirstLast] AS employeename,Branch FROM APP_employees WHERE [Employee ID]=  #get_ds.supervisor_id# <!---  AND active_record =1 --->
</cfquery>
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Daily Sheet - <cfoutput>#get_supervisor.branch#</cfoutput></h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
   ...
   <div class="row">
        ...
        <div class="portlet-body">
          ...
          <table class="table large">
            ...
            <tbody>
                  <tr>
                    <td nowrap="nowrap"><div align="left"><span class="text-success lgtxt"><cfif get_ds.ds_approved EQ 1>
 		 ...
 		 WHERE ds_id = #dsid# AND job_clock_id =#get_this_job.ID# ORDER BY  ID ASC
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><div align="center"><span class="tableheadersm">1000<br />Compl</span></div></td>
                  <td><div align="center"><span class="tableheadersm">1010<br />Prune</span></div></td>
                  <td><div align="center"><span class="tableheadersm">1020<br />Trash Rem</span></div></td>
                  <td><div align="center"><span class="tableheadersm">1040<br />Edge</span></div></td>
                  <td><div align="center"><span class="tableheadersm">1070<br />Turf Fert</span></div></td>
                  <td><div align="center"><span class="tableheadersm">1080<br />Aer</span></div></td>
                  <td><div align="center"><span class="tableheadersm">1090<br />Overseed</span></div></td>
                  <td><div align="center"><span class="tableheadersm">2000<br />Lime</span></div></td>
                  <td><div align="center"><span class="tableheadersm">2030<br />Seas Col</span></div></td>
                  <td><div align="center"><span class="tableheadersm">2050<br />Leaf Rem</span></div></td>
                  <td><div align="center"><span class="tableheadersm">2060<br />Misc.</span></div></td>
                  <td><div align="center"><span class="tableheadersm">2090<br />BdWeed</span></div></td>
                  <td><div align="center"><span class="tableheadersm">3030<br />BdMulch</span></div></td>
                  <td><div align="center"><span class="tableheadersm">4000<br />Extra</span></div></td>
                </tr>
...
AND ds_id = #dsid# 
          ...
          SELECT [Employee ID] As employee_id,[Name FirstLast] AS employee_name FROM APP_employees WHERE [Employee ID] =  #get_employee_time_services.Employee_ID#
                  ...
                  <tr>
                    ...
                    <td><div align="center"><cfif SERVICE_ID EQ 1000>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                   <td><div align="center"><cfif SERVICE_ID EQ 1010>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 1020>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 1040>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 1070>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 1080>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 1090>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 2000>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 2030>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 2050>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
                    <td><div align="center"><cfif SERVICE_ID EQ 2060>
                        #hours_all_s#:#NumberFormat(minutes_all_s,"09")#
                      </cfif></div></td>
...
WHERE   job_clock_id=  '#get_this_job.ID#'
                ...
                <cfoutput query="get_materials_used">
                  <tr>
                    ...
                    <td colspan="12"   align="center" valign="bottom" nowrap="nowrap"  >&nbsp;</td>
                  </tr>
                </cfoutput>
              </table>
            </cfloop>
