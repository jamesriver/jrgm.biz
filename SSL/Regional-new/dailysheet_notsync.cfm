...
<cfif get_all_employee_info.BRANCH EQ 'Richmond' >
  <CFSET branchcode =10>
  <cfelseif get_all_employee_info.BRANCH EQ 'Portsmouth' >
  <CFSET branchcode =20>
  <cfelseif  get_all_employee_info.BRANCH EQ 'Charlottesville' >
  <CFSET branchcode =30>
  <cfelseif get_all_employee_info.BRANCH EQ 'Williamsburg' >
  <CFSET branchcode =70>
  <cfelseif get_all_employee_info.BRANCH EQ 'Chesterfield' >
  <CFSET branchcode =80>
  <cfelseif   get_all_employee_info.BRANCH EQ 'Newport News' >
  <CFSET branchcode =90>
  <cfelse>
...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Daily Sheets That Did Not Sync on the Correct  Work Day</h1>
        <br>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
  ...
  <div class="page-content">
    <div class="container-fluid"> 
      ...
      <div class="row">
        <div class="col-md-12">These daily sheets did not sync on the correct work day in the past 45 days. Please check the tablet settings and review the <a href="assets/admin/layout3/pdfs/Reminder%20Sheet%20English.pdf">syncing procedures </a>with the crew leader<br>
          <br>
 ...
 SELECT  * FROM app_daily_sheets WHERE ID in (#mylist#) AND ID NOT In (#mylistused#)     AND branch_code IN  (#branchcodelist#)
 ORDER by ID DESC
 </cfquery>
