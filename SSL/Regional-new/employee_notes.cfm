...
WHERE  Employee_branch IN   (#PreserveSingleQuotes(branchlist)#) AND Employee_Position_ID
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#regionname#</cfoutput> Region Employee Notes</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      ...
      <!---   <li> <a href="scheduler/scheduler.html">Crews</a><i class="fa fa-circle"></i> </li> --->
        <li class="active"> Employee Notes</li>
      </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
...
SELECT  ID,note_content,employee_id,Note_Author_ID, Note_Date FROM app_notes WHERE Employee_ID  
 IN (SELECT Employee_ID FROM app_crews WHERE  Employee_branch IN   (#PreserveSingleQuotes(branchlist)#))
...
jQuery(".navbar-nav li i.fa-angle-down.downside").click(function(){
