...
SELECT      Inspection_ID, Crew_LeaderID, Inspection_Date, Inspection_Type, Problem, Created_By, Created_On, Current_Mileage, vehicleSatisfactory, 
                      InspectionMode
FROM     app_Inspection_Master  WHERE Inspection_Type ='Morning'  AND branch_code IN (#branchcodelist#)
order by  Inspection_Date DESC, Inspection_ID DESC
    ...
    <tbody>
     <cfoutput  query="get_morning_inspections"  >
        <cfquery name="get_branch_employees_cache"   dbtype="query"  cachedWithin = "#CreateTimeSpan(0, 6, 0, 0)#">
...
WHERE  employee_ID =  #Crew_LeaderID# 
          ...
          <!-- BEGIN CURRENTLY IN REPAIR -->
					<div class="portlet">
						<div class="portlet-body">
                              <cfquery name="get_evening_inspections" datasource="jrgm"  maxrows="500">
SELECT      Inspection_ID, Crew_LeaderID, Inspection_Date, Inspection_Type, Problem, Created_By, Created_On, Current_Mileage, vehicleSatisfactory, 
                      InspectionMode
FROM     app_Inspection_Master  WHERE Inspection_Type ='Evening'   AND    branch_code IN (#branchcodelist#)
order by  Inspection_Date DESC, Inspection_ID DESC
 </cfquery>
...
WHERE  employee_ID =  #Crew_LeaderID# 
              ...
              <td><a href="Evening_Inspection_Form.cfm?Inspection_ID=#Inspection_ID#" target="_blank" >View</a></td>
                   ...
                   <div class="portlet">
						<div class="portlet-body">
                   <cfquery name="get_weekly_inspections" datasource="jrgm"  maxrows="500">
SELECT      Inspection_ID, Crew_LeaderID, Inspection_Date, Inspection_Type, Problem, Created_By, Created_On, Current_Mileage, vehicleSatisfactory, 
 InspectionMode
FROM     app_Inspection_Master  WHERE Inspection_Type ='Weekly'   AND   branch_code IN (#branchcodelist#)
order by  Inspection_Date DESC, Inspection_ID DESC
</cfquery>
