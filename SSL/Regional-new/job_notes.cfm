  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#regionname#</cfoutput> Region Job Notes</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar"> 
        ...
        <li> <a href="scheduler/schedulerevents.html">Jobs</a><i class="fa fa-circle"></i> </li>
        <li class="active"> Job Notes</li>
      </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
