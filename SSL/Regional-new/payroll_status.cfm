 ...
 FROM app_pay_periods WHERE pay_period_week = #pay_period_week1#
   ...
   AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
                  ...
                  <h2 class="text-danger">You have unapproved Week 1 payroll.</h2>
                  ...
                  <cfelse>
                  <h2 class="text-success">All Week 1 payroll is approved</h2>
                </cfif>
   ...
   AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
                 ...
                 <cfif  todaydate GT APPLICATION.week2_date_available AND get_employees_with_time_unapproved_Week2.recordcount GT 0>
                  <h2 class="text-danger">You have unapproved Week 2 payroll.</h2>
                  ...
                  <cfelse>
                  <h2 class="text-success">All Week 2 payroll is approved</h2>
                </cfif>
             </div></div></div></div>
...
<h2 class="text-danger">These employees are on more than 1 daily sheet  in 1 day. Please review to make sure that this is correct.</h2>
