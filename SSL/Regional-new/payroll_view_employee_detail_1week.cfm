...
<cfset tomorrow = dateadd("d",1,somedate)>
 ...
 <cfquery name="get_employees_with_time" datasource="jrgm"  >
		...
		WHERE branch = '#url.branch#'  AND (app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' AND app_employee_payroll_clock.Time_Out < '#DateFormat(pay_period_end_week_plusone, 'yyyy-mm-dd')# 00:00:00.000')   <!--- AND employee_id =2714  --->
