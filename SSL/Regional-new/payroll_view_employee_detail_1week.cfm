...
<cfset tomorrow = dateadd("d",1,somedate)>
 ...
 <cfquery name="get_employees_with_time" datasource="jrgm"  >
		...
		WHERE branch = '#url.branch#'  AND (app_employee_payroll_clock.Time_In > #pay_period_start# AND app_employee_payroll_clock.Time_Out < #pay_period_end_week_plusone#)   <!--- AND employee_id =2714  --->
