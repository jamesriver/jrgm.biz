...
<tbody>
            ...
            --->
             ...
             <tr>
              ...
              <td><div class="stylededit-select">
              
                 <select name="BRANCH_NAME"   tabindex="5" onchange='this.form.submit()'>  
        <option value="All"   <cfif session.branchsearch EQ 'All'> selected="selected"</cfif>>Choose Branch</option>
        ...
        <cfelse>
             <tr>
           <td><strong>Branch:  </strong></td>
             <td><strong><cfoutput># form.BRANCH_NAME#</cfoutput></strong></td>
            </tr>
            </cfif>
