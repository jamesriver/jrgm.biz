  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Job  Labor &amp; Materials Detail Excel - Select Branch</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
    ...
    <div class="container-fluid"> 
      ...
      <div class="row">
        <div class="col-md-8">
          <table>
            <tbody>
              <cfif  SESSION.regionname  EQ 'Eastern'>
                <tr>
                  <td nowrap="nowrap" >
                  <ul>
                      <li><a href="branch_joblist.cfm?branch=Charlottesville">Charlottesville</a> </li>
                      <li><a href="branch_joblist.cfm?branch=Richmond">Richmond</a> </li>
                      <li><a href="branch_joblist.cfm?branch=Chesterfield">Chesterfield </a> </li>
                    </ul>
                    </td>
                </tr>
              </cfif>
              <cfif  SESSION.regionname  EQ 'Western'>
                <tr>
                  <td nowrap="nowrap" >
                  <ul>
                      <li><a href="branch_joblist.cfm?branch=Newport News">Newport News</a> </li>
                      <li><a href="branch_joblist.cfm?branch=Portsmouth">Portsmouth </a> </li>
                    </ul>
                    </td>
                </tr>
              </cfif>
