...
<cfif IsDefined("deleteme")  AND deleteme  EQ 'yes'>
 <cfquery name="delete_IncidentReport" datasource="jrgm">
DELETE  FROM Form_IncidentReport WHERE   IR_ID  = #url.ID# 
 </cfquery>
 <cflocation url="IRList.cfm">
</cfif>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="jobbutton">
        ...
        <a href="https://www.jrgm.biz/ssl/admin/inventory.cfm"><img src="https://www.jrgm.biz/ssl/admin/images/icon_equipment.png" width="60" height="60" alt="Crews" class="icons" /></a>
        <a href="https://www.jrgm.biz/ssl/admin/directory.cfm"><img src="https://www.jrgm.biz/ssl/admin/images/directory_icon.png" width="60" height="60" alt="Crews" class="icons" /></a><a href="https://www.jrgm.biz/ssl/admin/forms.cfm"><img src="https://www.jrgm.biz/ssl/admin/images/icon_forms.png" width="60" height="60" alt="Forms" /></a> </td>
  ...
  <div class="centrecontent_inner">  
    ...
    <div class="header">Incident Reports</div>
      ...
      <div class="lgaddress">Are you sure you want to delete this report?</div>
       ...
       <p align="left"><cfoutput><a href="IRList_delete.cfm?ID=#url.ID#&deleteme=yes" class="materialsbutton">
        Yes</a> </cfoutput>  
          &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  <a href="IRList.cfm" class="materialsbutton">No </a> <br />
          <br />
            <br />
         <div class="lgaddress">Choosing yes will delete the report permanently.</div>
