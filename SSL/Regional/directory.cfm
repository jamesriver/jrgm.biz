...
<div id="centrecontent">
  ...
  <div class="centrecontent_inner">
     ...
     <table width="100%" border="0" cellpadding="0">
      <tr>
        <td><div class="header"><cfoutput>#regionname#</cfoutput> Region Directory</div>
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"> <article class="accordion-a"> 
        <section>
          <header>
            <span class="subheader">&nbsp; <cfoutput>#regionname#</cfoutput> Region Employees</span>
          </header>
          <div class="content">
 ...
 ORDER by  Last_name ASC,first_name ASC
  ...
  <tr>
    ...
    <td><a href="employee_details.cfm?employee_id=#get_branch_employees.Employee_ID#&work_date=#todayDate#">Notes</a></td>
        ...
        <section>
          <header>
            <span class="subheader">&nbsp;<cfoutput>#regionname#</cfoutput> Region Employees Usernames &amp; Passwords</span>
          </header>
          <div class="content">
...
WHERE employee_branch IN (#PreserveSingleQuotes(branchlist)#)  AND    employee_active = 1
ORDER by  lastname ASC,firstname ASC
  ...
  <cfoutput query="get_branch_employees_PW"> <tr>
    <td>#firstname#</td>
    <td>#lastname#</td>
    <td nowrap="nowrap" >#employee_branch#</td>
  ...
  <td>#password#</td>  
        ...
        <section>
          <header>
            <span class="subheader">&nbsp; <cfoutput>#regionname#</cfoutput> Region Jobs </span>
          </header>
          <div class="content">
