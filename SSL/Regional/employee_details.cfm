  ...
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      <cfoutput query="get_employee_info">
        ...
        <ul class="crew">
        <li class="crewtop">Employee ID&##8212;#EmployeeID#</li>
          <li>Branch&##8212;#branch#</li>
        <li>Position&##8212;#position#</li>
        <li>Phone Home&##8212; #homephone#</li>
        <li class="crewbot">Phone Cell&##8212;#cellphone#</li>
     </ul> 
	 </cfoutput>
      <br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
      <tr>
  <td><span class="header">All Notes for <cfoutput>#get_employee_info.employeename#</cfoutput></span>
  <cfif IsDefined("deleteme") AND deleteme EQ 'notsure' ><br /><br />


  <span class="dstable_top">Are you sure you want to delete this note?<br />
<br /><cfoutput>
<a href="employee_details.cfm?deleteme=yes&employee_id=#employee_id#&work_date=#url.work_date#&noteid=#url.noteid#">Yes</a>&nbsp;&nbsp; <a href="employee_details.cfm?work_date=#url.work_date#&employee_id=#employee_id#">No</a></cfoutput></span>
<cfabort></cfif></td>
...
SELECT [Employee ID] AS EmployeeID,position,[Name FirstLast] AS employeename  FROM APP_employees WHERE [Employee ID]=  #get_job_notes.Note_Author_ID#  
   ...
   <td align="left" >#note_content#</td>
     <td align="center" ><a href="employee_details.cfm?deleteme=notsure&employee_id=#employee_id#&work_date=#url.work_date#&noteid=#get_job_notes.ID#"><img src="images/del.png" width="12" height="12" /></a></td>
   </tr></cfoutput>
 </tbody>
</table>  
 </div>
