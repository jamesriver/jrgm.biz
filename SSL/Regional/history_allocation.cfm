...
SELECT first_name,last_name,branch,position,[Employee ID] As employee_id,  [Name FirstLast] AS fullname  FROM APP_employees
WHERE branch ='#getequipment_this.branch_name#'  AND    active_record = 1 AND     [Employee ID]  = #crew_assignment_last#
 ORDER by  Last_name ASC,first_name ASC
</cfquery>
      ...
      <table width="99%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <div class="job_data_header">Allocation</div>
              <form action="history_allocation.cfm?branch=<cfoutput>#getequipment_this.branch_name#</cfoutput>"  name="allocateform" method="post">    
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" nowrap="nowrap" class="alltable">Allocated to:</td>
                <td class="alltable">  <cfif getequipment_this.Crew_assignment_last  EQ 3> Spare<cfelseif getequipment_this.Crew_assignment_last  EQ 5>Seasonal<cfelseif getequipment_this.Crew_assignment_last  EQ 6>Lost<cfelse>
    ...
    <cfoutput>  <input type="hidden" name="EquipmentID"  value="#ID#" /></cfoutput>
          ...
          <form action="history_allocation.cfm?branch=<cfoutput>#getequipment_this.branch_name#</cfoutput>"  name="allocateform" method="post">    
           <tr>
            ...
            <div class="spacer20"></div>
            <div class="headerbutton">Notes</div><div class="bluebuttonRT"><a href="note_addnote.cfm?ID=<cfoutput>#ID#</cfoutput>&branch=<cfoutput>#getequipment_this.branch_name#</cfoutput>" class="bluebuttonNR" >Add Notes</a></div>
  ...
  <tr>
    <td> <span class="arialfont">No Notes Information</span> </td>
         ...
         <cfoutput query="get_this_equipment_notes">   
          ...
          <a href="history_allocation.cfm?showrepairloginfo=yes&ID=<cfoutput>#ID#</cfoutput>&branch=<cfoutput>#getequipment_this.branch_name#</cfoutput>" class="bluebutton">File a Repair Report or Change Status</a>
          </cfif>
            
              <cfif IsDefined("url.showrepairloginfo")>
             <div class="damaged_equip">
           <div class="damaged_header">Repair Information</div>
          <form method="post" action="history_allocation.cfm?equipment_ID=<cfoutput>#ID#</cfoutput>&branch=<cfoutput>#getequipment_this.branch_name#</cfoutput>" >
...
WHERE  [Employee ID] =  #get_this_equipment_inspection.entered_by#
         ...
         <!---        <div class="spacer20"></div>
           <div class="headerbutton">Oil Change History</div><div class="bluebuttonRT"><a href="oil_change_info_equipment.cfm?ID=<cfoutput>#ID#</cfoutput>&branch=<cfoutput>#getequipment_this.branch_name#</cfoutput>"  class="bluebuttonNR">Add Oil Change</a></div>
             
<!---     <cfquery name="get_this_equipment_oilchange" datasource="jrgm">
SELECT * FROM equipment_oil_changes WHERE equipment_id = #ID#
order by  oil_change_date DESC
      </cfquery> --->
