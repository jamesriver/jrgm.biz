...
ORDER by  ID ASC
     ...
     <div class="header"><cfoutput>#regionname#</cfoutput> Region Equipment List-<cfoutput>#getequipment.recordcount#</cfoutput> Records&nbsp; &nbsp;
 ...
 <thead> 
   <tr>
     ...
     <th align="center">History &amp; Allocate/<br />
       Oil Change/ <br />
       Inspection</th>
