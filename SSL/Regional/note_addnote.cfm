...
<br />
 ...
 <br />
<cfoutput> <a href="history_allocation.cfm?ID=#id#&branch=<cfoutput>#url.branch#</cfoutput>" class="arialfont">Go Back to History & Allocate Screen</a></cfoutput>
    <cfabort>
 </cfif>
     <div class="header"> Notes for <cfoutput>#get_this_equipment.Product_name#</cfoutput></div>
   <form method="post"  action="note_addnote.cfm?branch=<cfoutput>#url.branch#</cfoutput>">
    <div class="statusTD">
