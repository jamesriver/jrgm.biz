...
<div id="outerfull">
 ...
 <div class="centrecontent_inner">
   ...
   <div class="header"> Payroll for <cfoutput>#idx#</cfoutput> Branch</div>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sortable" >
  <tbody>          
     <cfif todaydate GT APPLICATION.week1_date_available>       
      <tr>
    <td nowrap="nowrap"><a href="payroll_view_employee_detail_1week.cfm?branch=<cfoutput>#idx#</cfoutput>&pay_period_week=<cfoutput>#pay_period_week1#</cfoutput>">Approve Weekly Payroll Week 1</a></td>
...
<tr>
          <td nowrap="nowrap"><a href="payroll_view_employee_detail_1week.cfm?branch=<cfoutput>#idx#</cfoutput>&pay_period_week=<cfoutput>#pay_period_week2#</cfoutput>">Approve Weekly Payroll Week 2</a></td>
          <td nowrap="nowrap">Week Ending <cfoutput>#pay_period_week2_date# </cfoutput></td>
          <td nowrap="nowrap">&nbsp;</td>
        </tr>  
 </cfif>
        <tr> 
          <td nowrap="nowrap"><a href="payroll_view_employee_detail_2week.cfm?branch=<cfoutput>#idx#</cfoutput>&pay_period_number=<cfoutput>#pay_period_number#</cfoutput>">View Current Payroll Period</a></td>
        ...
        <tr>
            <td nowrap="nowrap"><a href="payroll_view_employee_detail_2week.cfm?pay_period_number=<cfoutput>#PAY_PERIOD_NUMBER_PRIOR#&branch=#idx#</cfoutput>">View Prior Payroll Period</a></td>
...
<tr>
        ...
        <tr> 
          <td nowrap="nowrap"><a href="payroll_view_employee_detail_2week.cfm?pay_period_number=<cfoutput>#pay_period_number#&branch=#idx#</cfoutput>">View Current Payroll Period</a></td>
          <td nowrap="nowrap">Pay Period <cfoutput>#DateFormat(app_payroll_periods_C.pay_period_start, "mm/dd/yyyy")#</cfoutput>- <cfoutput>#DateFormat(app_payroll_periods_C.pay_period_end, "mm/dd/yyyy")#</cfoutput></td>
          <td nowrap="nowrap">2 Week Period</td>
        </tr>
        <tr>
