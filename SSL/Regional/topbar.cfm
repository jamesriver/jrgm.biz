  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="jobbutton"><!---  <div class="btn-group">
        ...
        <a href=""><img src="images/icon_payroll.png"  width="60" height="60"  class="icons"/></a> <a href="https://www.jrgm.biz/ssl/branch/dailysheet_select.cfm"><img src="images/icon_dailysheet.png" width="60" height="60"  class="icons"/></a> <cfoutput><a href="https://www.jrgm.biz/ssl/scheduler/schedulerevents.html"><img src="images/icon_jobs.png" width="60" height="60" alt="Jobs" class="icons" /></a></cfoutput> <cfoutput><a href="https://www.jrgm.biz/ssl/scheduler/scheduler.html"><img src="images/icon_crews.png" width="60" height="60" alt="Crews" class="icons" /></a></cfoutput> <cfoutput><a href="https://www.jrgm.biz/ssl/branch/inventory.cfm"><img src="images/icon_equipment.png" width="60" height="60" alt="Crews" class="icons" /></a></cfoutput> </td>
      <!-- .btn-group -->
