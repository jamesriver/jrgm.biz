...
ORDER by Note_Date DESC
      ...
      <cfif IsDefined("url.employee_ID")>
        <cfoutput> <a href="notes.cfm?work_date=#url.work_date#&amp;employee_id=#employee_id#" class="bluebutton">Add Notes</a></cfoutput>
      </cfif>
      <cfif IsDefined("url.job_ID")>
        <cfoutput> <a href="notes.cfm?work_date=#url.work_date#&amp;job_ID=#job_ID#" class="bluebutton">Add Notes</a></cfoutput>
      </cfif>
    </div>
  </div>
  <!-- to clear footer -->
