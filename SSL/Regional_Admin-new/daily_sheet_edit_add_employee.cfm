...
WHERE branch IN   (#PreserveSingleQuotes(branchlist)#)  AND    active_record = 1 AND  [Employee ID] =#form.EMPLOYEEID#
</cfquery>
...
SELECT   ds_date,supervisor_id, crew_leader_id,branch_code   FROM app_daily_sheets
WHERE ID =#dsid#
 </cfquery>
...
<cfif get_DSID_info.branch_code EQ '10' >
    <CFSET branchname ='Richmond'>
    <cfelseif get_DSID_info.branch_code EQ '20' >
    <CFSET branchname ='Portsmouth'>
    <cfelseif get_DSID_info.branch_code EQ '30'  >
    <CFSET branchname ='Charlottesville'>
    <cfelseif get_DSID_info.branch_code EQ '70'  >
    <CFSET branchname ='Williamsburg'>
    <cfelseif get_DSID_info.branch_code EQ '80'  >
    <CFSET branchname ='Chesterfield'>
    <cfelseif get_DSID_info.branch_code EQ '90' >
    <CFSET branchname ='Newport News'>
    <cfelseif  get_DSID_info.branch_code EQ '21'>
    <CFSET branchname ='Corporate'>
    <cfelseif  get_DSID_info.branch_code EQ '00'>
...
SELECT first_name,last_name,branch,position,[Employee ID] As employee_id,  [Name FirstLast] AS fullname  FROM APP_employees
WHERE branch =   '#branchname#' AND    active_record = 1 AND  [Employee ID] NOT IN (#mylist#)
...
<div class="page-container-fluid"> 
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li> <a href="daily_sheet_edit.cfm?dsid=<cfoutput>#url.dsid#</cfoutput>">Edit Daily Sheet</a><i class="fa fa-circle"></i> </li>
  ...
  <div class="page-content">
    <div class="container-fluid"> 
					...
					<div class="row">
					  <div class="col-md-12">
                      <form   method="post" action="daily_sheet_edit_add_employee.cfm?dsid=<cfoutput>#url.dsid#</cfoutput>"   onsubmit="setTimeout('window.close()',1000)">
       <table class="table large">
                ...
                <a href="daily_sheet_edit.cfm?dsid=<cfoutput>#url.dsid#</cfoutput>" class="btn btn-primary">Back to Daily Sheet</a>
              </div></td>
                </tr>
              </table>
