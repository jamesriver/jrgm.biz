...
<cfif get_ds_info.branch_code EQ '10' >
    <CFSET branchname ='Richmond'>
    <cfelseif get_ds_info.branch_code EQ '20' >
    <CFSET branchname ='Portsmouth'>
    <cfelseif get_ds_info.branch_code EQ '30'  >
    <CFSET branchname ='Charlottesville'>
    <cfelseif get_ds_info.branch_code EQ '70'  >
    <CFSET branchname ='Williamsburg'>
    <cfelseif get_ds_info.branch_code EQ '80'  >
    <CFSET branchname ='Chesterfield'>
    <cfelseif get_ds_info.branch_code EQ '90' >
    <CFSET branchname ='Newport News'>
    <cfelseif  get_ds_info.branch_code EQ '21'>
    <CFSET branchname ='Corporate'>
    <cfelseif  get_ds_info.branch_code EQ '00'>
  ...
  <!-- BEGIN PAGE CONTENT -->
   <div class="page-content">
       ...
       <p>Dont forget to enter service time for each employee.</p>
              <cfoutput>
                <p><a href="daily_sheet_edit.cfm?dsid=#form.ds_id#"  class="btn btn-primary">Back to Daily Sheet</a>&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;<a href="daily_sheet_edit_add_job1.cfm?ds_id=#form.ds_id#" class="btn btn-primary">Add Another Job</a>&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;<a href="daily_sheet_edit_add_lunch1.cfm?ds_id=#form.ds_id#&job_clock_id=#getmaxid.newid#" class="btn btn-primary">Add Lunch to this Job</a></p>
              </cfoutput>
        <cfabort>
      </cfif>
      <table class="table large" >
        <tr>
          <td><strong>Date: <cfoutput>#DateFormat(get_ds_info.ds_date, "mmmm dd, yyyy")#--#branchname#</cfoutput></strong></td>
      ...
      <form  method="post" action="daily_sheet_edit_add_job1.cfm" >
        ...
        <table class="table large">
          ...
          <cfoutput>
            <tr>
              ...
              <td>
              <input type="text" class="form-control timepicker timepicker-no-seconds" name="Job_Time_In" value="#TimeFormat(Job_Time_In,"short")#">
                  <span class="add-on"><i class="icon-time"></i></span></td>
              <td><strong>Job End Time:</strong></td>
              <td>
              <input type="text" class="form-control timepicker timepicker-no-seconds" name="Job_Time_Out" value="#TimeFormat(Job_Time_Out,"short")#">
                  <span class="add-on"><i class="icon-time"></i></span></td>
        ...
        <cfoutput>
          <a href="daily_sheet_edit.cfm?dsid=#ds_id#" class="btn btn-primary">Back to Daily Sheet</a>
        </cfoutput>
