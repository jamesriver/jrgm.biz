...
SELECT *  FROM app_employee_payroll_clock
 WHERE  ds_id = #url.ds_id# AND  Employee_ID = #url.Employee_ID#
  ...
  <cflocation url="daily_sheet_edit2.cfm?dsid=#url.ds_id#">
</cfif>
...
WHERE  DS_ID =#url.ds_id# AND ID = #url.rowid#
  ...
  <cfoutput>
    <cflocation url="daily_sheet_edit_employee_time2.cfm?Employee_ID=#url.Employee_ID#&ds_id=#ds_id#">
  </cfoutput>
</cfif>
<!--- ------------ For  Time 1---------------- --->
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li><a href="daily_sheet_edit2.cfm?dsid=<cfoutput>#ds_id#</cfoutput>">Edit This Daily Sheet</a><i class="fa fa-circle"></i> </li>
  ...
  <div class="page-content">
    <div class="container-fluid"> 
      ...
      <cfif IsDefined("url.delete")>
        <div class="row">
          <div class="col-md-12"> Are you sure you want to delete <cfoutput>#get_employee.employeename#</cfoutput> from this daily sheet? <br />
            <cfoutput><a href="daily_sheet_edit_employee_time2.cfm?deleteme=yes&Employee_ID=#url.Employee_ID#&ds_id=#ds_id#" class="btn btn-primary"> Yes</a> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_employee_time2.cfm?Employee_ID=#url.Employee_ID#&ds_id=#ds_id#" class="btn btn-primary">No</a>
      ...
      <cfif IsDefined("url.deleterow")>
        <div class="row">
          <div class="col-md-12"> Are you sure you want to delete this row for <cfoutput>#get_employee.employeename#</cfoutput> from this daily sheet? <br />
            <cfoutput><a href="daily_sheet_edit_employee_time2.cfm?deletemerow=yes&Employee_ID=#url.Employee_ID#&ds_id=#ds_id#&rowid=#rowid#" class="btn btn-primary"> Yes</a> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_employee_time2.cfm?Employee_ID=#url.Employee_ID#&ds_id=#ds_id#" class="btn btn-primary">No</a>
      ...
      <div class="row">
        <div class="col-md-12">
          <table class="table large">
            <form  method="post" action="daily_sheet_edit_employee_time2.cfm"   >
              <cfoutput query="get_employee_time" startrow="1" maxrows="1">
                <tr>
                  ...
                  <td align="right"valign="top"><a href="daily_sheet_edit_employee_time2.cfm?deleterow=yes&rowid=#get_employee_time.id#&ds_id=#ds_id#&EMPLOYEE_ID=#EMPLOYEE_ID#" class="btn red">Delete</a></td>
                </tr>
            ...
            <cfif get_employee_time.recordcount GT 2>
              <form  method="post" action="daily_sheet_edit_employee_time2.cfm"   onsubmit="setTimeout('window.close()',1000)">
            ...
            <tr> </tr>
            <tr> <cfoutput>
                <td colspan="6" align="left" nowrap="nowrap"><a href="daily_sheet_edit_employee_time2.cfm?addrow=yes&ds_id=#ds_id#&Employee_ID=#Employee_ID#" class="text-dsadd"><i class="fa-green fa-plus-square"></i>Add
      ...
      <div class="row">
        <div class="col-md-4"> <cfoutput><a href="daily_sheet_edit_employee_time2.cfm?ds_id=#ds_id#&Employee_ID=#Employee_ID#&delete=yes"  class="btn red">Remove this Employee</a></cfoutput> </div>
        <div class="col-md-4"> <cfoutput><a href="daily_sheet_edit2.cfm?dsid=#ds_id#" class="btn btn-primary" >Back to Daily Sheet</a></cfoutput> </div>
        
        <cfif  IsDefined("form.submit")> 
        <div class="col-md-4"> <cfoutput> <a href="daily_sheet_edit_employee_time2.cfm?ds_id=#ds_id#&Employee_ID=#Employee_ID#&all=yes" class="btn btn-primary" >Use for ALL Employees on this Daily Sheet</a> </cfoutput></div>
      </div>
        </cfif>  
      
      <div class="row">
        <div class="col-md-4"> <cfoutput><span class="redarial"><strong>#message#</strong></span></cfoutput> </div>
      </div>
    </div>
  </div>
</div>
