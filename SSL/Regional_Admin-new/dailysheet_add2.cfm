...
WHERE  branch ='#form.branch_name#'  AND    active_record = 1  
  UNION
 SELECT first_name,last_name,branch,position,[Employee ID] As employee_id,  [Name FirstLast] AS fullname  FROM APP_employees
WHERE  branch ='Corporate'  AND    active_record = 1  AND [Employee ID] IN  (10291,10031)
...
<div class="page-container-fluid"> 
    ...
    <div class="container-fluid"> 
        ...
        <div class="col-md-6">
            ...
            <br />
            <h2>The Daily Sheet date must not be after today. <br />
                  Please <a href = "javascript:history.back()">go back</a> and select a date equal to today or a date before today.</h2>
            <cfabort>
            <br />
          </cfif>
           ...
           <!--- <cfmail to="benchanviolin@gmail.com"    FROM="JRGM Alerts <alerts@jrgm.com>"  subject="RA Create New DS"  type="html">
            ...
            <form action="dailysheet_add2.cfm" method="post">
                ...
                <tr>
                      ...
                      <td><select name="BRANCH_NAME"   onchange='this.form.submit()'  class="bs-select form-control">
                          <option value="Choose"   
...
<cfif  form.BRANCH_NAME EQ 'Richmond'> selected="selected"</cfif>>Richmond</option>
            ...
            <form action="dailysheet_add2.cfm" method="post">
                ...
                <tr>
                    ...
                    <input type="hidden" name="branchcode"   value="<cfoutput>#branchcode#</cfoutput>"  /></td>
                    </tr>
                <tr>
