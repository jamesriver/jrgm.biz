...
SELECT  * FROM app_daily_sheets  WHERE branch_code IN (#branchcodelist#) 
        ...
        AND ds_date > '2014-12-31' AND   ds_date < '2015-12-06'
...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Daily Sheets for <cfoutput>#SESSION.screenname#  - 2015 Audit List</cfoutput></h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
  ...
  <div class="page-content">
    ...
    <cfquery name="get_clid"  dbtype="query" >
  SELECT DISTINCT   employee_ID , fullname,Last_name,first_name 
FROM get_all_employee_info
WHERE  employee_ID   IN  (SELECT  Crew_Leader_ID FROM app_daily_sheets WHERE  Supervisor_ID =#session.userid# )
<!---ORDER by last_name--->
  </cfquery>
...
SELECT    fullname AS employee_name
...
SELECT    fullname AS employee_name,branch
