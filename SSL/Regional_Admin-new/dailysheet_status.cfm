  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Daily Sheet Status  for <cfoutput>#regionname#</cfoutput> Region</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
...
SELECT  * FROM APP_daily_sheets  WHERE  branch_code IN (#branchcodelist#) AND ds_approved IS NULL AND ds_date > '12/31/2014'  
  </cfquery>
