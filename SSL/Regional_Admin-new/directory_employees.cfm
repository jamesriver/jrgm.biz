  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#regionname#</cfoutput> Region Employees Directory</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="active"> <cfoutput>#regionname#</cfoutput> Region Directory</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
              ...
              <table class="table table-striped table-bordered table-hover" id="sample_3">
                <thead>
                  <tr>
                    ...
                    <th>Position</th>
                    <th>Branch</th>
                    <th> Work Cell Phone</th>
                    <th> Personal Cell Phone</th>
                    <th>Home Phone</th>
                    <th>Email</th>
                    <th>Notes</th>
                  </tr>
