...
SELECT  * FROM APP_daily_sheets  WHERE  branch_code IN (#branchcodelist#) AND ds_approved IS NULL AND ds_date > '12/31/2014' ORDER by ds_date DESC , ID DESC
  </cfquery>
            <div class="portlet-title">
   ...
   AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
              ...
              <cfif  todaydate GT APPLICATION.week1_date_available  AND get_employees_with_time_unapproved_Week1.recordcount GT 0>
                ...
                <cfelseif  todaydate GT APPLICATION.week1_date_available AND get_employees_with_time_unapproved_Week1.recordcount EQ  0>
                <p class="text-success"><br>
                  <strong>All Week 1 payroll is approved.</strong></p>
                <cfelse>
                <p class="text-success"><strong>Week 1 payroll is not ready to approve.</strong></p>
              </cfif>
   ...
   AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
              ...
              <cfif  todaydate GT APPLICATION.week2_date_available AND get_employees_with_time_unapproved_Week2.recordcount GT 0>
                ...
                <cfelseif  todaydate GT APPLICATION.week2_date_available AND get_employees_with_time_unapproved_Week2.recordcount EQ  0>
                <p class="text-success"><br>
                  <strong>All Week 2 payroll is approved.</strong></p>
                <cfelse>
                <p class="text-success"><br>
                  <strong>Week 2 payroll is not ready to approve.</strong></p>
              </cfif>
...
AND      Branch_name IN   (#PreserveSingleQuotes(branchlist)#)  ORDER by repair_last_completed_date DESC
 </cfquery>
