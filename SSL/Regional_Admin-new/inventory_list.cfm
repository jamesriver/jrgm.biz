...
ORDER by  ID ASC
      ...
      <div class="page-title">
        <h1><cfoutput>#regionname#</cfoutput> Region Equipment List-<cfoutput>#getequipment.recordcount#</cfoutput> Records&nbsp; &nbsp;
  ...
  <tr>
    ...
    <td nowrap="nowrap">Branch:
      <select name="BRANCH_NAME"   class="bs-select form-control input-small"  tabindex="4" onchange='this.form.submit()'>  
