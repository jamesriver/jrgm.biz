...
SELECT  DISTINCT [Employee ID] AS Employee_ID,position,[Name FirstLast] AS Employee_Name FROM 
...
<div class="page-container-fluid"> 
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Employees that answered "I do not agree" to hours signout question in 2015</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
  ...
  <div class="page-content">
    <div class="container-fluid"> 
        ...
        SELECT * FROM 
       app_employee_payroll_clock WHERE CompleteHours =0  AND  ((Supervisor IN (#mylistsupers#)  OR  Supervisor = #SESSION.userid#))   AND   ds_date > '12/31/2014' 
            </cfquery>
           ...
           <cfquery name="get_employees_name"  dbtype="query" cachedWithin="#createTimeSpan( 0, 0, 0, 0 )#">
SELECT  last_name AS employee_name,branch
FROM get_all_employee_info WHERE employee_ID =#get_employees_CompleteHours.employee_ID#
        </cfquery>
