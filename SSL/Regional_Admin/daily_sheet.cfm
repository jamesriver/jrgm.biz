...
SELECT   [Employee ID], [Name FirstLast] AS employeename FROM APP_employees WHERE [Employee ID]=  #get_ds.supervisor_id#  
</cfquery>
     ...
     <table width="100%" border="0" cellpadding="0"  >
      <tr>
        <td> 
            ...
            <tr class="dstable_date">    
               <td class="dstable_top" align="left">Date : <cfoutput>#DateFormat(ds_date, "mmmm dd, yyyy")#</cfoutput></td>
                  <td align="left" class="dstable_top">DSID : <cfoutput>#dsid#</cfoutput> </td>
                  </tr>
      <tr class="dstable_date">    
            <td class="dstable_top" align="left" >Crew Leader : <cfoutput>#get_crew_leader.employeename#</cfoutput></td>
              <td class="dstable_top" align="left">Supervisor : <cfoutput>#get_supervisor.employeename#</cfoutput></td>
               </tr>
          </table>
                </td>
                <td>
	...
	SELECT [Wk Location Name] AS event_name FROM app_jobs
 		 ...
 		 WHERE ds_id = #dsid# AND job_clock_id =#get_this_job.ID# ORDER BY  ID ASC
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="dailysheet_table">
              <cfoutput>
                <tr>
                  <td  class="dstable_header"   colspan="4">#LEFT(get_this_job_name.event_name,25)# - #job_id# - Job Clock ID: #get_this_job.id#</td>
                  ...
                  <td class="dstable_headersm" colspan="2" nowrap="nowrap"> </td>
