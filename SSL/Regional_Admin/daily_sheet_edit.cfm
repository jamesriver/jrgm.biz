...
Crew Leader : <cfoutput>#get_crew_leader.employeename#</cfoutput></td>
			  ...
			  <cfoutput><a href="daily_sheet_edit_add_job1.cfm?ds_id=#dsid#&branch=#url.branch#" class="greenbuttonsm">Add a Job</a></a>
              </cfoutput></td></tr>
          </table>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dailysheet_table" >
            ...
            <cfif  (ds_date GT #APPLICATION.blockdate#) or SESSION.userid EQ 1548 or  SESSION.userid EQ 1030>
                <a href="daily_sheet_edit_employee_time1.cfm?ds_id=#dsid#&Employee_ID=#get_employees_for_Crew_Leader.Employee_ID#&branch=#url.branch#"><i class="fa-orange fa-pencil-square"></i></a>
                 </cfif></td>
...
WHERE Employee_ID =#get_employees_for_Crew_Leader.Employee_ID# AND ds_id = #dsid# AND in_out_status =1
        ...
        <cfif  (ds_date GT #APPLICATION.blockdate#) or SESSION.userid EQ 1548 or SESSION.userid EQ 1030>
              <tr> <cfoutput>
                <td align="left" colspan="8" class="dstable">
