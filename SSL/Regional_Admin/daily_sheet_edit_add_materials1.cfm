<cfif IsDefined("form.ds_id") AND  IsDefined("form.submit")>
  <cfif  form.QUANTITY_USED  IS "">
    <cfoutput>
      <cflocation url="daily_sheet_edit_add_materials1.cfm?dsid=#ds_id#&job_clock_id=#form.job_clock_id#&error=qty&branch=#url.branch#">
    </cfoutput>
  </cfif>
...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
        ...
        <table   border="0" cellpadding="3" cellspacing="0" class="arialfont" >
          <tr>
            <td align="left" nowrap="nowrap" >The materials has been aded to the daiy sheet.<br />
              <br />
              <cfoutput> <a href="daily_sheet_edit.cfm?DSID=#form.ds_id#&branch=#url.branch#">Go to daily sheet. </a></cfoutput></td>
          </tr>
        </table>
        <cfabort>
      </cfif>
      ...
      <form   method="post" action="daily_sheet_edit_add_materials1.cfm?branch=<cfoutput>#url.branch#</cfoutput>" >
...
SELECT *  FROM app_materials_list order by sortid
        ...
        <table width="70%" border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            ...
            <td class="dailysheetEditTop"><input type="text" value="" name="quantity_used"  maxlength="5"  size="5" />
      ...
      <cfoutput>
        <p><a href="daily_sheet_edit.cfm?dsid=#ds_id#&branch=#url.branch#"  class="dssbutton">Back to Daily Sheet</a> </p>
      </cfoutput> </div>
  </div>
  <!-- to clear footer -->
</div>
