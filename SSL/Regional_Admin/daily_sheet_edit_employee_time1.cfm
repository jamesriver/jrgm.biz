...
<cfif get_employee_time_from_device.recordcount GT 0>
 ...
 (Employee_ID,crew_leader,supervisor,ds_id, In_Out_Status,entry_method , ds_date,time_in,time_out,record_created,CompleteHours, IsEmpInjury,time_worked) 
...
<cfif IsDefined("url.addrow") >
  <cfquery name="insert_time" datasource="jrgm">
 INSERT INTO app_employee_payroll_clock (Employee_ID,crew_leader,supervisor,ds_id, In_Out_Status, time_worked,entry_method,ds_date,record_created) 
 VALUES (#url.Employee_ID#,#get_crew_leader.empid#,#get_supervisor.empid#,#url.ds_id#,2,0,2,#ds_date#,CURRENT_TIMESTAMP)
 </cfquery>
</cfif>
