...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
          <tr>
            <td align="left" class="dailysheetEdit"> Are you sure you want to delete <strong><cfoutput>#get_this_job_name.event_name#</cfoutput></strong> from this daily sheet? <br />
              <cfoutput><a href="daily_sheet_edit_job1.cfm?deleteme=yes&ds_id=#ds_id#&ID=#url.ID#&branch=#url.branch#" class="YesNoButton"> Yes</a> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_job1.cfm?ds_id=#ds_id#&ID=#url.ID#&branch=#url.branch#" class="YesNoButton">No</a>
                <p  class="redarial"> <br />
      ...
      <form   method="post" action="daily_sheet_edit_job1.cfm?branch=<cfoutput>#url.branch#</cfoutput>" >
      ...
      <br />
      <tr> <cfoutput>
          <td><a href="daily_sheet_edit_job1.cfm?ds_id=#ds_id#&ID=#ID#&delete=yes&branch=#url.branch#"  class="removebutton">Remove this Job</a></td>
          <td>&nbsp;</td>
