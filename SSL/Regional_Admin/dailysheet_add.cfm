...
<CFIF IsDefined("url.work_date")>
 ...
 SELECT branch AS employee_branch from app_employees WHERE [employee id ]= #form.Supervisor_ID#
 </cfquery>

 <CFSET DS_branch = '#get_branch.employee_branch#'>
 
<!---   <cfoutput>#DS_branch#</cfoutput> --->
 
 <cfif DS_branch EQ 'Richmond' >
 <CFSET branchcode =10>
     <cfelseif DS_branch EQ 'Portsmouth' >
    <CFSET branchcode =20>
      <cfelseif DS_branch EQ 'Charlottesville' >
    <CFSET branchcode =30>
      <cfelseif DS_branch EQ 'Williamsburg' >
    <CFSET branchcode =70>
      <cfelseif DS_branch EQ 'Chesterfield' >
    <CFSET branchcode =80>
      <cfelseif DS_branch EQ 'Newport News' >
    <CFSET branchcode =90>
     <cfelse>
   <CFSET branchcode =0>
  </cfif>
...
WHERE branch IN   (#PreserveSingleQuotes(branchlist)#)  AND    active_record = 1  
...
<div id="outerfull">
 ...
 <br />
       ...
       <br />
 <p><span class="dailysheet_header">Daily Sheet ID : <cfoutput>#getmaxid.newid# has been created.</cfoutput></span> <br /><br />
 
<cfoutput><a href="daily_sheet_edit.cfm?dsid=#getmaxid.newid#&message=yes&branch=#get_branch.employee_branch#" class="bluebutton" ></cfoutput>Edit Daily Sheet</a>  </strong></span><br />
        <br />
        ...
        <form class="css_form" action="dailysheet_add.cfm" method="post">
          <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td class="statusTD_right"><div class="stylededit-select"><select name="Supervisor_ID" >
            ...
            <tr>
              ...
              <td class="statusTD_right"><div class="stylededit-select"><select name="Crew_Leader_ID" >
                  <cfoutput query="get_branch_employees">
                    <option value="#employee_id#">#fullname#</option>
                  </cfoutput>
                </select></div></td>
