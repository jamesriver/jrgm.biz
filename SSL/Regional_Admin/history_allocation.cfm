  ...
  <tr>
    <td> <span class="arialfont">No Notes Information</span> </td>
         ...
         <cfoutput query="get_this_equipment_notes">   
          ...
          <form method="post" action="history_allocation.cfm?equipment_ID=<cfoutput>#ID#</cfoutput>&branch=<cfoutput>#url.branch#</cfoutput>" >
...
WHERE  [Employee ID] =  #get_this_equipment_inspection.entered_by#
       ...
       <!---     <div class="headerbutton">Oil Change History</div><div class="bluebuttonRT"><a href="oil_change_info_equipment.cfm?ID=<cfoutput>#ID#</cfoutput>&branch=<cfoutput>#url.branch#</cfoutput>"  class="bluebuttonNR">Add Oil Change</a></div>
