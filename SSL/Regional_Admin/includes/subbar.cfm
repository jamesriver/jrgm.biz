<div class="subbar">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="subbartxt">Welcome:<cfoutput> #SESSION.screenname#</cfoutput> <cfif SESSION.access_role EQ 99> (Regional Manager<cfelse>(Regional Admin</cfif> - <cfoutput>#regionname#</cfoutput> Region)</td>
