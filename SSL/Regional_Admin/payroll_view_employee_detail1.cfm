  ...
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td nowrap="nowrap" class="header">Payroll Detail for <cfoutput query="get_employees_name">#get_employees_name.first_name# #get_employees_name.last_name# since since <cfoutput>#DateFormat("#payroll_start_date#", "mm/dd/yyyy")#</cfoutput><br />
...
app_employee_payroll_clock WHERE Employee_ID =#url.empid#  AND app_employee_payroll_clock.Time_In > '#payroll_start_date#'
