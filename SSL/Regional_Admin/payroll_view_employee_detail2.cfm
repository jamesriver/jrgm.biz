...
GROUP by Employee_ID
       ...
       <td nowrap="nowrap"  align="right"><a href="payroll_view_employee_detail_2week.cfm?branch=<cfoutput>#url.branch#</cfoutput>" class="bluebutton">Back to List</a></td></tr></table>
...
SELECT Employee_ID, SUM(time_worked) As sumdailytime, ds_id ,in_out_status,ds_date 
 ...
 ORDER by ds_date DESC ,ds_id DESC
     ...
     <table class="sortable" border="0" cellspacing="0" cellpadding="0"   width="75%">
    <thead> 
         <tr>
