...
<cfset tomorrow = dateadd("d",1,somedate)>
 ...
 <cfquery name="get_employees_with_time" datasource="jrgm"  >
		...
		WHERE branch = '#url.branch#'  AND (app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' AND app_employee_payroll_clock.Time_Out < '#DateFormat(pay_period_end_week_plusone, 'yyyy-mm-dd')# 00:00:00.000')
...
SELECT  Employee_ID , SUM(time_worked) As sumdailytime, in_out_status,ds_date 
 ...
 GROUP by Employee_ID, ds_date, in_out_status
       ...
       FROM app_employee_payroll_clock
       WHERE "Employee_ID" =#get_employees_with_time.Employee_ID# AND (app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' AND app_employee_payroll_clock.Time_Out < '#DateFormat(pay_period_end_week_plusone, 'yyyy-mm-dd')# 00:00:00.000')
         </cfquery>
