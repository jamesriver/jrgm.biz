...
<cfif getlogin.recordcount GT 0  >
  ...
  <cfif url.schedchoice  EQ 'home' AND employee_position_ID EQ 9 >
    <html>
    <head>
    <META HTTP-EQUIV="Refresh" CONTENT="1;URL=https://www.jrgm.biz/ssl/branch-new/default.cfm">
    </head>
    </html>
   </cfif>
    ...
    <html>
    <head>
    <META HTTP-EQUIV="Refresh" CONTENT="1;URL=https://www.jrgm.biz/ssl/supervisors-new/default.cfm">
    </head>
    </html>
   </cfif>
