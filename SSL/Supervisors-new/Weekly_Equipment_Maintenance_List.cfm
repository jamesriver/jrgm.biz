...
SELECT      Inspection_ID, Crew_LeaderID, Inspection_Date, Inspection_Type, Problem, Created_By, Created_On, Current_Mileage, vehicleSatisfactory, 
 InspectionMode
FROM     app_Inspection_Master  WHERE Inspection_Type ='Weekly'  AND  branch_code = #branchcode# <!--- AND  Crew_LeaderID IN  (#myList2#)--->
order by  Inspection_Date DESC, Inspection_ID DESC
</cfquery>
      <div class="page-title">
        <h1>Weekly Equipment Maintenance Form List</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="active">Weekly Equipment Maintenance List</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
              ...
              <table class="table table-striped table-hover" id="sample_5">
                ...
                <tbody>
                  <cfoutput  query="get_weekly_inspections"  >
                    <tr>
                      <td><a href="Weekly_Equipment_Maintenance_Form.cfm?Inspection_ID=#Inspection_ID#">#Inspection_ID#</a></td>
