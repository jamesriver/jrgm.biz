 <cfquery name="get_ds_date" datasource="#request.dsn#">
 SELECT  ds_date FROM app_daily_sheets  WHERE ID = #url.dsid#
 </cfquery>
 
<cfif get_ds_date.ds_date GT '12/05/15'><cflocation url="daily_sheet_edit2.cfm?dsid=#url.dsid#">
<cfelse>
		...
		AND ds_id = #dsid# 
				...
				WHERE   job_clock_id=  '#get_this_job.ID#'
                    ...
                    <cfoutput query="get_materials_used">
                      <tr>
                        <td width="25" align="center" nowrap="nowrap" ><a href="daily_sheet_edit_materials1.cfm?ds_id=#dsid#&MATID=#get_materials_used.ID#&JOB_CLOCK_ID=#get_this_job.ID#"><i class="fa-orange fa-pencil-square"></i></a></td>
