  ...
  <!-- BEGIN PAGE CONTENT -->
   <div class="page-content">
		<div class="container-fluid">
                    ...
                    <cfif IsDefined("form.ds_id") AND  IsDefined("form.submit") >
       <p>The materials has been added to the daiy sheet.</p>
...
SELECT *  FROM app_materials_list_OLD order by sortid
        ...
        <table class="table large">
          ...
          <tr>
            ...
            <td>
                <select name="unit_used" class="bs-select form-control">
          ...
          <tr>
            ...
            <td><strong>
              <input type="text" value="" name="quantity_used"  maxlength="5"  size="5" class="form-control input-inline input-small" />
          ...
          <tr>
            <td >&nbsp;</td>
            <td><input type="submit" name="submit" class="btn btn-primary" id="submit" value="Submit" /></td>
          </tr>
          <cfoutput>
