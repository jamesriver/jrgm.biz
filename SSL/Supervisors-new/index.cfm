...
<div class="page-container-fluid"> 
 ...
 SELECT  * FROM app_daily_sheets WHERE ID in (#mylist#) AND Supervisor_ID = #SESSION.userid#
 ORDER by ID DESC
 </cfquery>
...
SELECT  * FROM APP_daily_sheets  WHERE    Supervisor_ID = #SESSION.userid#  AND ds_approved IS NULL AND ds_date > '12/31/2014' ORDER by ds_date DESC
  </cfquery>
            <div class="portlet-title">
   ...
   AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
              ...
              <cfif  todaydate GT APPLICATION.week1_date_available  AND get_employees_with_time_unapproved_Week1.recordcount GT 0>
                ...
                <a href="payroll_view_employee_detail_1week.cfm?pay_period_week=<cfoutput>#pay_period_week1#</cfoutput>" class="btn btn-primary">Approve week 1 payroll</a><br>
                <cfelse>
