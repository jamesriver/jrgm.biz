...
<div class="page-container-fluid"> 
 ...
 SELECT MIN(ID) AS  first_id_oftheday  FROM APP_Employee_Payroll_Clock WHERE entry_method IS NULL AND ds_date = '#today_datex#'  
  ...
  <div class="portlet-title">
              <div class="caption">The following Daily Sheets came in AFTER the first daily sheet of today. They DID NOT sync until today.</div>
            </div>
...
SELECT  * FROM APP_daily_sheets  WHERE    Supervisor_ID = #SESSION.userid#  AND ds_approved IS NULL AND ds_date > '05/31/2014' ORDER by ds_date DESC
            ...
            <div class="portlet-title">
              <div class="caption"><span class="badge badge-portal"><cfoutput>#get_ds_supervisor.RecordCount#</cfoutput></span> Daily Sheets</div>
                ...
                <tbody>
                  <cfoutput query="get_ds_supervisor">
                    <cfquery name="get_info_S"  dbtype="query" cachedWithin="#createTimeSpan( 0, 1, 0, 0 )#">
						...
						FROM get_all_employee_info WHERE employee_ID =#get_ds_supervisor.supervisor_id#
					</cfquery>
                    <cfquery name="get_info_CL" dbtype="query" cachedWithin="#createTimeSpan( 0, 1, 0, 0 )#">
						SELECT   last_name AS employee_name,branch
						FROM   get_all_employee_info WHERE employee_ID =#get_ds_supervisor.Crew_Leader_ID#
					</cfquery>
                    <tr>
...
ORDER by repair_last_completed_date DESC
              ...
              <cfif get_this_equipment_in_repair_recent.recordcount EQ 0 >
                ...
                <cfelse>
                <h4>Recently Completed Repairs with Status "Active" <span class="message">These Do Not Need a Status Change</span> </h4>
                <div class="table-scrollable table-scrollable-borderless">
                <table class="table table-hover table-light">
                  <thead>
                    <tr class="uppercase">
...
WHERE  employee_ID =  #Crew_assignment_last# 
  ...
  <div class="row">
    <div class="col-md-6 col-sm-12"> 
      ...
      <div class="portlet box purple-plum">
        ...
        <div class="portlet-body">
          <div class="scroller" style="height:300px">
            <h4>Hours </h4>
            Employees that answered "I do not agree" to hours signout question <span class="message">Showing last 20 in 2015</span>
            <div class="table-scrollable table-scrollable-borderless">
              <table class="table table-hover table-light">
                <thead>
                  <tr class="uppercase">
    ...
    SELECT  * FROM APP_daily_sheets  WHERE (( Supervisor_ID = #SESSION.userid#)) AND ds_date > '12/31/2014' ORDER by ds_date DESC
    </cfquery>
                <CFSET mylistds ="0">
...
FROM   get_all_employee_info WHERE employee_ID =#get_employees_CompleteHours.supervisor#
              ...
              <h4>Injury </h4>
              Employees that answered "I do not agree" to injury signout question <span class="message">Showing last 20 in 2015</span>
              <div class="table-scrollable table-scrollable-borderless">
                <table class="table table-hover table-light">
                  <thead>
                    <tr class="uppercase">
