  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Payroll Period #DateFormat("#begin_date#", "mm/dd/yyyy")#-
...
<cfloop query="get_employees_with_time">
 ...
 AND in_out_status =2
        ...
        <cfloop query="get_employees_with_time" >
          <tr> <cfoutput>
              <td nowrap="nowrap"><a href="payroll_view_employee_detail2.cfm?empid=#get_employees_with_time.Employee_ID#&pay_period_number=#pay_period_number#">#get_employees_with_time.first_name# #get_employees_with_time.last_name# </a></td>
