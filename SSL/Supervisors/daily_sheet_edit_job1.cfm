...
<div id="outerfull">
    ...
    <div class="centrecontent_inner">
      ...
      <table   border="0" cellpadding="3" cellspacing="0" class="dailysheet_table_top" >
        ...
        <tr>
          ...
          <td align="left" nowrap="nowrap" class="dailysheetEditTop" >&nbsp;</td>
          <td align="left" nowrap="nowrap" class="dailysheetEditTop" ><strong>Job ID:&nbsp;<cfoutput></cfoutput> </strong></td>
  ...
  <tr>
    ...
    Are you sure you want to delete <strong><cfoutput>#get_this_job_name.event_name#</cfoutput></strong> from this daily sheet?
    <br />
    
      <cfoutput><a href="daily_sheet_edit_job1.cfm?deleteme=yes&ds_id=#ds_id#&ID=#url.ID#" class="YesNoButton">
        Yes</a>   
          &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_job1.cfm?ds_id=#ds_id#&ID=#url.ID#" class="YesNoButton">No</a>
  <p  class="redarial"> <br />
Choosing yes will delete <strong> #get_this_job_name.event_name# </strong> from this daily sheet.
  </p></cfoutput>  
     </td>
  </tr>
</table>
...
<br />
 ...
 <tr>
    <cfoutput> <td><a href="daily_sheet_edit_job1.cfm?ds_id=#ds_id#&ID=#ID#&delete=yes"  class="removebutton">Remove this Job</a></td>  
    <td>&nbsp;</td>
