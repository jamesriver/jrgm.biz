    ...
    <div class="centrecontent_inner">
      ...
      <form class="css_form" action="dailysheet_select_crew.cfm" method="post">
        <table border="0" cellpadding="0" cellspacing="0">
          <tr class="header2">
            <td class="dailysheet_header">Select Crew Leader
            </td>
            <td class="dailysheet_header">Select Date</td>
          </tr>
          <tr>
            <td align="left"><cfquery name="get_employees" datasource="jrgm">
SELECT [Employee ID] AS Employee_ID,position,[Name FirstLast] AS Employee_Name,[Ph Home] AS homephone,[Ph Cell] As cellphone FROM app_employees 
WHERE Direct_Supervisor_ID = #SESSION.userid# AND active_record =1
</cfquery>
              <fieldset>
