...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      <form action="dailysheet_select.cfm" method="post">
        <table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td   align="left" nowrap="nowrap"><input type="text" name="dsid" class="search square" placeholder="Search..." />
      ...
      <cfif not isNumeric(url.start) or url.start lt 1 or url.start gt get_daily_sheets_for_supervisor.recordCount or round(url.start) neq url.start>
        <cfset url.start = 1>
      </cfif>
      <cfset totalPages = ceiling(get_daily_sheets_for_supervisor.recordCount / perpage)>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="0">
        <tr class="arialfont">
          <td>[
            ...
            /
            <cfif (url.start + perpage - 1) lt get_daily_sheets_for_supervisor.recordCount>
              <cfset link = cgi.script_name & "?start=" & (url.start + perpage)>
              <cfoutput><a href="#link#">Older Daily Sheets</a></cfoutput>
              <cfelse>
            </cfif>
            ] </td>
          <td><cfoutput> You are on page #thisPage# of #totalPages#. </cfoutput> </td>
        </tr>
      </table>
      <table class="sortable" cellpadding="0" cellspacing="0" width="98%">
        ...
        <tbody>
          ...
          <cfoutput query="get_daily_sheets_for_supervisor" startrow="#url.start#" maxrows="#perpage#">
