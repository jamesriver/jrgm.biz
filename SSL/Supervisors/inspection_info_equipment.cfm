...
<br />
     ...
     <div class="header">Enter Inspection Information</div>
     <form   class="css_form"  method="post" action="inspection_info_equipment.cfm"  >
    <table border="0" cellspacing="0" cellpadding="0" ><tr>
       ...
       <table border="0" cellspacing="0" cellpadding="0" >
         ...
         <tr>
           <td class="statusTD_right"><strong>Inspection Date :</strong></td>
           <td class="statusTD_right"><input type="text" id="datepicker" name="inspection_date" />
            </td>
         </tr>
     <!---   <tr>
       ...
       <tr>
         ...
         <td class="statusTD_right"><input name="inspection_hours" type="text" size="8" maxlength="8" /></td>
       </tr>
       <tr>
         <td class="statusTD_right"><strong>Mileage:</strong></td>
         <td class="statusTD_right"><input name="inspection_mileage" type="text" size="10" maxlength="10" /></td>
       </tr>
       </table>
        <div align="right">
