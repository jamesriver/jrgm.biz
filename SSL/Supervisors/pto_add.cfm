 ...
 ORDER by  Last_name ASC,first_name ASC
        ...
        <form class="css_form" action="pto_add.cfm" method="post">
          <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td nowrap="nowrap" class="statusTD_right" align="right"> Branch : <cfoutput>#SESSION.BRANCH#</cfoutput></td>
            </tr>
            <tr>
        ...
        <form class="css_form" action="pto_add.cfm" method="post">
          <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr >
              <td colspan="2" align="left"  class="arialfontred" height="30">Please choose a date to proceed</td>
            </tr>
            </cfif>
            <tr>
