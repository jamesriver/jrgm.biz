  ...
  <div id="centrecontent">
   <cfinclude template="includes/subbar.cfm">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td nowrap="nowrap" class="header">Employees that answered &quot;I do not agree&quot; to injury signout question</td>
        </tr>
      </table>
    ...
    <tbody>
        ...
        SELECT * FROM 
       app_employee_payroll_clock WHERE IsEmpInjury =0 AND   Supervisor = #SESSION.userid#
       ORDER by ds_date desc
          </cfquery>
       
        <cfoutput query="get_employees_CompleteHours">   
        <cfquery name="get_employees_name" datasource="jrgm" cachedwithin="#createTimespan(0,8,0,0)#">
