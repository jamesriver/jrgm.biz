...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      <cfquery name="get_inspections" datasource="jrgm">
...
order by  Inspection_Date DESC
      ...
      <div class="header"> Inspection Form List  -<cfoutput>#get_inspections.RECORDCOUNT#</cfoutput> Reports</div>
...
WHERE  employee_ID =  #Crew_LeaderID# 
         ...
         <!---      <td>-</td> --->
          ...
          <CFIF  Inspection_Type EQ 'Morning'>   <td><a href="Morning_Inspection_Form.cfm?Inspection_ID=#Inspection_ID#" >View</a></td></CFIF>
            <CFIF  Inspection_Type EQ 'Evening'>   <td><a href="Evening_Inspection_Form.cfm?Inspection_ID=#Inspection_ID#" >View</a></td></CFIF>
        <CFIF  Inspection_Type EQ 'Weekly'>   <td><a href="Weekly_Equipment_Maintenance_Form.cfm?Inspection_ID=#Inspection_ID#" >View</a></td></CFIF>
            </tr>
          </cfoutput>
        </tbody>
      </table>
