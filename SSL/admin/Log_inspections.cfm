...
SELECT     ID, equipment_id, inspection_date, inspection_employee_id, inspection_mileage, inspection_hours, enter_date, entered_by
FROM         equipment_inspections
ORDER BY ID DESC
</cfquery>
      <div class="header">Inspection Log - <cfoutput>#get_inspections.recordcount#</cfoutput> Inspections</div>
      <table class="sortable" cellpadding="0" cellspacing="0" width="95%">
        <thead>
          <tr>
            ...
            <th align="left">Inspection Entered By</th>
          </tr>
        </thead>
        <tbody>
...
WHERE  ID =  #equipment_id# 
    ...
    <td><a href="history_allocation.cfm?ID=#ID#">#get_equipment_info_cache.equipment_id#</a></td>
