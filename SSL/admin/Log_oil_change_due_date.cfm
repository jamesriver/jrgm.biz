...
SELECT     ID,   Category, Product_description, Product_name,  Date_Purchased, Equipment_ID, 
   hours_mileage, mileage_eq, hours_eq, oil_change_date_due, 
                      ...
                      date_sent_to_mechanic, repair_last_completed_date, last_inspection_date, pended_repair_date, oil_change_criteria , Branch_code,BRANCH_NAME,Crew_assignment_last
FROM         equipment where hours_mileage = 3  AND inventory_status > 0 <!---AND   oil_change_date_due IS NOT NULL ---> AND BRANCH_NAME <> 'Test'
ORDER BY ID ASC
</cfquery>
      <div class="header">Oil Change Due - Date</div>
...
WHERE  employee_ID =  #Crew_assignment_last# 
              ...
              <td align="right" nowrap="nowrap">#dateformat(oil_change_date_due,"mm/dd/yy")#</td>
              <td align="center" nowrap="nowrap"><cfif  oil_change_date_due LT todayDate>
