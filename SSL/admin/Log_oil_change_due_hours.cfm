...
FROM         equipment where hours_mileage = 1   AND inventory_status > 0 <!---AND oil_change_hours_due > 0--->  AND BRANCH_NAME <> 'Test'
ORDER BY ID DESC
</cfquery>
      <div class="header">Oil Change Due - Hours</div>
...
WHERE  employee_ID =  #Crew_assignment_last# 
              ...
              <td>#Category#</td>
              <td align="center"><a href="history_allocation.cfm?ID=#ID#">#equipment_id#</a></td>
              <td align="right" nowrap="nowrap">#dateformat(last_oil_change_date,"mm/dd/yy")#</td>
              <td align="right" nowrap="nowrap">#NumberFormat(last_oil_change_hours,"999,999")#</td>
              <td align="right" nowrap="nowrap">#NumberFormat(oil_change_hours_due,"999,999")#</td>
              <td align="right" nowrap="nowrap"><cfif hours_eq NEQ "">
                  #NumberFormat(hours_eq,"999,999")#
                </cfif></td>
              <td align="center" nowrap="nowrap"><cfif  hours_eq GT oil_change_hours_due>
