      ...
      <cfoutput query="get_checklist_info">
        <table width="100%" class="tableadmin" border="0" cellpadding="0" cellspacing="0">
          <tbody>
            ...
            <tr>
              <td>Brakes fluid reservoir level</td>
              <td>#BrakesFluid# </td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>Turn signals/4-way flashers</td>
              <td>#TurnSignal# </td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>Radiator coolant level/Condition of Hoses Brakes</td>
              <td>#Radiator# </td>
              <td>&nbsp;</td>
              <td>Flares</td>
              <td>#Saf_Flares# </td>
            ...
            <tr>
              <td width="40%" ><strong>TRAILER</strong></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
