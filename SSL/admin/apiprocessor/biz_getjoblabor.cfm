...
<cfquery name="main_query" datasource="jrgm">
    SELECT TOP 2500 ajsae.Job_ID, ajsae.Service_ID, ajsae.Employee_ID, ajsae.Total_Time, ajsae.Service_Time_In, ajsae.ds_id FROM dbo.app_job_services_actual_employee ajsae
    ...
    ORDER BY aj.branch, aj.[Wk Location Name], ajsae.Service_Time_In, ajsae.Service_ID
</cfquery>
<cfset cv = 0>
