...
<cfquery name="main_query" datasource="jrgm">
    SELECT TOP 2500 ajma.Job_ID, ajma.Item_ID, ajma.crew_leader, ajma.Quantity_used, ajma.Service_Date, ajma.ds_id FROM dbo.app_job_materials_actual ajma
    ...
    ORDER BY aj.branch, aj.[Wk Location Name], ajma.Service_Date, ajma.Item_ID
</cfquery>
<cfset cv = 0>
