...
<cfif IsDefined('form.timestamp_new') AND IsDefined('form.timestamp_old')>
    <cfset table_names = ["app_jobs", "quote_start", "quote_main", "quote_data_entry_headers", "quote_data_entry_row", "quote_notes", "app_employees", "app_employee_passwords", "app_crews", "app_events"]>
