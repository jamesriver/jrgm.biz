...
<cfquery name="main_query" datasource="jrgm">
    SELECT Responsible_User_Employee_ID, [Name FirstLast] as Name_FirstLast FROM quote_start
    INNER JOIN app_employees ON app_employees.[Employee ID]=quote_start.Responsible_User_Employee_ID
