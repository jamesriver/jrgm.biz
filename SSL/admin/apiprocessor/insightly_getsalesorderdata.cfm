...
<cfif IsDefined('form.opportunity_id')>
    <cfquery name="main_query" datasource="jrgm">
        SELECT *, Grounds_Maintenance_Contract as Full_Grounds_Maintenance_Contract FROM dbo.quote_main
    ...
    <cfloop query="main_query">
        <cfset output_str = opportunity_id & "|" & Full_Grounds_Maintenance_Contract& "|" & Irrigation_Contract& "|" & Seasonal_Color_Contract& "|" & contract_start_date& "|" & contract_end_date& "|" & contract_installments>
    </cfloop>
