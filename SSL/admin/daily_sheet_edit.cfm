...
<cfif get_ds.ds_date.ds_date GT '12/05/15'><cflocation url="daily_sheet_edit2.cfm?dsid=#url.dsid#"></cfif>
<cfabort>
...
<CFIF NOT IsDefined("url.BRANCH")>
  <cfset url.BRANCH = #get_supervisor.branch#>
</CFIF>
...
<div id="centrecontent">
  ...
  <div class="redtype">Please add all employees to the new daily sheet first and then add jobs.</div>
    ...
    <table width="100%" border="0" cellpadding="0"  >
      <tr>
        <td><table width="100%"   border="0" cellpadding="0" cellspacing="0" class="dailysheet_table_top" >
            <tr>
              <td align="left" nowrap="nowrap" class="dailysheetEditTop" >Date : <cfoutput>#DateFormat(ds_date, "mmmm dd, yyyy")#</cfoutput>
              <br>DSID : <cfoutput query="get_ds">#ID#</cfoutput></td>


              <td align="left" class="dailysheetEditTop">Supervisor : <cfoutput>#get_supervisor.employeename#</cfoutput><br>Crew Leader : <cfoutput>#get_crew_leader.employeename#</cfoutput>
</td>
              <td align="center"> 
			  ...
			  <cfoutput><a href="daily_sheet_edit_add_job1.cfm?ds_id=#dsid#&branch=#url.branch#" class="greenbuttonsm">Add a Job</a></cfoutput></td></tr>
          </table>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dailysheet_table" >
            ...
            <cfoutput query="get_employees_for_Crew_Leader">
              <tr>
                ...
                <!--- 	 <cfif ds_date GT #APPLICATION.blockdate# >  ---><a href="daily_sheet_edit_employee_time1.cfm?ds_id=#dsid#&Employee_ID=#get_employees_for_Crew_Leader.Employee_ID#&branch=#url.branch#"><i class="fa-orange fa-pencil-square"></i></a>
                   <!---   </cfif> ---></td>
...
WHERE Employee_ID =#get_employees_for_Crew_Leader.Employee_ID# AND ds_id = #dsid# AND in_out_status =1
            ...
            <tr> <cfoutput>
                <td align="left" colspan="8" class="dstable"><a href="daily_sheet_edit_add_employee.cfm?" onclick="javascript:void window.open('daily_sheet_edit_add_employee.cfm?dsid=#dsid#&branch=#url.branch#','1384819222444','width=800,height=400,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=300,top=20');return false;"><i class="fa-green fa-plus-square"></i><span class="greentype">Add Employee</span></a> </td>
              </cfoutput>
            </tr>
        <!---     </cfif> --->
          </table>
		...
		SELECT [Wk Location Name] AS event_name FROM app_jobs
 		 ...
 		 WHERE ds_id = #dsid# AND job_clock_id =#get_this_job.ID# ORDER BY  ID ASC
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="dailysheet_table" >
              <cfoutput>
                <tr>
                  <td width="25"  align="center" valign="middle"  class="dstable_headersm1"><a href="daily_sheet_edit_job1.cfm?ID=#get_this_job.ID#&ds_id=#dsid#&branch=#url.branch#"><i class="fa-orange fa-pencil-square"></i></a></td>
   ...
   It needs to loop through the each employee job_services  --->
		...
		AND ds_id = #dsid# 
              ...
              <cfoutput query="get_employee_time_services" >
                ...
                <!--- <cfoutput> --->
                <tr>
                  <td width="25" align="center"  nowrap="nowrap" class="dstable"><a href="daily_sheet_edit_employee_service_time1.cfm?ds_id=#dsid#&Employee_ID=#get_employee_time_services.Employee_ID#&JOB_clock_ID=#get_employee_time_services.job_clock_id#&totalminutes=#totalminutes_this_job#&branch=#url.branch#"><i class="fa-orange fa-pencil-square"></i></a></td>
              ...
              <cfoutput query="get_materials_used">
                <tr>
                  <td width="25" align="center" nowrap="nowrap" class="dstable" ><strong><a href="daily_sheet_edit_materials1.cfm?ds_id=#dsid#&MATID=#get_materials_used.ID#&branch=#url.branch#"><i class="fa-orange fa-pencil-square"></i></a></strong></td>
              ...
              <tr>
				...
				<cfoutput><a href="daily_sheet_edit_add_materials1.cfm?dsid=#dsid#&job_clock_id=#get_this_job.ID#&branch=#url.branch#"><i class="fa-green fa-plus-square"></i><span class="greentype">Add Materials</span></a></cfoutput>
                <cfoutput><a href="daily_sheet_edit_add_employee_job.cfm?" onclick="javascript:void window.open('daily_sheet_edit_add_employee_job.cfm?dsid=#dsid#&job_clock_id=#get_this_job.ID#&branch=#url.branch#','1384819222444','width=800,height=400,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=300,top=20');return false;"><i class="fa-green fa-plus-square"></i><span class="greentype">Add Employee to this Job</span></a></cfoutput>          
                <cfif get_this_job_lunch.Lunch_Time_In EQ "">
                <cfoutput><a href="daily_sheet_edit_add_lunch1.cfm?ds_id=#dsid#&job_clock_id=#get_this_job.ID#&branch=#url.branch#"><i class="fa-green fa-plus-square"></i><span class="greentype">Add Lunch to this Job</span></a></cfoutput>
                  <cfelse>
                </cfif></td>
              </tr>
            </table>
