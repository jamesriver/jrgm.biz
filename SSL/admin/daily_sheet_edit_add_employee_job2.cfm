...
SELECT         employee_branch 
FROM      app_employee_passwords WHERE Employee_ID   =  #get_DSID_info.supervisor_id#
 </cfquery>
...
WHERE branch = '#get_branch.employee_branch#'  AND    active_record = 1 AND  [Employee ID] IN (#mylistonjobmissing#)
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb"> <li> <a href="default.cfm">Home</a><i class="fa fa-circle"></i> </li>
          <li> <a href="daily_sheet_listing.cfm">Daily Sheet</a><i class="fa fa-circle"></i> </li> <li> <!---<a href="daily_sheet_edit2.cfm?dsid=<cfoutput>#form.ds_id#</cfoutput>">--->Edit Daily Sheet<!---</a>---><i class="fa fa-circle"></i> </li>
      ...
      <div class="row">
        <div class="col-md-12">
          <cfif get_branch_employees_missing.recordcount EQ 0>
            ...
            <cfoutput> <a href="daily_sheet_edit2.cfm?dsid=#dsid#&DS_ID=#dsid#" class="btn btn-primary">Back to Daily Sheet</a> </cfoutput>
            <cfabort>
          </cfif>
...
SELECT  [Employee ID], [Name FirstLast] AS employeename FROM app_employees WHERE  [Employee ID]=  #form.EMPLOYEEID#  
          ...
          <cfoutput> <a href="daily_sheet_edit2.cfm?dsid=#dsid#&DS_ID=#dsid#" class="btn btn-primary">Back to Daily Sheet</a> </cfoutput> </div>
      </div>
