...
<cfif IsDefined("form.ds_id") AND  IsDefined("form.submit") AND  IsDefined("form.job_clock_name")>
  <cfif  Job_Time_Out LTE Job_Time_In>
    <!---  <cfabort> --->
    <cfoutput>
      <cflocation url="daily_sheet_edit_add_job1.cfm?ds_id=#ds_id#&error=time&branch=#url.branch#">
    </cfoutput>
  </cfif>
</cfif>
<cfif IsDefined("form.ds_id") AND  IsDefined("form.submit") AND  IsDefined("form.job_clock_name")>
...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
        ...
        <table   border="0" cellpadding="3" cellspacing="0" class="arialfont" >
          <tr>
            <td align="left" nowrap="nowrap" >The job has been aded to the daily sheet.<br />
              ...
              <cfoutput>
                <p><a href="daily_sheet_edit.cfm?dsid=#form.ds_id#&branch=#url.branch#"  class="dssbutton">Back to Daily Sheet</a>&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;<a href="daily_sheet_edit_add_job1.cfm?ds_id=#form.ds_id#&branch=#url.branch#" class="dssbutton">Add Another Job</a>&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;<a href="daily_sheet_edit_add_lunch1.cfm?ds_id=#form.ds_id#&job_clock_id=#getmaxid.newid#&branch=#url.branch#" class="dssbutton">Add Lunch to this Job</a></p>
              </cfoutput>
             </td>
          </tr>
        </table>
      ...
      <form  method="post" action="daily_sheet_edit_add_job1.cfm?branch=<cfoutput>#url.branch#</cfoutput>" >
        ...
        <table border="0" cellspacing="0" cellpadding="0" >
          ...
          <cfoutput>
            ...
            <cfif IsDefined("url.error")>
              <tr>
                <td colspan="7" align="right" nowrap="nowrap" class="dailysheetEdit"><span class="redarial">The Job End Time MUST be after the Job Start Time</span> </td>
              </tr>
            </cfif>
      ...
      <table   border="0" cellspacing="1" cellpadding="0">
        <cfoutput>
          <tr>
            <td width="200" nowrap="nowrap"><a href="daily_sheet_edit.cfm?dsid=#ds_id#&branch=#url.branch#" class="dssbutton">Back to Daily Sheet</a> </td>
            <td width="200">&nbsp;</td>
            <td><br />
               </td>
          </tr>
