...
<cfif IsDefined("form.ds_id") AND  IsDefined("form.submit") AND  IsDefined("form.job_clock_name")>
  <cfif  Lunch_end_time LTE Lunch_start_time>
    ...
    <cfoutput>
      <cflocation url="daily_sheet_edit_add_lunch1.cfm?ds_id=#ds_id#&job_clock_id=#job_clock_id#&error=time&branch=#url.branch#">
    </cfoutput>
  </cfif>
</cfif>
<cfif IsDefined("form.ds_id") AND  IsDefined("form.submit") AND  IsDefined("form.job_clock_name")>
...
<div id="outerfull">
 ...
 WHERE [Job ID] ='#get_this_job.job_id#'
      ...
      <form  method="post" action="daily_sheet_edit_add_lunch1.cfm?branch=<cfoutput>#url.branch#</cfoutput>" >
