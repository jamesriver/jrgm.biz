...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      <form  method="post" action="daily_sheet_edit_employee_service_time1.cfm?branch=<cfoutput>#url.branch#</cfoutput>"   >
        <table border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr> <cfoutput>
              <td colspan="4" align="left" class="dailysheetEditTop"><a href="daily_sheet_edit.cfm?dsid=#ds_id#&branch=#url.branch#" class="dssbutton">Back to Daily Sheet</a></td>
            </cfoutput>
          ...
          <tr>
            <td colspan="10" align="left" class="dailysheetEditTop"><cfif   
