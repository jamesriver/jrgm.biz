<cfif  IsDefined("SESSION.access_role")  AND SESSION.access_role EQ  '94'    OR    SESSION.access_role EQ  '97' >
  ...
  Click<a href="<cfoutput>#referringPage#</cfoutput>">Here</a>to go back to the page you just came from.<br />
  This does not mean you are going back but rather being forwarded on to the page you came from.<br />
  You get it?
   ...
   DELETE   FROM APP_Lunch WHERE DS_ID =#url.dsid#
    ...
    <form action="daily_sheet_listing.cfm" method="post">
      <table width="90%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td nowrap="nowrap"><div class="header"> Administrative &#8212; Daily Sheet Listing (Corporate Only)</div></td>
...
FROM   app_employees WHERE [Employee ID] =#get_daily_sheets.supervisor_id#
          ...
          <tr>
            ...
            <td align="left"><!---#get_info_S.branch#--->Corporate</td>
