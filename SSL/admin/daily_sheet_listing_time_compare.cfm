...
<div class="centrecontent_inner">
    <form action="daily_sheet_listing_time_compare.cfm" method="post"> 
        ...
        <tr>
          <td nowrap="nowrap"><div class="header">Administrative &#8212; Daily Sheet Listing</div></td>
 ...
 SELECT  ID, Supervisor_ID, Crew_Leader_ID, DS_Date FROM app_daily_sheets 
WHERE ds_date < '#todaydate_DS#' 
