...
<CFIF IsDefined("url.work_date")>
 ...
 INSERT INTO  app_daily_sheets (Supervisor_ID, Crew_Leader_ID, DS_Date, record_created,entry_method) VALUES ( #form.Supervisor_ID#, '#form.CREW_LEADER_ID#','#form.ds_date#',CURRENT_TIMESTAMP,2 )
 </cfquery>
 ...
 SELECT employee_branch from app_employee_passwords WHERE employee_id = #form.Supervisor_ID#
 </cfquery>
  </cfif> 
...
WHERE <!--- branch IN   (#PreserveSingleQuotes(branchlist)#)  AND --->    active_record = 1  AND branch <>'Test'
