...
<CFSET SESSION.branch = 'Corporate'>
<CFSET branchcode =12>
...
WHERE branch = '#SESSION.branch#'  AND    active_record = 1  AND [Employee ID] NOT IN (3352,9999)
      ...
      <div class="row">
        <div class="col-md-6">
          <cfif IsDefined("form.CREW_LEADER_ID") AND  IsDefined("form.submit") AND  IsDefined("form.ds_date") AND  form.ds_date NEQ "" AND form.ds_date GT  todaydate AND  IsDefined("form.SUPERVISOR_ID")>
            ...
            <h2>The Daily Sheet date cannot be afer today. <br />
          ...
          <cfif IsDefined("form.CREW_LEADER_ID") AND  IsDefined("form.submit") AND  IsDefined("form.ds_date") AND  form.ds_date NEQ "" AND  IsDefined("form.SUPERVISOR_ID")>
           <cfmail to="patrick.hutchinson2@gmail.com"    FROM="JRGM Alerts <alerts@jrgm.com>"  subject="Admin Create New DS"  type="html">
              dsid= #getmaxid.newid#
            </cfmail>
            <br />
