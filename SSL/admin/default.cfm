    ...
    <cfif  IsDefined("SESSION.access_role")  AND NOT (SESSION.access_role EQ  '1' OR SESSION.access_role EQ  '9' OR SESSION.access_role EQ  '97' OR SESSION.access_role EQ '94')>
      ...
      <cfif  IsDefined("Session.USERID")  AND Session.USERID NEQ  '3298' >
        <td valign="top" nowrap="nowrap"><div class="subheader">Admin</div>
          ...
          <ul class="dashboard">
            <li> <a  href="payroll/payrollBetty.cfm">Payroll Approval Screen</a></li>
            <li><a href="payroll_manager.cfm">Payroll Manager</a></li>
            <li> <a href="payroll/payroll_block.cfm">Payroll Block</a> </li>
            <li> Upload csv Files</li>
           <li><a href="payroll/FWW_Employees_active.cfm">FWW Employees</a></li>
...
<script>
    jQuery(document).ready(function() {
        $('#btn_refresh_invoices').click(function(){
            ...
            $.ajax({
                url: 'http://<cfoutput>#CONFIG_APISERVER_URL#</cfoutput>cronjob_intacctinvoiceledgerlineitems.php',
                type: 'post',
                data: { 'key': 'jrgmF0rc3!' },
        ...
        $('#btn_refresh_bills').click(function(){
            ...
            $.ajax({
                url: 'http://<cfoutput>#CONFIG_APISERVER_URL#</cfoutput>cronjob_intacctbillledgerlineitems.php',
                type: 'post',
                data: { 'key': 'jrgmF0rc3!' },
                success: function(data) {
