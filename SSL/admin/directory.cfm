...
<div id="centrecontent">
  ...
  <div class="centrecontent_inner">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <section>
          <header>
            <span class="subheader">Active JRGM Employees</span>
          </header>
          <div class="content">
  ...
  <tr>
    ...
    <td><a href="mailto:#email#">#email#</a></td> 
     <td><a href="employee_details.cfm?employee_id=#get_branch_employees.Employee_ID#&work_date=#todayDate#">Notes</a></td>
      <td><a href="payroll_view_employee_detail.cfm?empid=#get_branch_employees.Employee_ID#">Payroll</a></td>
  </tr>
        ...
        <section>
          <header>
            <span class="subheader">Active JRGM Employees Usernames &amp; Passwords</span>
          </header>
          <div class="content">
...
ORDER by  lastname ASC,firstname ASC
    ...
    <tbody>
  <cfoutput query="get_branch_employees_PW">
   <tr>
    <td>#employee_id#</td>
    <td>#firstname#</td>
    <td>#lastname#</td>
    <cfif access_role EQ 98> 
    <CFSET postition ='Regional Admin'>
     <cfelseif access_role EQ 97>
	<CFSET postition ='Estimator'>
     <cfelseif access_role EQ 96>
	<CFSET postition ='Administrative Assistant'>
     <cfelseif access_role EQ 95>
	<CFSET postition ='Administrative'>
    <cfelseif access_role EQ 10>
	<CFSET postition ='Regional Manager'>
    <cfelseif access_role EQ 9>
    <CFSET postition ='Branch Manager'>
      <cfelseif access_role EQ 8>
    <CFSET postition ='Mechanic'>
     <cfelseif access_role EQ 7>
    <CFSET postition ='Spray Tech'>
      <cfelseif access_role EQ 6>
    <CFSET postition ='Irrigation Tech'>
  ...
  <td>#employee_branch#</td>  
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <section>
          <header>
            <span class="subheader">Active JRGM Employees Usernames &amp; Passwords -NEW</span>
          </header>
          <div class="content">
...
<tr>
  <th align="left">Emp ID</th>
   ...
   <cfquery name="get_branch_employees_PW" datasource="jrgm"  >
SELECT   ID, Employee_ID, username, password, employee_name, access_role, employee_active, firstname, lastname, employee_branch, email
FROM app_employee_passwords_new
WHERE      employee_active = 1
ORDER by  lastname ASC,firstname ASC
</cfquery>
    <tbody>
  ...
  <td>#employee_branch#</td>  
        ...
        <section>
          <header>
            <span class="subheader">Active JRGM Jobs </span>
          </header>
          <div class="content">
...
SELECT ID, [Job ID] as jobid, [Wk Loc ID], [Wk Location Name] AS locationname, [Service Address] AS jobaddress1, [Service Address2] AS jobaddress2, [Service City] AS jobcity, [Service State] AS jobstate , [Service Zip] AS jobzip, [Acct Mgr] AS acctmgr, [Crew Leader] AS crewleader,branch
 FROM APP_jobs   WHERE      active_record = 1 
  ORDER by  locationname ASC
</cfquery>
<tbody>
  <cfoutput query="get_branch_jobs"> <tr>
    <td nowrap="nowrap">#jobid#</td>
     <td nowrap="nowrap">#locationname#</td>
      <td nowrap="nowrap">#jobaddress1#</td>
      <td nowrap="nowrap">#jobcity#</td>
    <td nowrap="nowrap" align="left">#Branch#</td>
