...
SELECT inventory_status ,ID,Product_description,Product_name,Serial_Number,Equipment_ID,category,License_Plate,Equipment_Year, engine_cycle, mileage_eq,hours_eq, Date_Created, BRANCH_NAME,ISNULL(CREW_ASSIGNMENT_LAST,0),CREW_ASSIGNMENT_LAST,initial_diagnosis,oil_change_criteria,oil_change_mileage_due,oil_change_hours_due, oil_change_date_due
...
UPDATE equipment SET  crew_assignment_last = #form.EMPLOYEEID# 
 WHERE ID=#form.EquipmentID#
  ...
  <cfquery name="getequipment_this" datasource="jrgm">
SELECT inventory_status ,ID,Product_description,Product_name,Serial_Number,Equipment_ID,category,License_Plate,Equipment_Year, engine_cycle, mileage_eq,hours_eq, Date_Created, BRANCH_NAME,ISNULL(CREW_ASSIGNMENT_LAST,0),CREW_ASSIGNMENT_LAST,oil_change_criteria,oil_change_mileage_due,oil_change_hours_due, oil_change_date_due
  FROM equipment WHERE 0=0 AND ID=#form.EquipmentID#
</cfquery>
  <CFSET url.id =form.EquipmentID>
</cfif>
...
UPDATE equipment SET  hours_eq = #form.hours_eq# 
 WHERE ID=#form.EquipmentID#
  ...
  <cfquery name="getequipment_this" datasource="jrgm">
SELECT inventory_status ,ID,Product_description,Product_name,Serial_Number,Equipment_ID,category,License_Plate,Equipment_Year, engine_cycle, mileage_eq,hours_eq, Date_Created, BRANCH_NAME,ISNULL(CREW_ASSIGNMENT_LAST,0),CREW_ASSIGNMENT_LAST,oil_change_criteria 
  FROM equipment WHERE 0=0 AND ID=#form.EquipmentID#
</cfquery>
  <CFSET url.id =form.EquipmentID>
</cfif>
...
UPDATE equipment SET  mileage_eq = #form.mileage_eq# 
 WHERE ID=#form.EquipmentID#
  ...
  <cfquery name="getequipment_this" datasource="jrgm">
SELECT inventory_status ,ID,Product_description,Product_name,Serial_Number,Equipment_ID,category,License_Plate,Equipment_Year, engine_cycle, mileage_eq,hours_eq, Date_Created, BRANCH_NAME,ISNULL(CREW_ASSIGNMENT_LAST,0),CREW_ASSIGNMENT_LAST,oil_change_criteria,oil_change_mileage_due,oil_change_hours_due, 
oil_change_date_due
  FROM equipment WHERE 0=0 AND ID=#form.EquipmentID#
</cfquery>
  <CFSET url.id =form.EquipmentID>
...
oil_change_criteria,oil_change_mileage_due,oil_change_hours_due, oil_change_date_due
...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <table width="99%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top"  width="35%"><div class="allocate_equip">
            <div class="job_data_header">Allocation</div>
            <form action="history_allocation.cfm" method="post"  name="allocateform" id="allocateform">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" nowrap="nowrap" class="alltable">Branch Allocated to:</td>
                  <td align="left" nowrap="nowrap" class="alltable"><cfoutput>#getequipment_this.branch_name#</cfoutput></td>
                </tr>
                <tr>
                  <td align="left" nowrap="nowrap" class="alltable">Allocated to:</td>
                  <td class="alltable"><cfif getequipment_this.Crew_assignment_last  EQ 3>
                      Spare
        ...
        <select    name="employeeID"  onchange="this.form.submit();" class="select_element"  >
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <cfif  getequipment_this.inventory_status EQ 2>
              <tr>
                ...
                <td colspan="3" class="alltable2"><cfoutput>#getequipment_this.initial_diagnosis#</cfoutput></td>
              </tr>
            </cfif>
            <tr>
            ...
            <form action="history_allocation.cfm" method="post"  name="allocateform" id="allocateform">
              <tr>
                <td align="left" class="alltable2">Oil Change Criteria</td>
                <td colspan="3" class="alltable2"><cfif getequipment_this.oil_change_criteria EQ 0>
                    N/A
                    <cfelseif  getequipment_this.oil_change_criteria EQ 1>
                    Hours+100
                    <cfelseif  getequipment_this.oil_change_criteria EQ 2>
                    Mileage+5000
                    <cfelseif getequipment_this.oil_change_criteria EQ 3>
                    Mileage+10000
                    <cfelseif getequipment_this.oil_change_criteria EQ 4>
                    Date+30 Days
                    <cfelseif getequipment_this.oil_change_criteria EQ 5>
                    Hours+200
                    <cfelse>
                    N/A
                  </cfif>
                  ...
                  (<cfoutput>#getequipment_this.oil_change_criteria#</cfoutput>)&nbsp;</td>
              </tr>
              <tr>
                <td align="left" class="alltable2">Next Oil Change Due</td>
                <td colspan="3" class="alltable2"><cfif getequipment_this.oil_change_criteria EQ 0>
                    N/A
                    <cfelseif  getequipment_this.oil_change_criteria EQ 1>
                    <cfoutput> #getequipment_this.oil_change_hours_due#</cfoutput>
                    <cfelseif  getequipment_this.oil_change_criteria EQ 2>
                    <cfoutput>#getequipment_this.oil_change_mileage_due#</cfoutput>
                    <cfelseif getequipment_this.oil_change_criteria EQ 3>
                    <cfoutput>#getequipment_this.oil_change_mileage_due#</cfoutput>
                    <cfelseif getequipment_this.oil_change_criteria EQ 4>
                    <cfoutput>#getequipment_this.oil_change_date_due#</cfoutput>
                    <cfelseif getequipment_this.oil_change_criteria EQ 5>
                    <cfoutput>#getequipment_this.oil_change_hours_due#</cfoutput>
                    <cfelse>
                    N/A
            ...
            <form action="history_allocation.cfm" method="post"  name="allocateform" id="allocateform">
              <tr>
                ...
                <td colspan="3" class="alltable2"><input name="mileage_eq" type="text"   tabindex="5" value="<cfoutput>#getequipment_this.mileage_eq#</cfoutput>" size="8" maxlength="8"/>
                  <input name="submit3" type="submit" class="bluebutton2"  value="Update Mileage" /></td>
              </tr>
              <cfoutput>
                <input type="hidden" name="EquipmentID"  value="#ID#" />
              </cfoutput>
          ...
          <div class="spacer20"></div>
          <div class="headerbutton">Notes</div>
          <div class="bluebuttonRT"><a href="note_addnote.cfm?ID=<cfoutput>#ID#</cfoutput>" class="bluebuttonNR" >Add Notes</a></div>
...
order by  enter_date DESC, ID DESC
        ...
        <td valign="top"><div class="equip_rtcol">
                  ...
                  <tr>
                    <td class="alltable" colspan="2">Description:
                      <div class="equip_form">
                        <textarea  name="initial_diagnosis" cols="5" rows="5" class="textarea"> </textarea>
                      </div></td>
                  </tr>
                </table>
...
order by id desc
          ...
          <div class="spacer20"></div>
          <div class="spacer20"></div>
          <div class="headerbutton">Oil Change History</div>
          <div class="bluebuttonRT"><a href="oil_change_info_equipment.cfm?ID=<cfoutput>#ID#</cfoutput>"  class="bluebuttonNR">Add Oil Change</a></div>
...
WHERE  [Employee ID] =  #get_this_equipment_inspection.entered_by#
          ...
          <cfif getequipment_this.category EQ 'Vehicles'>
            <div class="job_data_header">Mileage History From Inspection Reports</div>
