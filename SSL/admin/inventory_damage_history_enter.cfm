...
SELECT * FROM equipment WHERE ID = #url.id#
    ...
    <cfoutput  query="get_this_equipment">
       ...
       <form method="post" enctype="multipart/form-data" action="inventory_damage_history_enter2.cfm">
        <table width="95%" border="1" cellpadding="4" cellspacing="0"    bordercolor="##F3F3F3" bordercolorlight="White">
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4" valign="top"><strong><span class="dstableno">
                <input name="damage_date" type="text" id="damage_date"    tabindex="4" size="12" maxlength="12"   />
&nbsp; </span></strong><span class="dstableno"><strong>(mm/dd/yyyy)</strong></span></td>
            </tr>
            <tr>
              <td align="right" valign="top" nowrap="nowrap" class="dstableno">Damage Notes</td>
              <td colspan="4" valign="top"><textarea name="equipment_notes" id="textarea" cols="45" rows="5"></textarea><label for="textfield"></label></td>
              </tr>
            <tr>
              ...
              <td colspan="4"><span class="dstableno">  <input name="damagepix1" type="file"   title="damagepix1" id="damagepix1"  size="25" /></span>&nbsp;</td>
                ...
                <tr>
              <td height="34" align="right" nowrap="nowrap" class="dstableno">Upload Picture&nbsp;2</td>
              <td colspan="4"> <span class="dstableno"> <input name="damagepix2" type="file"   title="damagepix2" id="damagepix2" size="25" /></span>&nbsp;</td>
              </tr>
              
                <tr>
              <td height="34" align="right" nowrap="nowrap" class="dstableno">Upload Picture&nbsp;3</td>
              <td colspan="4"> <span class="dstableno"> <input name="damagepix3" type="file"    title="damagepix3" id="damagepix3" size="25" /></span>&nbsp;</td>
              </tr>
              
                <tr>
              <td height="34" align="right" nowrap="nowrap" class="dstableno">Upload Picture&nbsp;4</td>
              <td colspan="4"> <span class="dstableno"> <input name="damagepix4" type="file"   title="damagepix4" id="damagepix4"  size="25" /></span>&nbsp;</td>
              </tr>
              
                <tr>
              <td height="34" align="right" nowrap="nowrap" class="dstableno">Upload Picture&nbsp;5</td>
              <td colspan="4"><span class="dstableno"><input name="damagepix5" type="file"    title="damagepix5" id="damagepix5" size="25" /></span>&nbsp;</td>
              </tr>
            <tr>
            
              <td height="34" align="right" nowrap="nowrap" class="dstableno">&nbsp;</td>
              <td>&nbsp;</td>
        ...
        <input type="hidden"  name="ID" value="#ID#"/>
           <input type="hidden"  name="entry_type" value="damage"/>
          <input type="hidden"  name="MODIFIED_BY" value="#SESSION.userid#"/>
