...
<cfquery name="add_equipment_history_insert" datasource="#request.dsn#">
SET NOCOUNT ON INSERT INTO equipment_history (EQUIPMENT_ID,enter_date, equipment_notes,entry_type,
damage_date,
MODIFIED_BY)   
VALUES 
('#form.ID#',CURRENT_TIMESTAMP,'#equipment_notes#', '#entry_type#',
<cfif damage_date EQ "">
NULL,
 <cfelse>
 '#form.damage_date#',
...
SELECT @@identity AS newid SET NOCOUNT OFF
 ...
 <CFSET new_ID= #add_equipment_history_insert.newid#>
 
  
   <cfif isDefined("damagepix1") AND    Len(damagepix1) GT 1  > 
     <cffile action = "upload"  
        fileField = "damagepix1"  
        destination = "C:\inetpub\websites\jrgm.biz\SSL\admin\damagepix\#new_ID#_1.jpg" 
