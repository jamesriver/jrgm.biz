...
SELECT * FROM equipment_history WHERE ID = #url.id#
      </cfquery>
      
      
 <cfquery name="get_this_equipment" datasource="jrgm">
SELECT * FROM equipment WHERE ID = #get_this_equipment_history.equipment_ID#
 </cfquery> 
    ...
    <cfoutput  query="get_this_equipment">
         <table width="95%" border="1" cellpadding="4" cellspacing="0"    bordercolor="##F3F3F3" bordercolorlight="White">
          <tbody>
            ...
            <tr>
              <td height="34" align="right" nowrap="nowrap" class="dstableno">Upload Pictures</td>
              <td colspan="4" class="dstableno">Yes/No&nbsp;</td>
              </tr>
