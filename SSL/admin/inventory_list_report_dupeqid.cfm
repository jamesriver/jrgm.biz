...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      <cfquery name="getdup_EQID" datasource="jrgm">
SELECT Equipment_ID, COUNT(Equipment_ID) AS countsn FROM equipment 
WHERE Equipment_ID <> ''
 GROUP by Equipment_ID
HAVING COUNT(Equipment_ID) > 1
 </cfquery>
      <div class="header">Inventory List - Duplicate Equipment ID Numbers-<cfoutput>#getdup_EQID.recordcount#</cfoutput> Records</div>
      <cfloop query="getdup_EQID">
        <cfif getdup_EQID.countsn GT 1>
          <cfquery name="getequipment" datasource="jrgm">
SELECT * FROM equipment  WHERE  Equipment_ID = '#getdup_EQID.Equipment_ID#'
</cfquery>
          ...
          <tbody>
            <cfoutput query="getequipment">
              <tr>
                ...
                <td align="left">#Equipment_Year#</td>
