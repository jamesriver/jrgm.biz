...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      <cfquery name="getdup_SN" datasource="jrgm">
SELECT Serial_number, COUNT(Serial_number) AS countsn FROM equipment 
WHERE Serial_number <> ''
 GROUP by Serial_number
HAVING COUNT(Serial_number) > 1
 </cfquery>
      <div class="header">Inventory List - Duplicate Serial Numbers-<cfoutput>#getdup_SN.recordcount#</cfoutput> Records</div>
      <cfloop query="getdup_SN">
        <cfif getdup_SN.countsn GT 1>
          <cfquery name="getequipment" datasource="jrgm">
SELECT * FROM equipment  WHERE  Serial_number = '#getdup_SN.Serial_number#'
</cfquery>
