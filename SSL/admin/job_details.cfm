...
<div id="outerfull">
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      </cfoutput> <cfoutput> <a href="notes.cfm?job_id=#job_id#" class="bluebutton">Add Notes</a></cfoutput> <cfoutput> <a href="view_notes.cfm?job_id=#job_id#" class="bluebutton">View Notes</a></cfoutput> </div>
  </div>
  <!-- to clear footer -->
</div>
<!-- end outer div -->
