  ...
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner_pop"> <br />
      ...
      <cfif IsDefined("form.submit")   AND  form.OIL_CHANGE_DATE IS "">
        <span class="arialfontredbig">You must enter an oil change date.<br />
        Please <a href = "javascript:history.back()">go back</a> and enter an oil change date.</span>
        <cfabort>
      </cfif>
      <cfif IsDefined("form.submit")   AND  form.EMPLOYEEID EQ 0>
        <span class="arialfontredbig"> You must enter an Oil Changed By name.<br />
        Please <a href = "javascript:history.back()">go back</a> and enter an Oil Changed By name.</span>
        <cfabort>
      </cfif>
          ...
          <tr>
            ...
            <td valign="top"><table border="0" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                  ...
                  <td class="statusTD_right"><input type="text" id="datepicker" name="oil_change_date" /></td>
                  <td class="arialfontred"  nowrap="nowrap">Required Field</td>
                </tr>
                <!--- Get Employee List --->
