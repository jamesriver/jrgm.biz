  ...
  <div class="page-content">
    <div class="container-fluid"> 
      <!---<table width="90%" border="0" align="center">
        <tbody>
          <tr>
            <td><strong>This data is from the app_jobs_new table! </strong></td>
          </tr>
        </tbody>
      </table>
      <br />---> 
   ...
   <table width="90%" border="1">
      ...
      <table width="90%" border="1">
        <tbody>
          ...
          <tr>
            <td><ol>
                <li>Ben &amp; I need to make sure we're in agreement on all of the fileds in the app_jobs_new table before the changeover</li>
