...
SELECT [Job ID] AS projectid, <!---[Wk Loc ID] as projectid, --->[Wk Location Name] AS job_name, [Service Address] as project_address, [Service Address2], [Service City] as project_city, [Service State], [Service Zip],      active_record,  branch,total_project_value,  project_start_date,  project_end_date 
FROM app_jobs_new
WHERE 0=0 AND Status ='In Progress' <!---branch =  '#url.BRANCH_NAME#'   --->
...
<div class="page-container-fluid"> 
  ...
  <div class="page-content">
    <table width="95%" border="0"  align="center">
      <tbody>
        <tr>
          <td><strong>This data will come from the app_jobs once the changes from app_jobs_new table are in place.<br />
              This data is dynamic data from the app_jobs_new table<br />
              This table will be filterable , sortable and searchable.</strong><br />
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <table class="table table-striped table-bordered table-hover" id="sample_1">
        <thead>
          <tr>
            ...
            <th  nowrap="nowrap"><div align="left">Renewal Lead</div></th>
            <th >Hold<br />
              Billing</th>
        ...
        <tbody>
          <cfoutput  query="get_all_jobs">
            <tr>
              ...
              <td><a href="project_View_Project_Information.cfm?ProjectID=#projectid#&amp;job_name=#job_name#">#job_name#</a></td>
              ...
              <td  align="center">&nbsp;</td>
              <td  align="center"><!---<a class="btn btn-success btn-sm" href="project_Edit_Project_Information.cfm?ProjectID=#ProjectID#">---><a class="btn btn-success btn-sm" href="http://api.jrgm.com/staging/biz/?EmployeeID=#SESSION.userid#&action=renew_project&JobID=#ProjectID#" target="_blank">Renew</a></td>
...
FROM         app_jobs_new  WHERE status ='IN PROGRESS'
      ...
      <tbody>
        <tr>
          <td><p><strong>This data will come from the app_jobs once the changes from app_new table are in place.<br />
              This is dynamic data from the app_jobs_new table<br />
     ...
     <!--- <table class="table table-striped table-hover" id="sample_3">--->
        ...
        <tbody>
          <cfoutput  query="get_project_info">
            <tr>
              <td>#ProjectID#</td>
             <!--- <td><a href="project_View_Project_Information.cfm?z=#projectname#">#LEFT(projectname,30)#</a></td>--->
               <td><a href="project_View_Project_Information.cfm?ProjectID=#projectid#&job_name=#projectname#">#projectname#</a></td>
              <cfif  branch EQ 'Richmond' >
                <CFSET branchnew = "RIC" >
                <cfelseif  branch EQ 'Portstmouth' >
                <CFSET branchnew = "POR" >
