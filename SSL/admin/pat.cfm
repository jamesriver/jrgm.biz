   ...
   <div class="subbar">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="subbartxt"  ><a href="https://www.jrgm.biz/ssl/admin/scheduler_select-new.cfm">Log In New</a></td>
 ...
 ORDER by  Last_name ASC,first_name ASC
      ...
      <table width="95%" border="1" cellspacing="0" cellpadding="4" class="arialfont"  bordercolor="#C0C0C0" bordercolorlight="White">
        ...
        <tr>
          ...
          <td nowrap="nowrap"><cfif IsDefined("SESSION.ADP")><a href="data_load/load_adp_employees_1.cfm">Load ADP  Data-1</a></cfif></td>
...
WHERE name ='ADP_JRGM.xml'
    ...
    <CFSET  filesize = dirsOnly.size> --->
        <tr>
          ...
          <td><cfif IsDefined("SESSION.ADP")><a href="data_load/load_adp_employees_2.cfm">Load ADP Data-2</a></cfif></td>
