...
WHERE  app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' AND  app_employee_payroll_clock.Time_In < '#DateFormat(pay_period_end, "yyyy-mm-dd")# 00:00:00.000'  AND   FWW =1
...
app_employee_payroll_clock WHERE Employee_ID =#get_employees_with_time.Employee_ID#  AND app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start_week1, "yyyy-mm-dd")# 00:00:00.000' AND  app_employee_payroll_clock.Time_In < '#DateFormat(pay_period_end_week1, "yyyy-mm-dd")# 00:00:00.000' AND in_out_status =2  GROUP by Employee_ID
      		   </cfquery >
