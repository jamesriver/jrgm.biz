<div class="topbar">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="jobbutton"> 
       <!---  <a href="https://www.jrgm.biz/ssl/admin/payroll_main.cfm"><img src="images/icon_payroll.png"  width="60" height="60"  class="icons"/></a> ---> <a href="https://www.jrgm.biz/ssl/admin/daily_sheet_listing.cfm"><img src="images/icon_dailysheet.png" width="60" height="60"  class="icons"/></a>   <cfoutput><a href="https://www.jrgm.biz/ssl/admin/inventory.cfm"><img src="images/icon_inventory.png" width="60" height="60" alt="Crews" class="icons" /></a></cfoutput> 
        <cfoutput><a href="https://www.jrgm.biz/ssl/admin/directory.cfm"><img src="images/directory_icon.png" width="60" height="60" alt="Employee Directory" class="icons" /></a></cfoutput>
        </td>
