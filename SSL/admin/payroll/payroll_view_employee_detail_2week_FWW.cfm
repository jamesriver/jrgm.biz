...
<cfquery name="app_payroll_periods" datasource="jrgm">
 ...
 <cfquery name="app_payroll_periods_weeks" datasource="jrgm">
 SELECT  MIN(pay_period_week) as pay_period_week1, MAX(pay_period_week) AS pay_period_week2
 FROM app_pay_periods WHERE pay_period_number = #pay_period_number#
 </cfquery>  
...
<div id="outerfull">
 ...
 SELECT  MIN(pay_period_start) as pay_period_start, MAX(pay_period_end) AS pay_period_end
 FROM app_pay_periods WHERE pay_period_week = #app_payroll_periods_weeks.pay_period_week1#
 </cfquery>
      ...
      <table width="100%"  border="0" cellpadding="2" cellspacing="0">
        <cfoutput query="app_payroll_periods_Week1">
          <tr class="job_data">
            <td><strong> Payroll Period #DateFormat("#app_payroll_periods_Week1.pay_period_start#", "mm/dd/yy")#- #DateFormat("#app_payroll_periods_Week1.pay_period_end#", "mm/dd/yy")#</strong></td>
          </tr>
        </cfoutput>
      </table>
 ...
 SELECT  MIN(pay_period_start) as pay_period_start, MAX(pay_period_end) AS pay_period_end
 FROM app_pay_periods WHERE pay_period_week = #app_payroll_periods_weeks.pay_period_week2#
 </cfquery>
      ...
      <table width="100%"  border="0" cellpadding="2" cellspacing="0">
        <cfoutput query="app_payroll_periods_Week2">
          <tr class="job_data">
            <td><strong> Payroll Period #DateFormat("#app_payroll_periods_Week2.pay_period_start#", "mm/dd/yy")#- #DateFormat("#app_payroll_periods_Week2.pay_period_end#", "mm/dd/yy")#</strong></td>
          </tr>
        </cfoutput>
      </table>
      <cfquery name="get_employees_with_time" datasource="jrgm" >
