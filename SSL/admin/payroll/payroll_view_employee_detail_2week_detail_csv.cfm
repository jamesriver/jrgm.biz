...
<div id="outerfull">
 ...
 <cfoutput query="app_payroll_periods"> <tr class="job_data">
    <td><strong> Payroll Period #DateFormat("#begin_date#", "mm/dd/yy")#-
     #DateFormat("#pay_period_end#", "mm/dd/yy")#</strong></td>
    </tr>
  </cfoutput>
 ...
 <cfquery name="get_employees_with_time" datasource="jrgm"   maxrows="5"    >
		...
		WHERE  app_employee_payroll_clock.Time_In > #pay_period_start# AND  app_employee_payroll_clock.Time_In < #end_date_plus1#  AND FWW <> 1
 ...
 AND in_out_status =2
        ...
        <cfloop query="get_employees_with_time" >
          <tr>
            ...
            <cfoutput>  <td nowrap="nowrap">#get_employees_with_time.BRANCH#&nbsp;</td>
 ...
 <cfif BRANCH EQ 'Richmond' >
    ...
    <CFSET branchcode ='Unknown'>
         ...
         <!---   ------------------------------------------ --->
           ...
           <cfoutput>   <td align="center">#hourssum_OT2#:#NumberFormat(minutessum_OT2,"09")#</td></cfoutput><cfelse><cfset sumtime_OT2 = 0><td align="center">0</td></cfif>
