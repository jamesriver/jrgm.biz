  ...
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      <table   border="0" cellspacing="0" cellpadding="2" class="sortable" >
		...
		ON app_employee_payroll_clock.Employee_ID=APP_employees.[Employee ID]  
		WHERE  
         (app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' 00:00:00.000' AND app_employee_payroll_clock.Time_Out < #end_date_plus1#)  AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
 </cfquery>
