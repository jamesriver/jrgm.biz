  ...
  <div id="centrecontent">
    ...
    <div class="centrecontent_inner">
      ...
      <cfquery name="get_employees_with_time" datasource="jrgm" >
		...
		WHERE branch = '#url.branch#'  AND app_employee_payroll_clock.Time_In > #pay_period_start# AND  app_employee_payroll_clock.Time_In < #end_date_plus1#
      ...
      <table   border="0" cellspacing="0" cellpadding="2" class="sortable" >
		...
		ON app_employee_payroll_clock.Employee_ID=APP_employees.[Employee ID]  
		WHERE  
         (app_employee_payroll_clock.Time_In > #pay_period_start# AND app_employee_payroll_clock.Time_Out < #end_date_plus1#)  AND Employee_ID IN (#mylist#)  AND payroll_approved IS NULL
		ORDER by APP_employees.last_name
 </cfquery>
