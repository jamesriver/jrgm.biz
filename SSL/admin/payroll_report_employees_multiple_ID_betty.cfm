...
<tbody>
			...
			WHERE [Employee ID]  > 9999 AND  [Employee ID] < 99999     AND  [Employee ID]  NOT IN (SELECT employee_id FROM app_employee_passwords  WHERE access_role <>2)  AND  active_record =1
