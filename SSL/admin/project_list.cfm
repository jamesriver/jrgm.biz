<cfset filter_sql=" AND Status='IN PROGRESS'">
<cfif IsDefined('url.showall')>
    <cfset filter_sql=''>
</cfif>

<cfquery name="get_all_jobs" datasource="jrgm"  >
SELECT [Job ID] AS projectid, <!---[Wk Loc ID] as projectid, --->[Wk Location Name] AS job_name, [Service Address] as project_address, [Service Address2], [Service City] as project_city, [Service State], [Service Zip],      active_record,  branch,total_project_value,  project_start_date,  project_end_date, responsible_user_Employee_ID, project_status_checkbox, Status
FROM app_jobs
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        ...
        <cfif !IsDefined('url.showall')>
            - IN PROGRESS</h1>
            <a class="btn btn-success btn-sm" href="project_list.cfm?showall">Show ALL projects</a>
        <cfelse>
            - ALL</h1>
            <a class="btn btn-success btn-sm" href="project_list.cfm">Only show IN PROGRESS projects</a>
        </cfif>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
        ...
        <thead>
          <tr>
           ...
           <!--- <th><div align="left">Project Address</div></th>--->
            ...
            <th nowrap="nowrap"><div align="center">Auto-terminate<br />in Intacct?</div></th>
            <th nowrap="nowrap"><div align="right">Project Value</div></th>
            <th ><div align="center">Edit Project</div></th>
        ...
        <tbody>
          ...
          <cfif get_all_jobs.responsible_user_Employee_ID GT 0>
            ...
            <!---  <td><div align="left">#project_address#</div></td>--->
              ...
              <td>
              <div align="center">
              <cfif project_status_checkbox EQ 1>
