                                ...
                                <cfelse>
                                  ...
                                  <cfelse>
                                      <cfif current_row.quote_services_field NEQ ''>
                                          ...
                                          <cfelse>
                                              <cfoutput><input class="column<cfoutput>#current_column.ID#</cfoutput> #current_row.quote_services_field#" type="text" size="6" value="#current_row.row_defaultvalue#" /></cfoutput>
