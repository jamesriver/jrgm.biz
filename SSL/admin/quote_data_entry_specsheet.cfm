...
SELECT  [Employee ID] as employee_id, [Name FirstLast] AS employee_Name FROM app_employees WHERE active_record=1 AND [Employee ID] < 9999  
      ...
      <cfoutput query="get_quote_start">
        ...
        <table width="100%" align="center" border="1"   class="table2">
          <tr>
            <td width="150" bgcolor="##ECECEC"><strong>Job No : </strong></td>
          ...
          <tr>
            <td width="150" bgcolor="##ECECEC"><strong>Customer : </strong></td>
          ...
          <tr>
            <td width="150" bgcolor="##ECECEC"><strong>Contact : </strong></td>
          ...
          <tr>
            <td width="150" bgcolor="##ECECEC"><strong>Phone : </strong></td>
          ...
          <tr>
            <td width="150" bgcolor="##ECECEC"><strong>Email : </strong></td>
              ...
              <cfloop from="1" to="#arrayLen(quote_data_entry_row_order_array)#" index="ii">
                ...
                <tr id="#row_ID#">
                  <cfloop from="1" to="#arrayLen(current_row)#" index="iii">
                    ...
                    <td><strong>#row_column#</strong></td>
                  </cfloop>
                </tr>
              </cfloop>
              <cfif i EQ 1>
                  <tr>
                      <td style="font-weight: bold">Total Seasonal Hours</td>
                      <td></td>
                      <td></td>
                      <td><span id="span_seasonal_hours_total" style="font-weight: bold"></td>
                      <td></td>
                      <td></td>
                  </tr>
              </cfif>
...
FROM         quote_notes  WHERE  opportunity_id = #url.id# AND  opportunity_id_original = #url.id# AND note_type= 3
      ...
      <table width="98%"   align="center" border="1"  class="table2">
        <tr      bgcolor="#EDF3F8">
          ...
          <td height="30" colspan="2" align="right" bgcolor="#E9E9E9"><strong><cfoutput>Total SF Bed: #NumberFormat(get_quote_main.bed_sqft ,"999,999,999")# &nbsp;&nbsp;&nbsp;&nbsp;Total SF Turf: #get_quote_main.turf_sqft#&nbsp;</cfoutput></strong></td>
        </tr>
        <CFIF get_all_notes_3.recordcount GT 0>
          <cfoutput query="get_all_notes_3">
            <tr>
              ...
              <td valign="top" align="left"><strong>#note_body#</strong></td>
            </tr>
          </cfoutput>
          <cfelse>
          <tr>
