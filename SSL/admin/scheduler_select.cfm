...
<tr> 
          ...
          <cfoutput query="get_regional_managers">
           ...
           <td>#employee_ID#</td>
              <td>#employee_name#</td>
               <td><a href="do_login.cfm?employee_ID=#get_regional_managers.employee_ID#&schedchoice=home" target="_blank">Home</a></td>
             </tr>
          </cfoutput>
          </tbody>
        </table>
...
<tr> 
          ...
          <cfoutput query="get_branch_managers">
            <tr>
              ...
              <td><a href="do_login.cfm?employee_ID=#get_branch_managers.employee_ID#&schedchoice=home" target="_blank">Home</a></td>
              <td><a href="do_login.cfm?employee_ID=#get_branch_managers.employee_ID#&schedchoice=crews" target="_blank">Crews</a></td>
              <td><a href="do_login.cfm?employee_ID=#get_branch_managers.employee_ID#&schedchoice=jobs" target="_blank">Jobs</a></td>
            </tr>
          </cfoutput>
          </tbody>
        </table>
...
<div class="dailysheet_header">Admin</div>
...
<tr> 
          ...
          <cfoutput query="get_reg_admin">
            <tr>
              ...
              <td>#employee_name#</td>
              <td>#employee_branch#</td>
              <td><a href="do_login.cfm?employee_ID=#get_reg_admin.employee_ID#&schedchoice=home" target="_blank">Home</a></td>
             </tr>
          </cfoutput>
          </tbody>
        </table><br />
...
<tr> 
          ...
          <cfoutput query="get_mechanics">
           ...
           <td>#employee_ID#</td>
              <td>#employee_name#</td>
               <td><a href="do_login.cfm?employee_ID=#get_mechanics.employee_ID#&schedchoice=home" target="_blank">Home</a></td>
             </tr>
          </cfoutput>
          </tbody>
        </table>
          ...
          <cfoutput query="get_supervisors">
            <tr>
              ...
              <td align="left">#employee_branch#</td>
               <td><a href="do_login.cfm?employee_ID=#get_supervisors.employee_ID#&schedchoice=home" target="_blank">Home</a></td>
              <td align="left"><a href="do_login.cfm?employee_ID=#get_supervisors.employee_ID#&schedchoice=crews" target="_blank">Crews</a></td>
              <td align="left"><a href="do_login.cfm?employee_ID=#get_supervisors.employee_ID#&schedchoice=jobs" target="_blank">Jobs</a></td>
            </tr>
          </cfoutput>
          </tbody>
        </table><br />
