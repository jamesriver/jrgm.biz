<cfif  NOT IsDefined("form.BRANCH_NAME")>
 ...
 <cflocation url="payroll/payroll_view_employee_detail_all_select_dates.cfm?BRANCH=#form.BRANCH_NAME#&empid=#form.EMPLOYEE_ID#">
 </cfif>
...
<div id="outerfull">
  ...
  <tr>
    <td><span class="header">View Employee Payroll Detail</span> </td>
