    ...
    <div class="container-fluid"> 
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <!--- <table class="table large">
            <tr>
              <td><strong>Date: August 17, 2015</strong></td>
              <td><strong>DSID: 30255</strong></td>
            </tr>
            <tr>
              <td><strong>Crew Leader: Ricardo Perez Beltre</strong></td>
              <td><strong>Supervisor: Chase Townshend</strong></td>
            </tr>
          </table>---> 
        </div>
        <!--- <div class="col-md-6">
            ...
            <div class="panel panel-default">
              ...
              <div id="collapse_1" class="panel-collapse collapse">
                <div class="panel-body"> 
                  <!---  <p>
										  <div class="alert alert-info text-coname">Short Pump Crossing - J0712-1213 - Job Clock ID: 84445</div> 
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th colspan="12" nowrap="nowrap">
                  <span class="text-cotime">Start&nbsp; 06:30 AM</span> <span class="text-cotime">&nbsp; &nbsp; End 07:40 AM</span> &nbsp; <span class="text-cotime">&nbsp; &nbsp; Total Hours 1:10 &nbsp;&nbsp;(70 min.)</span> <span class="text-cotime">&nbsp; &nbsp;   &nbsp; &nbsp;  Total Crew Hours 4:40 &nbsp;&nbsp;(280 min.)</span> &nbsp; &nbsp;   &nbsp; &nbsp; </th>
              </tr>
            </thead>
            <tbody>
              <tr>
 		 ...
 		 WHERE ds_id = #dsid# AND job_clock_id =#get_this_job.ID# ORDER BY  ID ASC
                    ...
                    <table class="table table-striped table-hover">
                      <thead>
                        <cfoutput>
                          <tr>
                            <th colspan="13" nowrap="nowrap"><!---<div class="text-coname">#get_this_job_name.event_name# - #get_this_job.job_id# - Job Clock ID: #get_this_job.id#</div>---> 
