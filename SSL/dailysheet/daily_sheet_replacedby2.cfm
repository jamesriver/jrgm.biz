  ...
  <div class="row">
    <div class="col-md-12"> 
      ...
      <div class="portlet box green">
        <div class="portlet-title">Employee Time</div>
      ...
      <div class="panel-group accordion" id="accordion1">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_1">Job Service Detail Information</a> </h4>
          </div>
...
AND ds_id = #dsid# 
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_2">GPS Information </a> </h4>
          </div>
