  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1><cfoutput>#SESSION.branch#</cfoutput> Branch Oil Change Due - Miles</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar">
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="active"> <cfoutput>#SESSION.branch#</cfoutput> Branch Oil Change Due - Miles</li>
        </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
...
FROM         equipment where hours_mileage = 2  AND inventory_status > 0 <!---AND   oil_change_date_due IS NOT NULL ---> AND BRANCH_NAME = '#SESSION.branch#'
ORDER BY ID ASC
</cfquery>
              <!-- BEGIN EXAMPLE TABLE PORTLET-->
