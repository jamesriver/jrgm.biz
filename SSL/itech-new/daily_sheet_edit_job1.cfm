   ...
   <div class="page-content">
      ...
      <cfif IsDefined("url.delete")>
        <p  class="text-danger"><strong>Are you sure you want to delete <cfoutput>#get_this_job_name.event_name#</cfoutput> from this daily sheet?</strong></p>
              <cfoutput><a href="daily_sheet_edit_job1.cfm?deleteme=yes&ds_id=#ds_id#&ID=#url.ID#" class="btn btn-primary"> Yes</a> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_job1.cfm?ds_id=#ds_id#&ID=#url.ID#" class="btn btn-primary">No</a>
              <p></p>
      ...
      <br />
     <cfoutput>
         <a href="daily_sheet_edit_job1.cfm?ds_id=#ds_id#&ID=#ID#&delete=yes"  class="btn btn-primary">Remove this Job</a>&nbsp;&nbsp;&nbsp;&nbsp;
