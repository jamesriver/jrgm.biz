    ...
    <div class="centrecontent_inner">
      ...
      <cfif IsDefined("form.ds_id") AND  IsDefined("form.submit") AND  IsDefined("form.JOB_TIME_IN")>
        ...
        <tr>
          ...
          <cfoutput>
           <p><a href="daily_sheet_edit.cfm?dsid=#form.ds_id#"  class="dssbutton">Back to Daily Sheet</a><br />
<a href="daily_sheet_edit_add_job1.cfm?ds_id=#form.ds_id#" class="dssbutton">Add Another Job</a><br />
<a href="daily_sheet_edit_add_lunch1.cfm?ds_id=#form.ds_id#&job_clock_id=#getmaxid.newid#" class="dssbutton">Add Lunch to this Job</a></p>
        </cfoutput>
        </td>
         </tr>
        </table>
      ...
      <form  method="post" action="daily_sheet_edit_add_job1.cfm" >
		...
		WHERE <!--- branch= '#SESSION.branch#' --->irrigation =1
