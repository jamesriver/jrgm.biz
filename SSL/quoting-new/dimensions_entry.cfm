...
<div class="page-head">
  ...
  <cfoutput><center>Customer : <b>#get_quote_start.opportunity_name#&nbsp;&nbsp;<a class="btn btn-danger btn-sm" href="javascript:window.close()">Close Window</a></center></cfoutput>
  <div class="clearfix"></div>
  <div class="page-content">
  <div class="container-fluid text-center">
    <div class="row center-block text-center" style="margin: 0; padding: 0">
        <cfloop from="1" to="#arrayLen(dimensions)#" index="i">
            <cfset dim = dimensions[i]>
            <cfif i % 4 EQ 1 && i NEQ 1>
                </div><div class="row center-block text-center" style="margin: 0; padding: 0">
            </cfif>
                <div class="col-xs-12 col-lg-3 center-block" style="border: 1px solid black; margin-bottom: 5px;">
                    <cfoutput>
                        ...
                        <span style="font-size: 12pt; position: relative; top: -16px">#dim[1]#</span>
                        <table id="table_#dim[2]#" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="highlighted_tr">
                                    <cfif dim[3] EQ 'area'>
                                        <td style="font-size: 10pt; font-weight: bold" align="center" colspan="6"><b>#dim[1]# Total</b> = <span id="#dim[2]#_area_total" value="0"></span></td>
                                    </cfif>
                                    <cfif dim[3] EQ 'count_area'>
                                        <td style="font-size: 10pt; font-weight: bold" align="center" colspan="2"><b>#dim[1]# Total</b> = <span id="#dim[2]#_count_total" value="0"></span></td>
                                    </cfif>
                                    <cfif dim[3] EQ 'count_ot_slope'>
                                        <td style="font-size: 10pt; font-weight: bold" align="center" colspan="4"><b>OT</b> = <span id="#dim[2]#_count_obstacle_total" value="0"></span>, <b>ST</b> = <span id="#dim[2]#_count_slope_total" value="0"></span></td>
                                    </cfif>
                                </tr>
                                <!---<cfif dim[3] EQ 'count_ot_slope'>
                                    <tr class="highlighted_tr">
                                        <td style="font-size: 10pt; font-weight: bold" align="center" colspan="4"><b>Slope Total</b> = <span id="#dim[2]#_count_slope_total" value="0"></span></td>
                                    </tr>
                                </cfif>--->
                            </tbody>
                        </table>
...
<script>
    ...
    function apply_calculation_above(type, id, base_id, trcount, unit)
    {
        ...
        switch(type)
        {
            case 'area':
                ...
                html += '<td align="center">'+trcount+'.&nbsp;&nbsp;<input class="input_noborder '+id+'_length" size="6" id="'+base_id+'_length" name="'+base_id+'_length" oninput="recalculate_area(\''+id+'\', '+trcount+', \''+unit+'\', 1);"></td>';
                html += '<td align="center">x</td>';
                html += '<td align="center"><input class="input_noborder '+id+'_width" size="6" id="'+base_id+'_width" name="'+base_id+'_width" oninput="recalculate_area(\''+id+'\', '+trcount+', \''+unit+'\', 1);"></td>';
                html += '<td align="center">=</td>';
                html += '<td align="center" style="pointer-events: none"><input class="input_noborder '+id+'_area '+base_id+'_area" size="6"><input class="'+base_id+'_area" id="'+base_id+'_area" type="hidden"></td>';
            ...
            case 'count_area':
                ...
                html += '<td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="input_noborder '+id+'_count" size="6" id="'+base_id+'_count" name="'+base_id+'_count" oninput="recalculate_count_area(\''+id+'\', '+trcount+', \''+unit+'\', 1);"></td>';
                break;
            case 'count_ot_slope':
    ...
    function recalculate_count_area(id, trcount, unit, saveit)
    {
        ...
        if (id == 'bed_edge')
        {
            recalculate_count_area('winter_edge', trcount, dimensions['winter_edge'][3], saveit);
        }
    }
