  ...
  <div class="page-content">
    <div class="container-fluid"> 
      ...
      <div class="row">
        ...
        VALUES (#project_id#)
            ...
            <!--- ===================== update the new quote_start entry with opportunity_id=ID (for now, ensures it's unique) =================== --->
    ...
    --->
        ...
        WHERE ID=#result_insert_quote_start["GENERATEDKEY"]#
            ...
            <cfset app_jobs_new_query_string = '[Job ID] as job_id,
        ...
        [total_project_value] as bid_amount'>
            ...
            <!--- ======================= build an array of all possible branches by grouping all app_jobs_new entries by branch and then reading those values into an array ========================= --->
    ...
    --->
            ...
            <cfquery name="get_app_jobs_new_keys" datasource="jrgm">
        SELECT * FROM
        (
        SELECT #app_jobs_new_query_string#,
            ROW_NUMBER() OVER (ORDER BY (SELECT 1)) AS rnum
        FROM app_jobs_new
        ) a
        WHERE rnum = 1
    </cfquery>
            <cfloop list="#ArrayToList(get_app_jobs_new_keys.getColumnNames())#" index="i">
    ...
    ---> 
            ...
            <cfquery name="get_app_jobs_new" datasource="jrgm">
	...
	padding-left: 5px;
            ...
            <form id="form_project_select" method="post">
              ...
              <input id="project_id_input" name="project_id_input" list="project_id_list" style="width: 300px" value="" oninput="select_project()" onClick="this.value='';">&nbsp;&nbsp;OR&nbsp;&nbsp;
            ...
            <cfif IsDefined("form.project_id")>
              ...
              <cfquery name="get_app_jobs_new_by_project_id" datasource="jrgm">
                SELECT #app_jobs_new_query_string#
                FROM app_jobs_new
                WHERE [Wk Loc ID] = '#form.project_id#'
            </cfquery>
              <cfloop query="get_app_jobs_new_by_project_id">
                <cfset cols    = ListToArray(get_app_jobs_new_by_project_id.columnList)>
                <cfloop from="1" to="#arrayLen(cols)#" index="i">
                  <cfset initial_project[cols[i]] = get_app_jobs_new_by_project_id[cols[i]][1]>
                </cfloop>
              </cfloop>
