...
<cfif IsDefined('form.contract_installments')>
    ...
    <cfloop collection=#form# item="form_element_name">
      ...
      <cfif field_name neq "fieldnames" AND field_name neq 'submittedform'>
        ...
        <cfelse>
            <cfif field_name CONTAINS 'date' OR field_name CONTAINS '_unit' OR field_name CONTAINS '_service' OR (field_name CONTAINS '_material' AND field_name DOES NOT CONTAIN '_materials')>
                <cfif field_value eq "">
            ...
            <cfelse>
                ...
                <cfelse>
                    ...
                    <cfif field_name CONTAINS 'materials' OR field_name CONTAINS 'material'>
                ...
                <td align="left" colspan="#total_columns#">
                    <table>
                        <tr>
                            ...
                            <td><input id="turf_sqft" name="turf_sqft"  type="text" size="8"  value="#get_quote_main.turf_sqft#" /></td>
                            <td width="100">&nbsp;</td>
                            <td>Bed Sq. Footage:&nbsp;</td>
                            <td><input id="bed_sqft" name="bed_sqft"  type="text" size="8"  value="#get_quote_main.bed_sqft#" /></td>
                            <td width="100">&nbsp;</td>
                        </tr>
                    </table>
                </td>
