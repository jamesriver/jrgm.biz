...
<!---<CFSET spraying_materials_rate= 0.12>--->
...
<!---<cfset StructDelete(SESSION,"turf_sqft")>
<cfset StructDelete(SESSION,"bed_sqft")>
--->
<!--- <cfif  IsDefined("form.turf_sqft") AND form.turf_sqft GT 0><cfset SESSION.turf_sqft = form.turf_sqft ></cfif>
 <cfif  IsDefined("form.bed_sqft") AND form.bed_sqft GT 0><cfset SESSION.bed_sqft = form.bed_sqft ></cfif>--->
...
<cfquery name="get_material_admin_info_all" datasource="jrgm">
SELECT     ID,  Item_Desc,Item_unit, Selling_Price, Cost_Opening,  For_Quoting_Purposes,  For_Time_Entry
FROM         quote_materials_admin   
</cfquery>
<cfloop query="get_distinct_material_ID">
  <cfquery name="get_material_admin_info"  dbtype="query">
SELECT     ID,  Item_Desc,Item_unit, Selling_Price, Cost_Opening,  For_Quoting_Purposes,  For_Time_Entry
FROM         get_material_admin_info_all  WHERE item_desc = '#get_distinct_material_ID.item_desc#'
</cfquery>
  ...
  <cfif  item_desc EQ 'Non-Dyed Mulch (yd)'>
  ...
  <cfif  item_desc EQ 'Flowers (6" pots)'>
...
<cfquery name="get_service_admin_info_ALL" datasource="jrgm">
...
<cfloop query="get_distinct_service_ID">
  <cfquery name="get_service_admin_info"  dbtype="query">
SELECT      ID, Service_ID, Service_Name, Sq_Ft, Service_Unit, Service_Rate, Service_Type, Service_Type_Sub_Group
FROM         get_service_admin_info_ALL  WHERE Service_ID = '#get_distinct_service_ID.Service_ID#'
</cfquery>
...
<!---<cfparam  name="SESSION.turf_sqft"  default="0">
<cfparam  name="SESSION.bed_sqft"  default="0">

<cfparam  name="form.turf_sqft"  default="0">
<cfparam  name="form.bed_sqft"  default="0">
--->
...
<cfquery name="update_quote_main_A" datasource="jrgm">
UPDATE quote_main SET 
 
 
<cfif  IsDefined("form.turf_sqft")  AND form.turf_sqft NEQ "">
turf_sqft ='#form.turf_sqft#',
</cfif>

<cfif  IsDefined("form.bed_sqft")  AND form.bed_sqft NEQ "">
  bed_sqft = '#form.bed_sqft#',
</cfif>
...
<!---<cfoutput>#get_quote_main.bed_sqft#</cfoutput>--->

<CFSET form.bed_sqft = get_quote_main.bed_sqft>
<CFSET form.turf_sqft = get_quote_main.turf_sqft>
...
<cfset SESSION.gross_margin40 = 40.00>
<cfset SESSION.gross_margin40_perc = 40.00>
<cfset SESSION.gross_margin40_diff = (100-SESSION.gross_margin40)/100>

<!---<cfoutput>#form.bed_sqft#</cfoutput>
   <cfabort>--->
<!---<cfset form.bed_sqft = get_quote_main.bed_sqft>
<cfset form.turf_sqft = get_quote_main.turf_sqft>--->
...
<cfset SESSION.turf_prel_materials_qty=(get_service_info.turf_prel_qty /1190.48)>
<!--- = .84 oz per 1000 sq ft--->
...
<cfset SESSION.mulch_f_dyed_hoursA = #NumberFormat(SESSION.mulch_f_dyed_hours,"999999.99")#>
...
<cfset SESSION.mulch_f_dyed_materials_qty=(get_service_info.mulch_f_dyed_qty /243)>
...
<cfset SESSION.mulch_f_reg_materials_qty=(get_service_info.mulch_f_reg_qty /243)>
...
<cfset SESSION.Mulch_S_Reg_hoursA = #NumberFormat(SESSION.Mulch_S_Reg_hours,"999999.99")#>
...
<cfset SESSION.Lot_Sweeping_hoursA = #NumberFormat(SESSION.Lot_Sweeping_hours,"999999.9")#>
...
<cfset SESSION.Turf_Nutsedge_materials_qty=(get_service_info.Turf_Nutsedge_qty/5555)>
<!---( =.187 oz per 100 sq ft.)--->
...
<cfset SESSION.Turf_Fungicide_materials_qty =(get_service_info.Turf_Fungicide_qty/666.66)>
<!---= 1.5 oz per 1000 sq ft--->
...
<cfset SESSION.Turf_Insecticide_materials_qty =(get_service_info.Turf_Insecticide_qty/1000)>
...
<!---<CFIF  SESSION.TURF_SQFT EQ ''>
  <CFSET SESSION.TURF_SQFT=0.00>
</CFIF>
<CFIF  SESSION.bed_SQFT EQ ''>
  <CFSET SESSION.bed_SQFT=0.00>
</CFIF>--->
<!--- Seasonal Hours  --->
...
<!---END Added 7/20/2015--->
<!----<cfoutput> #SESSION.turf_sqft#</cfoutput>
  <cfabort> --->
...
WHERE opportunity_id = #url.id#
    ...
    <form   name="quoteform" method="post" action="quote_data_entry.cfm?ID=<cfoutput>#url.id#</cfoutput>">
              ...
              <tbody>
                <tr> 
                  ...
                  <cfif NOT IsDefined("url.enter_service_rate")>
                    <td align="right"><!---<a href="quote_data_entry.cfm?enter_service_rate=yes&ID=<cfoutput>#url.id#</cfoutput>" class="btn btn-primary btn-xs">Edit</a>---></td>
                    <cfelse>
                ...
                <cfoutput> 
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.push_mow_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.push_mow_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.push_mow_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <cfset SESSION.push_mow_contract_price  =  #NumberFormat(SESSION.push_mow_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.walk_behind_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.walk_behind_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.walk_behind_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.walk_behind_contract_price  =  #NumberFormat(SESSION.walk_behind_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.ride_mow_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.ride_mow_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.ride_mow_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.ride_mow_contract_price  =  #NumberFormat(SESSION.ride_mow_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.hard_edge_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.hard_edge_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.hard_edge_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.hard_edge_contract_price  =  #NumberFormat(SESSION.hard_edge_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.bed_edge_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.bed_edge_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.bed_edge_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.bed_edge_contract_price  =  #NumberFormat(SESSION.bed_edge_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TRIM_O_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.TRIM_O_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TRIM_O_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.TRIM_O_contract_price  =  #NumberFormat(SESSION.TRIM_O_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TRIM_S_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.TRIM_S_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TRIM_S_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.TRIM_S_contract_price  =  #NumberFormat(SESSION.TRIM_S_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.spraying_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.spraying_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.spraying_contract_price  =  #NumberFormat(SESSION.spraying_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.weeding_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.weeding_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.weeding_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.weeding_contract_price  =  #NumberFormat(SESSION.weeding_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.blowing_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.blowing_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.blowing_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.blowing_contract_price  =  #NumberFormat(SESSION.blowing_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trash_S_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Trash_S_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trash_S_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Trash_S_contract_price  =  #NumberFormat(SESSION.Trash_S_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Traveltime_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Traveltime_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Traveltime_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Traveltime_contract_price  =  #NumberFormat(SESSION.Traveltime_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trash_O_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Trash_O_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trash_O_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Trash_O_contract_price  =  #NumberFormat(SESSION.Trash_O_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.leafrem_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.leafrem_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.leafrem_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.leafrem_contract_price  =  #NumberFormat(SESSION.leafrem_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.cleanup_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.cleanup_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.cleanup_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.cleanup_contract_price  =  #NumberFormat(SESSION.cleanup_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">&nbsp;</td>
                    <td align="left" nowrap="nowrap">Granular Pre-emergent (lb)</td>
                    <!---  <cfif NOT IsDefined("url.enter_materials_qty")>--->
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_preg_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_preg_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.turf_preg_contract_price  =  #NumberFormat(SESSION.turf_preg_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_prel_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_prel_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.turf_prel_contract_price  =  #NumberFormat(SESSION.turf_prel_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_post_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_post_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.turf_post_contract_price  =  #NumberFormat(SESSION.turf_post_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_fert_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_fert_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.turf_fert_contract_price  =  #NumberFormat(SESSION.turf_fert_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_lime_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.turf_lime_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.turf_lime_contract_price  =  #NumberFormat(SESSION.turf_lime_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Aer_H_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Turf_Aer_H_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Aer_H_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Turf_Aer_H_contract_price  =  #NumberFormat(SESSION.Turf_Aer_H_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Aer_T_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Turf_Aer_T_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Aer_T_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Turf_Aer_T_contract_price  =  #NumberFormat(SESSION.Turf_Aer_T_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Seed_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Seed_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Turf_Seed_contract_price  =  #NumberFormat(SESSION.Turf_Seed_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Nutsedge_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Nutsedge_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Turf_Nutsedge_contract_price  =  #NumberFormat(SESSION.Turf_Nutsedge_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Fungicide_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Fungicide_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Turf_Fungicide_contract_price  =  #NumberFormat(SESSION.Turf_Fungicide_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Insecticide_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Turf_Insecticide_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Turf_Insecticide_contract_price  =  #NumberFormat(SESSION.Turf_Insecticide_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pruning_TP_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Pruning_TP_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pruning_TP_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Pruning_TP_contract_price  =  #NumberFormat(SESSION.Pruning_TP_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pruning_S_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Pruning_S_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pruning_S_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Pruning_S_contract_price  =  #NumberFormat(SESSION.Pruning_S_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TS_Fert_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TS_Fert_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.TS_Fert_contract_price  =  #NumberFormat(SESSION.TS_Fert_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TS_Insect_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TS_Insect_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.TS_Insect_contract_price  =  #NumberFormat(SESSION.TS_Insect_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TS_hort_oil_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.TS_hort_oil_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.TS_hort_oil_contract_price  =  #NumberFormat(SESSION.TS_hort_oil_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">&nbsp;</td>
                    <td align="left" nowrap="nowrap">Bed Pre-emergent (lb) </td>
                    <!---   <cfif NOT IsDefined("url.enter_materials_qty")>--->
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_pre_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_pre_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Mulch_pre_contract_price  =  #NumberFormat(SESSION.Mulch_pre_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_edging_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Mulch_edging_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_edging_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!---   <td align="right" nowrap="nowrap">'#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Mulch_edging_contract_price  =  #NumberFormat(SESSION.Mulch_edging_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">&nbsp;</td>
                    <td align="left" nowrap="nowrap">Dyed Mulch (yd)</td>
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.mulch_s_dyed_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.mulch_s_dyed_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!---     <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.mulch_s_dyed_contract_price  =  #NumberFormat(SESSION.mulch_s_dyed_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.mulch_f_dyed_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.mulch_f_dyed_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!---  <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.mulch_f_dyed_contract_price  =  #NumberFormat(SESSION.mulch_f_dyed_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">&nbsp;</td>
                    <td align="left" nowrap="nowrap">Non-Dyed Mulch (yd)</td>
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_S_Reg_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_S_Reg_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Mulch_S_Reg_contract_price  =  #NumberFormat(SESSION.Mulch_S_Reg_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_F_Reg_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Mulch_F_Reg_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Mulch_F_Reg_contract_price  =  #NumberFormat(SESSION.Mulch_F_Reg_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">&nbsp;</td>
                    <td align="left" nowrap="nowrap">Playground Mulch (yd)</td>
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Playground_mulch_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Playground_mulch_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Playground_mulch_contract_price  =  #NumberFormat(SESSION.Playground_mulch_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">&nbsp;</td>
                    <td align="left" nowrap="nowrap">Pine Tags (bale)</td>
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pine_Tags_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pine_Tags_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Pine_Tags_contract_price  =  #NumberFormat(SESSION.Pine_Tags_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Annuals_S_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Annuals_S_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Annuals_S_contract_price  =  #NumberFormat(SESSION.Annuals_S_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Annuals_F_total_labor_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Annuals_F_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Annuals_F_contract_price  =  #NumberFormat(SESSION.Annuals_F_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_SU_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Irrigation_SU_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_SU_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Irrigation_SU_contract_price  =  #NumberFormat(SESSION.Irrigation_SU_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_W_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Irrigation_W_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_W_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Irrigation_W_contract_price  =  #NumberFormat(SESSION.Irrigation_W_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_I_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Irrigation_I_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_I_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Irrigation_I_contract_price  =  #NumberFormat(SESSION.Irrigation_I_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_TM_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Irrigation_TM_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_TM_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Irrigation_TM_contract_price  =  #NumberFormat(SESSION.Irrigation_TM_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_BFI_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Irrigation_BFI_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Irrigation_BFI_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <!--- <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>--->
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin40_perc,"999,999.999")#%</td>
                    <cfset SESSION.Irrigation_BFI_contract_price  =  #NumberFormat(SESSION.Irrigation_BFI_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin40_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pond_Maint_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Pond_Maint_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Pond_Maint_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Pond_Maint_contract_price  =  #NumberFormat(SESSION.Pond_Maint_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trim_Hillside_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Trim_Hillside_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trim_Hillside_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Trim_Hillside_contract_price  =  #NumberFormat(SESSION.Trim_Hillside_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Addtl_Mowing_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Addtl_Mowing_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Addtl_Mowing_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Addtl_Mowing_contract_price  =  #NumberFormat(SESSION.Addtl_Mowing_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Day_Porter_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Day_Porter_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Day_Porter_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Day_Porter_contract_price  =  #NumberFormat(SESSION.Day_Porter_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Bush_Hog_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Bush_Hog_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Bush_Hog_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Bush_Hog_contract_price  =  #NumberFormat(SESSION.Bush_Hog_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trail_Maint_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Trail_Maint_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trail_Maint_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Trail_Maint_contract_price  =  #NumberFormat(SESSION.Trail_Maint_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Natural_Area_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Natural_Area_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Natural_Area_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Natural_Area_contract_price  =  #NumberFormat(SESSION.Natural_Area_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trash_Receptacle_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Trash_Receptacle_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Trash_Receptacle_total_materials_cost,"9,999,999.99")#</td>
                    ...
                    <td align="right" nowrap="nowrap">#NumberFormat(SESSION.gross_margin,"999,999.999")#%</td>
                    <cfset SESSION.Trash_Receptacle_contract_price  =  #NumberFormat(SESSION.Trash_Receptacle_total_all_costs,"999999999.99")#/#NumberFormat(SESSION.gross_margin_diff,"999999.99999")#>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Lot_Sweeping_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Lot_Sweeping_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Lot_Sweeping_total_materials_cost,"9,999,999.99")#</td>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Blank1_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Blank1_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Blank1_total_materials_cost,"9,999,999.99")#</td>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Blank2_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Blank2_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Blank2_total_materials_cost,"9,999,999.99")#</td>
                  ...
                  <tr>
                    ...
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Blank3_total_labor_cost,"9,999,999.99")#</td>
                    <CFSET SESSION.Blank3_total_materials_cost = 0>
                    <td align="right" nowrap="nowrap">$#NumberFormat(SESSION.Blank3_total_materials_cost,"9,999,999.99")#</td>
...
>
                  <tr  style="font-weight: 800"   bgcolor="##EDF3F8">
                    ...
                    <td align="right" nowrap="nowrap"><!---<label for="textfield2">Text Field:</label>
                    <input type="text" name="textfield2" id="textfield2" />---></td>
                    <td align="right" nowrap="nowrap"><!---<label for="textfield">Text Field:</label>
...
+SESSION.Total_materials_cost>
                  ...
                  <tr> 
                    ...
                    <td align="right" colspan="7"><a href="quote_notes.cfm?opportunity_id_original=<cfoutput>#url.id#&opportunity_id=#url.id#</cfoutput>&note_type=5"><i class="fa fa-file-text mysize font-blue">&nbsp;Note</i></a>&nbsp;&nbsp;&nbsp; <strong>Contract Adjustment</strong></td>
                    <td align="right">$
                  ...
                  <tr> 
                    ...
                    <td align="left" colspan="4">Turf Sq. Footage: 
                      <!---<cfif   NOT IsDefined("form.turf_sqft") >
                    <CFSET form.turf_sqft =0>
                    </cfif>--->
                      
                      <cfparam name="form.turf_sqft" default="0">
                      <input  name="turf_sqft"  type="text" size="5"  value="#form.turf_sqft#"/></td>
                    <td align="left" colspan="6">Bed Sq. Footage: 
                      <!---<cfif   NOT IsDefined("form.bed_sqft") >
                    <CFSET form.bed_sqft =0>
                    </cfif>--->
                      
                      <cfparam name="form.bed_sqft" default="0">
                      <input name="bed_sqft" type="text"  size="5" value="#form.bed_sqft#"/></td>
                    <td align="right" colspan="3"></td>
                    <td align="right" colspan="8" ><a href="quote_notes.cfm?opportunity_id_original=<cfoutput>#url.id#&opportunity_id=#url.id#</cfoutput>&note_type=6"><i class="fa fa-file-text mysize font-blue">&nbsp;Note</i></a>&nbsp;&nbsp;&nbsp;<strong>Discount Adjustment</strong></td>
                    <td align="right">$
