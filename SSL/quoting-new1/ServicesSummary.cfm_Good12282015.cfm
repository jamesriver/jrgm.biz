...
<CFSET monthly_price =  "">
<cfelseif get_price_quote_dollars.total_contract_price NEQ "" AND  get_price_quote_dollars.contract_installments NEQ 0>
...
<CFSET Fax= '-'>
    ...
    <div class="container-fluid"> 
     ...
     <div class="row">
  <div class="col col-md-4"><img src="images/logo.png" width="281" height="66" /></div>
 ...
 <div class="row">
 <div class="col-md-12"><div align="center"><strong><em>ATTACHMENT A</em></strong><br />
 ...
 <div class="col-md-12">
            ...
            JAMES RIVER GROUNDS MANAGEMENT, INC. SHALL PROVIDE THE FOLLOWING SERVICES AT <strong>#opportunity_name#</strong>, LOCATED AT  <strong>#q_address1#</strong>, IN <strong>#q_city#, #q_address_state#</strong>. PLEASE REFER TO THE 'DEFINITION OF SERVICES' (Attachment B) FOR MORE DETAILED SERVICE SPECIFICATIONS.
            </cfoutput>
           ...
           <cfoutput>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td> Walk Behind Mowing</td><td>&nbsp;</td>
              </tr>
              </cfif>
              ...
              <tr>
                ...
                <td>Hard Edging (curbs/sidewalks)</td><td>&nbsp;</td>
              </tr>
          </cfif>
           <cfif  get_price_quote_info.bed_edge_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.bed_edge_times#</span></td><td>Bed Stick Edging</td><td>&nbsp;</td>
              </tr>
              </cfif>
             <cfif  get_price_quote_info.trim_o_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.trim_o_times#</span></td><td>Obstacle Trimming</td><td>&nbsp;</td>
              </tr>
              </cfif>
               <cfif  get_price_quote_info.trim_s_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.trim_s_times#</span></td><td>Slope Trimming</td><td>&nbsp;</td>
              </tr>
              </cfif>
              ...
              <tr>
                ...
                <td>Herbicide Spraying (beds/pavement)</td><td>&nbsp;</td>
              </tr>
              </cfif>
              ...
              <tr>
                ...
                <td>Hand Weeding (beds)</td><td>&nbsp;</td>
              </tr>
              </cfif>
               <cfif  get_price_quote_info.blowing_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.blowing_times#</span></td><td>Blowing</td><td>&nbsp;</td>
              </tr>
              </cfif>
              ...
              <tr>
                ...
                <td>Seasonal Trash&nbsp;/ Debris Pick-up</td><td>&nbsp;</td>
              </tr>
              </cfif>
           ...
           <td align="right"><span class="priceh">$#NumberFormat(OFFSEASON,"999,999.99")#</span></td>
              ...
              <tr>
                ...
                <td>Off Season Trash&nbsp;/ Debris Pick-up<br /></td><td>&nbsp;</td>
              </tr>
               </cfif>
                 <cfif  get_price_quote_info.leafrem_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.leafrem_times#</span></td><td> Leaf Removal</td><td>&nbsp;</td>
              </tr>
               </cfif>
                 <cfif  get_price_quote_info.cleanup_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.cleanup_times#</span></td><td> Cleanup</td><td>&nbsp;</td>
              </tr>
               </cfif>
              <tr>
                <td colspan="3"><h3> III. TURF CARE</h3> </td>
              <td   align="right"><span class="priceh">$#NumberFormat(TURFCARE,"999,999.99")#</span></td>
              </tr>
                  <cfif  get_price_quote_info.turf_preg_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.turf_preg_times#</span></td><td>Granular Turf Pre-em / Fert Combo</td><td>&nbsp;</td>
              </tr>
                </cfif>
              ...
              <tr>
                ...
                <td>Liquid Turf Pre / Post-em Combo</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.turf_post_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.turf_post_times#</span></td><td>Turf Post-emergent</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.turf_fert_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.turf_fert_times#</span></td><td>Turf Fertilization</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.turf_lime_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.turf_lime_times#</span></td><td>Lime Application</td><td>&nbsp;</td>
              </tr>
                  </cfif>
              ...
              <tr>
                ...
                <td>Aeration (hand work)</td><td>&nbsp;</td>
              </tr>
                  </cfif>
              ...
              <tr>
                ...
                <td>Aeration (tractor work)</td><td>&nbsp;</td>
              </tr>
                  </cfif>
              ...
              <tr>
                ...
                <td>Overseeding</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.Turf_nutsedge_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Turf_nutsedge_times#</span></td><td>Turf Nutsedge Application</td><td>&nbsp;</td>
              </tr>
                  </cfif>
              ...
              <tr>
                ...
                <td>Turf Fungicide Application</td><td>&nbsp;</td>
              </tr>
                  </cfif>
              ...
              <tr>
                ...
                <td>Turf Insecticide Application</td><td>&nbsp;</td>
              </tr>
                  </cfif>
               <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.pruning_tp_times#</span></td><td>Tree &amp; Perennial Pruning</td><td>&nbsp;</td>
              </tr>
              </cfif>
                  <cfif  get_price_quote_info.pruning_s_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.pruning_s_times#</span></td><td>Shrub Pruning</td><td>&nbsp;</td>
              </tr>
                 </cfif>
              ...
              <tr>
                ...
                <td>Plant Fertilization</td><td>&nbsp;</td>
              </tr>   </cfif>
              
                  <cfif  get_price_quote_info.TS_Insect_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.TS_Insect_times#</span></td><td>Plant Insecticide Application</td><td>&nbsp;</td>
              </tr>   </cfif>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Mulch_pre_times#</span></td><td>Bed Pre-emergent Weed Control</td><td>&nbsp;</td>
              </tr>
              </cfif>
              ...
              <tr>
                ...
                <td>Renovational Bed Edging</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.Mulch_s_dyed_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Mulch_s_dyed_times#</span></td><td>Spring Mulch (dyed)</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.Mulch_f_dyed_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Mulch_f_dyed_times#</span></td><td>Fall Mulch (dyed)</td><td>&nbsp;</td>
              </tr>
                  </cfif>
                  <cfif  get_price_quote_info.Mulch_S_Reg_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Mulch_S_Reg_times#</span></td><td>Spring Mulch (non dyed)</td><td>&nbsp;</td>
              </tr>
               </cfif>
                  <cfif  get_price_quote_info.Mulch_F_Reg_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Mulch_F_Reg_times#</span></td><td>Fall Mulch (non dyed)</td><td>&nbsp;</td>
              </tr>
               </cfif>
                  <cfif  get_price_quote_info.Pine_Tags_times GT 0>
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Pine_Tags_times#</span></td><td>Pine Tags</td><td>&nbsp;</td>
              </tr>
                 </cfif>
              <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><span class="price">#get_price_quote_info.Annuals_S_times#</span></td><td> Spring Annuals - 400<br /></td><td>&nbsp;</td>
              </tr></cfif>
                <cfif  get_price_quote_info.Annuals_F_times GT 0>
                  <tr>
                    <td>&nbsp;</td>
                    <td><span class="price">#get_price_quote_info.Annuals_F_times#</span></td><td>Fall Annuals - 400</td><td>&nbsp;</td>
                  </tr>
                </cfif>
                 <tr>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Irrigation_SU_times#</span></td><td>Irrigation System Start-up</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Irrigation_W_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Irrigation_W_times#</span></td><td>Irrigation System Winterization</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Irrigation_I_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Irrigation_I_times#</span></td><td>Irrigation System Inspections</td><td>&nbsp;</td>
                </tr>
                </cfif>
                ...
                <tr>
                  ...
                  <td>Irrigation Time &amp; Material</td><td>&nbsp;</td>
                </tr>
                </cfif>
                ...
                <tr>
                  ...
                  <td>Backflow Certification</td><td>&nbsp;</td>
                </tr>
                </cfif>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Day_Porter_times#</span></td><td>Day Porter</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Bush_Hog_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Bush_Hog_times#</span></td><td>Bush Hog</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Lot_Sweeping_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Lot_Sweeping_times#</span></td><td>Lot Sweeping</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Trail_Maint_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Trail_Maint_times#</span></td><td>Trail Maintenance</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Natural_Area_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Natural_Area_times#</span></td><td>Natural Area</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Trash_Receptacle_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Trash_Receptacle_times#</span></td><td>Trash Receptacle/Dog Station</td><td>&nbsp;</td>
                </tr>
                </cfif>
                <cfif  get_price_quote_info.Playground_mulch_times GT 0>
                <tr>
                  <td>&nbsp;</td>
                  <td><span class="price">#get_price_quote_info.Playground_mulch_times#</span></td><td>Playground Mulch</td><td>&nbsp;</td>
                </tr>
                </cfif>
                ...
                <tr>
                  ...
                  <td align="left">#get_price_quote_info.blank1_service#</td><td>&nbsp;</td>
                </tr>
                </cfif>
                ...
                <tr>
                  ...
                  <td align="left" >#get_price_quote_info.blank2_service#</td><td>&nbsp;</td>
                </tr>
                 </cfif>
                ...
                <tr>
                  ...
                  <td align="left" >#get_price_quote_info.blank3_service#</td><td>&nbsp;</td>
                </tr>
                 </cfif>
