      ...
      <div class="row">
        <div class="col-md-12">
          <table width="95%" border="0" cellspacing="0" cellpadding="0"  align="center">
            <tr>
              <td><p><br>
                  <a href="quote_list.cfm">Quote List</a><br>
                  <br>
                  <a href="select_branch_j.cfm">Job Cost Reports</a><br>
                  <br>
                  <a href="quote_create_renewal.cfm">Create Quote Renewal</a> <br>
                  <br>
                  <a href="quote_create_from_opportunity.cfm">Create Quote From Insightly Opportunity</a> <br>
                  <br>
                  <a href="https://www.jrgm.biz/ssl/admin/project_list.cfm" target="_blank">Project List / Manage Project Information</a></p></td>
            </tr>
          </table>
        </div>
      </div>
