...
<cfset Session.Mulch_pre_materials_qty_actual=#NumberFormat(Session.Mulch_pre_materials_qty_actual,"999999.99")#>  
...
<cfset Session.mulch_s_dyed_materials_qty_actual=#NumberFormat(Session.mulch_s_dyed_materials_qty_actual,"999999.99")#>  
...
<cfset Session.mulch_f_dyed_materials_qty_actual=#NumberFormat(Session.mulch_f_dyed_materials_qty_actual,"999999.99")#>  
...
<cfset Session.mulch_f_reg_materials_qty_actual=#NumberFormat(Session.mulch_f_reg_materials_qty_actual,"999999.99")#>  
...
<cfset Session.mulch_s_reg_materials_qty_actual=#NumberFormat(Session.mulch_s_reg_materials_qty_actual,"999999.99")#>  
...
<cfset Session.Pine_Tags_materials_qty_actual=#NumberFormat(Session.Pine_Tags_materials_qty_actual,"999999.99")#>  
...
<cfif  IsDefined("form.TS_hort_oil_qty")>A
...
<cfset Session.TS_hort_oil_materials_qty_actual=#NumberFormat(Session.TS_hort_oil_materials_qty_actual,"999999.99")#>  
 <cfif  IsDefined("form.TS_hort_oil_materials_qty")    AND  get_materials_info.TS_hort_oil_materials_qty  EQ Session.TS_hort_oil_materials_qty_actual  AND Session.TS_hort_oil_materials_qty EQ 0  AND   NOT IsDefined("form.BTNSUMIT1")>B
<cfset Session.TS_hort_oil_materials_qty=(get_service_info.TS_hort_oil_qty *128)>
<cfelseif   IsDefined("form.TS_hort_oil_materials_qty")    AND get_materials_info.TS_hort_oil_materials_qty  EQ form.TS_hort_oil_materials_qty  AND   NOT IsDefined("form.BTNSUMIT1")    AND   IsDefined("TS_hort_oil_qty_pre")   AND   IsDefined("TS_hort_oil_qty_post") AND TS_hort_oil_qty_pre NEQ  TS_hort_oil_qty_post>C
<cfset Session.TS_hort_oil_materials_qty=(get_service_info.TS_hort_oil_qty *128)>
<cfelseif  IsDefined("form.TS_hort_oil_materials_qty")  AND    IsDefined("form.BTNSUMIT1")>D
<cfset Session.TS_hort_oil_materials_qty=(form.TS_hort_oil_materials_qty)>
 <cfelseif   NOT IsDefined("form.TS_hort_oil_materials_qty")  AND IsDefined("url.enter_materials_qty") >E
<cfset Session.TS_hort_oil_materials_qty=(get_materials_info.TS_hort_oil_materials_qty)>
   <cfelse>F
<cfset Session.TS_hort_oil_materials_qty=(get_materials_info.TS_hort_oil_materials_qty)>
</cfif>
...
<cfset Session.Playground_mulch_materials_qty_actual=#NumberFormat(Session.Playground_mulch_materials_qty_actual,"999999.99")#>  
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="quote_data_entry.cfm?ID=<cfoutput>#url.id#</cfoutput>">
      ...
      <div class="container-table">
        <div class="left-table"> <!--- <cfoutput> #Session.traveltime_contract_price#   -#Session.travel_time_gm# #Session.gross_margin_diff_travel_time# </cfoutput> --->
        <!---  <cfoutput>
...
#NumberFormat(Session.Annual_S_actual_extended,"999,999.999")#
   ...
   <td>&nbsp;</td>
            ...
            <tr>
              <td  nowrap="nowrap">Contract Start Date : <input name="contract_start_date" type="text" class="form_buttons" id="contract_start_date"  size="10"  value="#dateformat(Session.contract_start_date,"mm/dd/yyyy")#"/> </td>
             
             <td>&nbsp;</td>
              <td nowrap="nowrap"   colspan="2"  align="left">Contract End Date : <input name="contract_end_date" type="text" class="form_buttons" id="contract_end_date"  size="10"  value="#dateformat(Session.contract_end_date,"mm/dd/yyyy")#"/> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;Installments : <input name="contract_installments" type="text" class="form_buttons" id="contract_installments"  size="2"  value="#SESSION.contract_installments#"/></td> 
            </tr>
            <tr>
...
Price</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td align="right"><input name="gross_margin" type="text"   <cfoutput>value="#Session.gross_margin#"</cfoutput> size="5" /></td>
                  <td align="right" >&nbsp;</td>
                </tr>
                <cfoutput>
                  <tr>
                    <td nowrap="nowrap">Push Mow</td>
                    <td align="right"><input name="push_mow_qty" type="text" id="push_mow_qty"   size="6"    value="#Session.push_mow_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="walk_behind_qty" type="text" id="walk_behind_qty"   size="6"   value="#Session.walk_behind_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="ride_mow_qty" type="text" id="ride_mow_qty"   size="6"   value="#Session.ride_mow_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="hard_edge_qty" type="text" id="hard_edge_qty"   size="6"   value="#Session.hard_edge_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="bed_edge_qty" type="text" id="bed_edge_qty"   size="6"   value="#Session.bed_edge_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Trim_O_qty" type="text" id="Trim_O_qty"   size="6"   value="#Session.Trim_O_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Trim_S_qty" type="text" id="Trim_S_qty"   size="6"   value="#Session.Trim_S_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="spraying_qty" type="text" id="spraying_qty"   size="6"   value="#Session.spraying_qty#"/>
                    </td>
                   ...
                   <!--- <td align="right"><input name="spraying_materials_qty" type="text" id="spraying_materials_qty"   size="6"    value="#Session.spraying_materials_qty#"/>
                      ...
                      <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.spraying_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="weeding_qty" type="text" id="weeding_qty"   size="6"   value="#Session.weeding_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="blowing_qty" type="text" id="blowing_qty"   size="6"   value="#Session.blowing_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Trash_S_Qty" type="text" id="Trash_S_Qty"   size="6"   value="#Session.Trash_S_Qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="traveltime_qty" type="text" id="traveltime_qty"   size="6"   value="#Session.traveltime_qty#"/>
                    </td>
                    ...
                    <td align="center"><input name="travel_time_gm" type="text"   size="3" value="#SESSION.travel_time_gm#"/><!---#NumberFormat(Session.gross_margin,"999,999.99")#--->%</td>  
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Trash_O_Qty" type="text" id="Trash_O_Qty"   size="6"   value="#Session.Trash_O_Qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="leafrem_qty" type="text" id="leafrem_qty"   size="6"   value="#Session.leafrem_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="cleanup_qty" type="text" id="cleanup_qty"   size="6"   value="#Session.cleanup_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Turf Pre (G)</td>
                    <td align="right"><input name="turf_preg_qty" type="text" id="turf_preg_qty"   size="6"    value="#Session.turf_preg_qty#"/>
                    </td>
               ...
               <!---     <td align="right"><input name="turf_preg_materials_qty" type="text" id="turf_preg_materials_qty"   size="6"    value="#Session.turf_preg_materials_qty#"/>
                    </td>--->
    ...
    <cfif NOT IsDefined("url.enter_materials_qty")>
				...
				<cfoutput>
                  <tr>
                    <td>Turf Pre (L)</td>
                    <td align="right"><input name="turf_prel_qty" type="text" id="turf_prel_qty"   size="6"    value="#Session.turf_prel_qty#"/>
                    </td>
...
<!--- <td align="right"><input name="turf_prel_materials_qty" type="text" id="turf_prel_materials_qty"   size="6"    value="#Session.turf_prel_materials_qty#"/>
                    </td>--->


               <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.turf_prel_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Turf Post</td>
                    <td align="right"><input name="turf_post_qty" type="text" id="turf_post_qty"   size="6"    value="#Session.turf_post_qty#"/>
                    </td>
                   ...
                   <!--- <td align="right"><input name="turf_post_materials_qty" type="text" id="turf_post_materials_qty"   size="6"    value="#Session.turf_post_materials_qty#"/>
                         ...
                         <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.turf_post_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Turf Fert</td>
                    <td align="right"><input name="turf_fert_qty" type="text" id="turf_fert_qty"   size="6"    value="#Session.turf_fert_qty#"/>
                    </td>
                    ...
                    <!---<td align="right"><input name="turf_fert_materials_qty" type="text" id="turf_fert_materials_qty"   size="6"    value="#Session.turf_fert_materials_qty#"/>
                    </td>--->
                    
                         <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.turf_fert_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Turf Lime</td>
                    <td align="right"><input name="turf_lime_qty" type="text" id="turf_lime_qty"   size="6"    value="#Session.turf_lime_qty#"/>
                    </td>
                   ...
                   <!--- <td align="right"><input name="turf_lime_materials_qty" type="text" id="turf_lime_materials_qty"   size="6"    value="#Session.turf_lime_materials_qty#"/>
                    </td>--->
                    
                      <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.turf_lime_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Turf Aer (H)</td>
                    <td align="right"><input name="Turf_Aer_H_qty" type="text" id="Turf_Aer_H_qty"   size="6"    value="#Session.Turf_Aer_H_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Turf Aer (T)</td>
                    <td align="right"><input name="Turf_Aer_T_qty" type="text" id="Turf_Aer_T_qty"   size="6"    value="#Session.Turf_Aer_T_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Turf  Seed</td>
                    <td align="right"><input name="Turf_Seed_qty" type="text" id="Turf_Seed_qty"   size="6"    value="#Session.Turf_Seed_qty#"/>
                    </td>
                ...
                <!---    <td align="right"><input name="Turf_Seed_materials_qty" type="text" id="Turf_Seed_materials_qty"   size="6"    value="#Session.Turf_Seed_materials_qty#"/>
                    </td>--->
                    
                      <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Turf_Seed_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Turf Nutsedge</td>
                    <td align="right"><input name="Turf_Nutsedge_qty" type="text" id="Turf_Nutsedge_qty"   size="6"    value="#Session.Turf_Nutsedge_qty#"/>
                    </td>
              ...
              <!---      <td align="right"><input name="Turf_Nutsedge_materials_qty" type="text" id="Turf_Nutsedge_materials_qty"   size="6"    value="#Session.Turf_Nutsedge_materials_qty#"/>
                    </td>--->
                    
                  
                    
                       <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Turf_Nutsedge_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Turf_Fungicide_qty" type="text" id="Turf_Fungicide_qty"   size="6"    value="#Session.Turf_Fungicide_qty#"/>
                    </td>
                 ...
                 <!---   <td align="right"><input name="Turf_Fungicide_materials_qty" type="text" id="Turf_Fungicide_materials_qty"   size="6"    value="#TRIM(Session.Turf_Fungicide_materials_qty)#"/>
                           ...
                           <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Turf_Fungicide_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Turf_Insecticide_qty" type="text" id="Turf_Insecticide_qty"   size="6"    value="#Session.Turf_Insecticide_qty#"/>
                    </td>
              ...
              <!---      <td align="right"><input name="Turf_Insecticide_materials_qty" type="text" id="Turf_Insecticide_materials_qty"   size="6"    value="#Session.Turf_Insecticide_materials_qty#"/>
                          ...
                          <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Turf_Insecticide_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Pruning, T/P</td>
                    <td align="right"><input name="Pruning_TP_qty" type="text" id="Pruning_TP_qty"   size="6"    value="#Session.Pruning_TP_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Pruning, S</td>
                    <td align="right"><input name="Pruning_S_qty" type="text" id="Pruning_S_qty"   size="6"    value="#Session.Pruning_S_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>T&amp;S, Fert</td>
                    <td align="right"><input name="TS_Fert_qty" type="text" id="TS_Fert_qty"   size="6"    value="#Session.TS_Fert_qty#"/>
                    </td>
                   ...
                   <!--- <td align="right"><input name="TS_Fert_materials_qty" type="text" id="TS_Fert_materials_qty"   size="6"    value="#Session.TS_Fert_materials_qty#"/>
                    ...
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.TS_Fert_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>T&amp;S, Insect</td>
                    <td align="right"><input name="TS_Insect_qty" type="text" id="TS_Insect_qty"   size="6"    value="#Session.TS_Insect_qty#"/>
                    </td>
                    ...
                    <!---<td align="right"><input name="TS_Insect_materials_qty" type="text" id="TS_Insect_materials_qty"   size="6"    value="#Session.TS_Insect_materials_qty#"/>
                         ...
                         <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.TS_Insect_materials_qty,"999,999.99")#</td>
...
<cfoutput>
                  <tr>
                    <td>T&amp;S, Hort Oil</td>
                    <td align="right"><input name="TS_hort_oil_qty" type="text" id="TS_hort_oil_qty"   size="6"    value="#Session.TS_hort_oil_qty#"/>
                    </td>
                 ...
                 <!---   <td align="right"><input name="TS_hort_oil_materials_qty" type="text" id="TS_hort_oil_materials_qty"   size="6"    value="#Session.TS_hort_oil_materials_qty#"/>
                       ...
                       <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.TS_hort_oil_materials_qty,"999,999.99")#</td>
...
<cfoutput>
                  <tr>
                    <td>Mulch, Pre</td>
                    <td align="right"><input name="Mulch_pre_qty" type="text" id="Mulch_pre_qty"   size="6"    value="#Session.Mulch_pre_qty#"/>
                    </td>
                 ...
                 <!---   <td align="right"><input name="Mulch_pre_materials_qty" type="text" id="Mulch_pre_materials_qty"   size="6"    value="#Session.Mulch_pre_materials_qty#"/>
                  ...
                  <tr>
                    <td>Mulch, Edging</td>
                    <td align="right"><input name="Mulch_edging_qty" type="text" id="Mulch_edging_qty"   size="6"    value="#Session.Mulch_edging_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Mulch, S (dyed)</td>
                    <td align="right"><input name="mulch_s_dyed_qty" type="text" id="mulch_s_dyed_qty"   size="6"    value="#Session.mulch_s_dyed_qty#"/>
                    </td>
                 ...
                 <!---   <td align="right"><input name="mulch_s_dyed_materials_qty" type="text" id="mulch_s_dyed_materials_qty"   size="6"    value="#Session.mulch_s_dyed_materials_qty#"/>
                    ...
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.mulch_s_dyed_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Mulch, F (dyed)</td>
                    <td align="right"><input name="mulch_f_dyed_qty" type="text" id="mulch_f_dyed_qty"   size="6"    value="#Session.mulch_f_dyed_qty#"/>
                    </td>
                  ...
                  <!---  <td align="right"><input name="mulch_f_dyed_materials_qty" type="text" id="mulch_f_dyed_materials_qty"   size="6"    value="#Session.mulch_f_dyed_materials_qty#"/>
                    ...
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.mulch_f_dyed_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Mulch, S (reg)</td>
                    <td align="right"><input name="Mulch_S_Reg_qty" type="text" id="Mulch_S_Reg_qty"   size="6"    value="#Session.Mulch_S_Reg_qty#"/>
                    </td>
                 ...
                 <!---   <td align="right"><input name="Mulch_S_Reg_materials_qty" type="text" id="Mulch_S_Reg_materials_qty"   size="6"    value="#Session.Mulch_S_Reg_materials_qty#"/>
                    ...
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Mulch_S_Reg_materials_qty,"999,999.99")#</td>
                  ...
                  <tr>
                    <td>Mulch, F&nbsp;(reg)</td>
                    <td align="right"><input name="Mulch_F_Reg_qty" type="text" id="Mulch_F_Reg_qty"   size="6"    value="#Session.Mulch_F_Reg_qty#"/>
                    </td>
             ...
             <!---       <td align="right"><input name="Mulch_F_Reg_materials_qty" type="text" id="Mulch_F_Reg_materials_qty"   size="6"    value="#Session.Mulch_F_Reg_materials_qty#"/>
                    ...
                    <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Mulch_F_Reg_materials_qty,"999,999.99")#</td>
...
<cfoutput>
                  <tr>
                    ...
                    <td align="right"><input name="Playground_mulch_qty" type="text" id="Playground_mulch_qty"   size="6"    value="#Session.Playground_mulch_qty#"/>
                    </td>
                   ...
                   <!--- <td align="right"><input name="Playground_mulch_materials_qty" type="text" id="Playground_mulch_materials_qty"   size="6"    value="#Session.Playground_mulch_materials_qty#"/>
                     ...
                     <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Playground_mulch_materials_qty,"999,999.99")#</td>
...
<cfoutput>
                  <tr>
                    <td>Pine Tags</td>
                    <td align="right"><input name="Pine_Tags_qty" type="text" id="Pine_Tags_qty"   size="6"    value="#Session.Pine_Tags_qty#"/>
                    </td>
                   ...
                   <!--- <td align="right"><input name="Pine_Tags_materials_qty" type="text" id="Pine_Tags_materials_qty"   size="6"    value="#Session.Pine_Tags_materials_qty#"/>
                      ...
                      <cfif NOT IsDefined("url.enter_materials_qty")>
                      <td align="left" nowrap="nowrap">#NumberFormat(Session.Pine_Tags_materials_qty,"999,999.99")#</td>
 ...
 <cfoutput>
                  <tr>
                    <td>Annuals, S</td>
                    <td align="right"><input name="Annuals_S_qty" type="text" id="Annuals_S_qty"   size="6"    value="#Session.Annuals_S_qty#"/>
                    </td>
 ...
 <cfoutput>
                  <tr>
                    <td>Annuals, F</td>
                    <td align="right"><input name="Annuals_F_qty" type="text" id="Annuals_F_qty"   size="6"    value="#Session.Annuals_F_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Irrigation, SU</td>
                    <td align="right"><input name="Irrigation_SU_qty" type="text" id="Irrigation_SU_qty"   size="6"    value="#Session.Irrigation_SU_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Irrigation, W</td>
                    <td align="right"><input name="Irrigation_W_qty" type="text" id="Irrigation_W_qty"   size="6"    value="#Session.Irrigation_W_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Irrigation, I</td>
                    <td align="right"><input name="Irrigation_I_qty" type="text" id="Irrigation_I_qty"   size="6"    value="#Session.Irrigation_I_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Irrigation,TM</td>
                    <td align="right"><input name="Irrigation_TM_qty" type="text" id="Irrigation_TM_qty"   size="6"    value="#Session.Irrigation_TM_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Irrigation_BFI_qty" type="text" id="Irrigation_BFI_qty"   size="6"    value="#Session.Irrigation_BFI_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Pond Maint.</td>
                    <td align="right"><input name="Pond_Maint_qty" type="text" id="Pond_Maint_qty"   size="6"    value="#Session.Pond_Maint_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Trim, Hillside</td>
                    <td align="right"><input name="Trim_Hillside_qty" type="text" id="Trim_Hillside_qty"   size="6"    value="#Session.Trim_Hillside_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Addt'l. Mowing</td>
                    <td align="right"><input name="Addtl_Mowing_qty" type="text" id="Addtl_Mowing_qty"   size="6"    value="#Session.Addtl_Mowing_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Day Porter</td>
                    <td align="right"><input name="Day_Porter_qty" type="text" id="Day_Porter_qty"   size="6"    value="#Session.Day_Porter_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Bush Hog</td>
                    <td align="right"><input name="Bush_Hog_qty" type="text" id="Bush_Hog_qty"   size="6"    value="#Session.Bush_Hog_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Trail Maint</td>
                    <td align="right"><input name="Trail_Maint_qty" type="text" id="Trail_Maint_qty"   size="6"    value="#Session.Trail_Maint_qty#"/>
                    </td>
                  ...
                  <tr>
                    <td>Natural Area</td>
                    <td align="right"><input name="Natural_Area_qty" type="text" id="Natural_Area_qty"   size="6"    value="#Session.Natural_Area_qty#"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="Trash_Receptacle_qty" type="text" id="Trash_Receptacle_qty"   size="6"    value="#Session.Trash_Receptacle_qty#"/>
                    </td>
...
<cfoutput>
                  <tr>
                    <td>Lot Sweeping</td>
                    <td align="right"><input name="Lot_Sweeping_qty" type="text" id="Lot_Sweeping_qty"   size="6"    value="#Session.Lot_Sweeping_qty#"/>
                    </td>
                    ...
                    <td align="center"><input name="Lot_Sweeping_gm" type="text"   size="3" value="#SESSION.Lot_Sweeping_gm#"/>%</td>
...
<cfoutput>
                  <tr>
                    ...
                    <td align="right"><input name="Blank1_qty" type="text" id="Blank1_qty"   size="6"    value="#Session.Blank1_qty#"/>
                    </td>
                    <td nowrap="nowrap">$
                      <input name="Blank1_cost" type="text" id="Blank1_cost"   size="5"  value="#Session.Blank1_cost#"/>
                    </td>
                ...
                <!---    <td align="center">#NumberFormat(Session.gross_margin,"999,999.99")#%</td>--->
                       <td align="center"><input name="blank1_gm" type="text"   size="3" value="#SESSION.blank1_gm#"/>%</td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="blank2_qty" type="text" id="blank2_qty"   size="6"    value="#Session.blank2_qty#"/>
                    </td>
                    <td nowrap="nowrap">$
                      <input name="blank2_cost" type="text" id="blank2_cost"   size="5"  value="#Session.blank2_cost#"/>
                    </td>
                    ...
                    <!---<td align="center">#NumberFormat(Session.gross_margin,"999,999.99")#%</td>--->
                <td align="center"><input name="blank2_gm" type="text"   size="3" value="#SESSION.blank2_gm#"/>%</td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="blank3_qty" type="text" id="blank3_qty"   size="6"    value="#Session.blank3_qty#"/>
                    </td>
                    <td nowrap="nowrap">$
                      <input name="blank3_cost" type="text" id="blank3_cost"   size="5"  value="#Session.blank3_cost#"/>
                    </td>
                   ...
                   <!--- <td align="center">#NumberFormat(Session.gross_margin,"999,999.99")#%</td>--->
           <td align="center"><input name="blank3_gm" type="text"   size="3" value="#SESSION.blank3_gm#"/>%</td>
            ...
            <div class="container-buttons">
              ...
              <div class="right-buttons">
                ...
                <input name="btnSumit" class="btn btn-primary" id="btnSumit" value="Contract Approved"/>
                &nbsp;&nbsp;
                <input name="btnSumit" type="submit" class="btn btn-primary" id="btnSumit" value="Calculate & Save"/>
...
<br />
<br />
<br /> <div class="container-buttons">
           
              <div class="right-buttons">
                
                 <input name="btnSumit"  class="btn btn-primary" id="btnSumit" value="Duplicate this Quote"/>
