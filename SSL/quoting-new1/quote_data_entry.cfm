...
<!--- Totals 4 --->
<CFIF  SESSION.Contract_Adjustment EQ ''><CFSET SESSION.Contract_Adjustment=0></CFIF>
...
#NumberFormat(SESSION.Annual_S_actual_extended,"999,999.999")#
        ...
        <cfoutput query="get_quote_info">
          <table class="table">
            ...
            <tr>
              <td>Customer</td>
              <td colspan="4"><input name="opportunity_name" value="#opportunity_name#" size="35"></td>
            </tr>
            <tr>
              <td>Job Location</td>
