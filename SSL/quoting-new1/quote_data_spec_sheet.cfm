<!---ADD TO UPDATE query push_mow_actualprice
push_mow_actual_extended
push_mow_overtime_adjustment--->
...
<cfset  push_mow_actualprice  = get_service_info.push_mow_hours*get_service_info.push_mow_cost>
<cfset Session.push_mow_materials_rate  = 0>
<cfset push_mow_service_materials  = push_mow_actualprice+Session.push_mow_materials_rate >
      ...
      <tr>
        <td valign="top"><table class="table table-striped">
            ...
            <tbody>
              ...
              <cfif  get_quote_main.push_mow_contract_price GT 0>
              <cfoutput>
                <tr>
                  <td nowrap="nowrap">Push Mow</td>
                  <td align="left">#get_service_info.push_mow_qty#</td>
                  <td nowrap="nowrap">$#get_service_info.push_mow_cost#</td>
                  <td align="left" nowrap="nowrap">#get_service_info.push_mow_rate#</td>
                  <td nowrap="nowrap">SF</td>
                  <td align="right">$ #NumberFormat(push_mow_actualprice,"999.99")#</td>
                  <td align="right">#NumberFormat(get_service_info.push_mow_hours,"999.9")#</td>
                  <td align="right">&nbsp;</td>
                  <td align="left">&nbsp;</td>
                  <td align="right">&nbsp;</td>
                  <td align="right">&nbsp;</td>
                  <td align="right">&nbsp;</td>
                  <td align="right">$ #NumberFormat(push_mow_service_materials,"999.99")#</td>
                  <td align="right">#get_service_info.push_mow_times#</td>
                  <td align="right">$ #NumberFormat(Session.push_mow_actual_extended,"999,999.99")#</td>
                  <td align="right">#NumberFormat(get_service_info.push_mow_hours,"9,999.9")#</td>
                  <td align="right">$#NumberFormat(SESSION.push_mow_overtime_adjustment,"999,999.99")#</td>
                  <td align="center">#NumberFormat(get_service_info.gross_margin,"999,999.99")#%</td>
                  <cfset  push_mow_contract_price  =  #ROUND(get_quote_main.push_mow_contract_price)#> 
                  <td align="right">$#NumberFormat(push_mow_contract_price,"999,999.99")#</td>
                </tr>
              </cfoutput> 
			  </cfif>
			  ...
			  <cfoutput>
 			  ...
 			  <cfoutput>
                <tr>
                  ...
                  <td align="center">#NumberFormat(Session.gross_margin,"999,999.99")#%<!---#SESSION.travel_time_gm#%---></td> 
