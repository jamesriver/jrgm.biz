...
<!---   <cfdump var="#get_material_admin_info#">  
 --->  <cfif  item_desc EQ 'Non-Sel. Herbicide (oz)'>
    ...
    <cfparam  name="Session.TURF_fert_materials_rate" default="#get_material_admin_info.Selling_Price#">
      ...
      <cfif  item_desc EQ 'Pelletzed Lime (lb)'>
...
<!--- ZZ-<cfoutput>#TRAVELTIME_RATE#</cfoutput> --->
...
<!--- <cfparam  name="Day_Porter_materials_qty" default="0">
  <cfparam  name="Day_Porter_MATERIALS_RATE" default="0">  --->
<cfparam  name="Session.Bush_Hog_qty" default="0"  >
<cfparam  name="Session.Bush_Hog_times" default="0">
<!--- <cfparam  name="Session.Bush_Hog_materials_qty" default="0">
 <cfparam  name="Session.Bush_Hog_MATERIALS_RATE" default="0">  --->
<cfparam  name="Bush_Hog_qty" default="0"  >
<cfparam  name="Bush_Hog_times" default="0">
<!--- <cfparam  name="Bush_Hog_materials_qty" default="0">
  <cfparam  name="Bush_Hog_MATERIALS_RATE" default="0">  --->
<cfparam  name="Session.Lot_Sweeping_qty" default="0"  >
<cfparam  name="Session.Lot_Sweeping_times" default="0">
<!--- <cfparam  name="Session.Lot_Sweeping_materials_qty" default="0">
 <cfparam  name="Session.Lot_Sweeping_MATERIALS_RATE" default="0">  --->
<cfparam  name="Lot_Sweeping_qty" default="0"  >
<cfparam  name="Lot_Sweeping_times" default="0">
<!--- <cfparam  name="Lot_Sweeping_materials_qty" default="0">
  <cfparam  name="Lot_Sweeping_MATERIALS_RATE" default="0"> ---> 
...
<!--- <cfparam  name="Session.Trash_Receptacle_materials_qty" default="0">
 <cfparam  name="Session.Trash_Receptacle_MATERIALS_RATE" default="0">  --->
<cfparam  name="Trash_Receptacle_qty" default="0"  >
<cfparam  name="Trash_Receptacle_times" default="0">
<!--- <cfparam  name="Trash_Receptacle_materials_qty" default="0">
 <cfparam  name="Trash_Receptacle_MATERIALS_RATE" default="0">  --->
...
<cfparam  name="Turf_Nutsedge_MATERIALS_RATE" default="0"> 
...
INSERT INTO quote_main (opportunity_id,gross_margin) VALUES ('#url.id#','52')
 </cfquery>
</cfif>
<!--- Quote Main Insert --->
...
turf_preg_materials_qty = '#turf_preg_materials_qty#', turf_preg_materials_rate = '#SESSION.turf_preg_materials_rate#'  ,
spraying_materials_qty = '#spraying_materials_qty#', spraying_materials_rate = '#SESSION.spraying_materials_rate#'  ,
turf_prel_materials_qty = '#turf_prel_materials_qty#', turf_prel_materials_rate = '#SESSION.turf_prel_materials_rate#'  ,
 turf_post_materials_qty = '#turf_post_materials_qty#', turf_post_materials_rate = '#SESSION.turf_post_materials_rate#'   ,
 turf_fert_materials_qty = '#turf_fert_materials_qty#', turf_fert_materials_rate = '#SESSION.turf_fert_materials_rate#'   ,
 turf_lime_materials_qty = '#turf_lime_materials_qty#', turf_lime_materials_rate = '#SESSION.turf_lime_materials_rate#'  <!---  ,
 Turf_Aer_H_materials_qty = '#Turf_Aer_H_materials_qty#', Turf_Aer_H_materials_rate = '#Turf_Aer_H_materials_rate#'   ,
 Turf_Aer_T_materials_qty = '#Turf_Aer_T_materials_qty#', Turf_Aer_T_materials_rate = '#Turf_Aer_T_materials_rate#'    --->,
 Turf_Seed_materials_qty = '#Turf_Seed_materials_qty#', Turf_Seed_materials_rate = '#SESSION.Turf_Seed_materials_rate#' ,
 TS_Fert_materials_qty = '#TS_Fert_materials_qty#', TS_Fert_materials_rate = '#SESSION.TS_Fert_materials_rate#'    ,
 TS_Insect_materials_qty = '#TS_Insect_materials_qty#', TS_Insect_materials_rate = '#SESSION.TS_Insect_materials_rate#'   ,
 Mulch_pre_materials_qty = '#Mulch_pre_materials_qty#', Mulch_pre_materials_rate = '#SESSION.Mulch_pre_materials_rate#'   ,
 mulch_s_dyed_materials_qty = '#mulch_s_dyed_materials_qty#', mulch_s_dyed_materials_rate = '#SESSION.mulch_s_dyed_materials_rate#' ,
 mulch_f_dyed_materials_qty = '#mulch_f_dyed_materials_qty#', mulch_f_dyed_materials_rate = '#SESSION.mulch_f_dyed_materials_rate#'   ,
 Annuals_S_materials_qty = '#Annuals_S_materials_qty#', Annuals_S_materials_rate = '#SESSION.Annuals_S_materials_rate#'  ,
 Annuals_F_materials_qty = '#Annuals_F_materials_qty#', Annuals_F_materials_rate = '#SESSION.Annuals_F_materials_rate#' ,
 Mulch_F_Reg_materials_qty = '#Mulch_F_Reg_materials_qty#', Mulch_F_Reg_materials_rate = '#SESSION.Mulch_F_Reg_materials_rate#'  ,
 Mulch_S_Reg_materials_qty = '#Mulch_S_Reg_materials_qty#', Mulch_S_Reg_materials_rate = '#SESSION.Mulch_S_Reg_materials_rate#' ,
 Pine_Tags_materials_qty = '#Pine_Tags_materials_qty#', Pine_Tags_materials_rate = '#SESSION.Pine_Tags_materials_rate#'   ,
 TS_hort_oil_materials_qty = '#TS_hort_oil_materials_qty#', TS_hort_oil_materials_rate = '#SESSION.TS_hort_oil_materials_rate#'  ,
 Playground_mulch_materials_qty = '#Playground_mulch_materials_qty#', Playground_mulch_materials_rate = '#SESSION.Playground_mulch_materials_rate#' ,
 Turf_Nutsedge_materials_qty = '#Turf_Nutsedge_materials_qty#', Turf_Nutsedge_materials_rate = '#SESSION.Turf_Nutsedge_materials_rate#'   ,
 Turf_Fungicide_materials_qty = '#Turf_Fungicide_materials_qty#', Turf_Fungicide_materials_rate = '#SESSION.Turf_Fungicide_materials_rate#'   ,
 Turf_Insecticide_materials_qty = '#Turf_Insecticide_materials_qty#', Turf_Insecticide_materials_rate = '#SESSION.Turf_Insecticide_materials_rate#'   
...
turf_prel_materials_qty = '#turf_prel_materials_qty#', turf_prel_materials_rate = '#turf_prel_materials_rate#'   ,
turf_post_materials_qty = '#turf_post_materials_qty#', turf_post_materials_rate = '#turf_post_materials_rate#'   ,
turf_fert_materials_qty = '#turf_fert_materials_qty#', turf_fert_materials_rate = '#turf_fert_materials_rate#'   ,
turf_lime_materials_qty = '#turf_lime_materials_qty#', turf_lime_materials_rate = '#turf_lime_materials_rate#'   <!--- ,
 Turf_Aer_H_materials_qty = '#Turf_Aer_H_materials_qty#', Turf_Aer_H_materials_rate = '#Turf_Aer_H_materials_rate#'   ,
 Turf_Aer_T_materials_qty = '#Turf_Aer_T_materials_qty#', Turf_Aer_T_materials_rate = '#Turf_Aer_T_materials_rate#'    --->,
Turf_Seed_materials_qty = '#Turf_Seed_materials_qty#', Turf_Seed_materials_rate = '#Turf_Seed_materials_rate#'   ,
TS_Fert_materials_qty = '#TS_Fert_materials_qty#', TS_Fert_materials_rate = '#TS_Fert_materials_rate#'   ,
TS_Insect_materials_qty = '#TS_Insect_materials_qty#', TS_Insect_materials_rate = '#TS_Insect_materials_rate#'   ,
Mulch_pre_materials_qty = '#Mulch_pre_materials_qty#', Mulch_pre_materials_rate = '#Mulch_pre_materials_rate#'   ,
mulch_s_dyed_materials_qty = '#mulch_s_dyed_materials_qty#', mulch_s_dyed_materials_rate = '#mulch_s_dyed_materials_rate#'  ,
mulch_f_dyed_materials_qty = '#mulch_f_dyed_materials_qty#', mulch_f_dyed_materials_rate = '#mulch_f_dyed_materials_rate#'   ,
Annuals_S_materials_qty = '#Annuals_S_materials_qty#', Annuals_S_materials_rate = '#Annuals_S_materials_rate#'  ,
Annuals_F_materials_qty = '#Annuals_F_materials_qty#', Annuals_F_materials_rate = '#Annuals_F_materials_rate#' ,
Mulch_F_Reg_materials_qty = '#Mulch_F_Reg_materials_qty#', Mulch_F_Reg_materials_rate = '#Mulch_F_Reg_materials_rate#'   ,
Mulch_S_Reg_materials_qty = '#Mulch_S_Reg_materials_qty#', Mulch_S_Reg_materials_rate = '#Mulch_S_Reg_materials_rate#'  ,
Pine_Tags_materials_qty = '#Pine_Tags_materials_qty#', Pine_Tags_materials_rate = '#SESSION.Pine_Tags_materials_rate#'  ,
TS_hort_oil_materials_qty = '#TS_hort_oil_materials_qty#', TS_hort_oil_materials_rate = '#SESSION.TS_hort_oil_materials_rate#' ,
Playground_mulch_materials_qty = '#Playground_mulch_materials_qty#', Playground_mulch_materials_rate = '#SESSION.Playground_mulch_materials_rate#'  ,
Turf_Nutsedge_materials_qty = '#Turf_Nutsedge_materials_qty#', Turf_Nutsedge_materials_rate = '#SESSION.Turf_Nutsedge_materials_rate#'  ,
...
z-<cfoutput>#Session.turf_prel_rate# -#Session.turf_prel_qty#</cfoutput>
<!--- <cfoutput>#NumberFormat(Session.push_mow_service_materials,"999,999.9")#
        
           Session.push_mow_hoursA = #Session.push_mow_hoursA#<br />

         Session.push_mow_cost = #Session.push_mow_cost# <br />

         Session.overtime_adjustment_rate=#Session.overtime_adjustment_rate# <br />

         Session.push_mow_cost = #Session.push_mow_cost#---><!---<br />---> 

 <!----Session.push_mow_service_materials =#Session.push_mow_service_materials#<br />
Session.push_mow_times= #Session.push_mow_times#<br />


         Session.push_mow_actual_extended -#Session.push_mow_actual_extended#<br />
<br />#Ceiling(Session.push_mow_actual_extended)#<br />
<br />
#NumberFormat(Session.push_mow_actual_extended,"999,999.999")#
  </cfoutput>--->
...
<cfset Session.mulch_s_dyed_hoursA = #NumberFormat(Session.mulch_s_dyed_hours,"999,999.9")#> 
...
<cfset Session.mulch_s_dyed_materials_qty = #NumberFormat(Session.mulch_s_dyed_materials_qty,"999999.99")#> 
...
<cfset Session.mulch_f_dyed_materials_qty = #NumberFormat(Session.mulch_f_dyed_materials_qty,"999999.99")#> 
...
<cfset Session.Annuals_S_materials_qty = #NumberFormat(Session.Annuals_S_materials_qty,"999999.99")#> 
...
(Session.Annuals_S_total_hours*0.10* Session.Annuals_S_cost*1.5)>
 <cfset Session.Annuals_S_contract_price = Session.Annuals_S_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
<cfset Session.Annuals_F_hoursA = #NumberFormat(Session.Annuals_F_hours,"999,999.9")#> 
...
<cfset Session.Annuals_F_materials_qty = #NumberFormat(Session.Annuals_F_materials_qty,"999999.99")#> 
...
(Session.Annuals_F_total_hours*0.10* Session.Annuals_F_cost*1.5)>
 <cfset Session.Annuals_F_contract_price = Session.Annuals_F_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
(Session.Irrigation_SU_total_hours*0.10* Session.Irrigation_SU_cost*1.5)>
 <cfset Session.Irrigation_SU_contract_price = Session.Irrigation_SU_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
(Session.Irrigation_W_total_hours*0.10* Session.Irrigation_W_cost*1.5)>
 <cfset Session.Irrigation_W_contract_price = Session.Irrigation_W_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
(Session.Irrigation_I_total_hours*0.10* Session.Irrigation_I_cost*1.5)>
 <cfset Session.Irrigation_I_contract_price = Session.Irrigation_I_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
<cfset Session.Mulch_F_Reg_materials_qty = #NumberFormat(Session.Mulch_F_Reg_materials_qty,"999999.99")#> 
...
<cfset Session.Mulch_S_Reg_materials_qty = #NumberFormat(Session.Mulch_S_Reg_materials_qty,"999999.99")#> 
...
<cfset Session.Pine_Tags_hoursA = #NumberFormat(Session.Pine_Tags_hours,"999,999.9")#> 
...
<cfset Session.Pine_Tags_materials_qty = #NumberFormat(Session.Pine_Tags_materials_qty,"999999.99")#> 
...
<cfset Session.TS_hort_oil_hoursA = #NumberFormat(Session.TS_hort_oil_hours,"999,999.9")#> 
...
<cfset Session.Addtl_Mowing_hoursA = #NumberFormat(Session.Addtl_Mowing_hours,"999,999.9")#> 
...
<cfset Session.Day_Porter_hoursA = #NumberFormat(Session.Day_Porter_hours,"999,999.9")#> 
...
(Session.Lot_Sweeping_total_hours*0.10* Session.Lot_Sweeping_cost*1.5)>
 <cfset Session.Lot_Sweeping_contract_price = Session.Lot_Sweeping_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
<cfset Session.Trail_Maint_hoursA = #NumberFormat(Session.Trail_Maint_hours,"999,999.9")#> 
...
(Session.Irrigation_TM_total_hours*0.10* Session.Irrigation_TM_cost*1.5)>
 <cfset Session.Irrigation_TM_contract_price = Session.Irrigation_TM_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
(Session.Irrigation_BFI_total_hours*0.10* Session.Irrigation_BFI_cost*1.5)>
 <cfset Session.Irrigation_BFI_contract_price = Session.Irrigation_BFI_overtime_adjustment / Session.gross_margin_diff>
<!------------------------------------------------------------------------------------------------------------->
...
<cfset Session.Playground_mulch_hoursA = #NumberFormat(Session.Playground_mulch_hours,"999,999.9")#> 
...
<cfset Session.Playground_mulch_materials_qty = #NumberFormat(Session.Playground_mulch_materials_qty,"999999.99")#> 
...
<cfset Session.Turf_Nutsedge_hoursA = #NumberFormat(Session.Turf_Nutsedge_hours,"999,999.9")#> 
...
<cfset Session.Turf_Fungicide_hoursA = #NumberFormat(Session.Turf_Fungicide_hours,"999,999.9")#> 
...
<cfset Session.Turf_Insecticide_hoursA = #NumberFormat(Session.Turf_Insecticide_hours,"999,999.9")#> 
...
<cfset Session.blank1_hoursA = #NumberFormat(Session.blank1_hours,"999,999.9")#> 
...
(Session.blank1_total_hours*0.10* Session.blank1_cost*1.5)>
 <cfset Session.blank1_contract_price = Session.blank1_overtime_adjustment / Session.gross_margin_diff>
...
<cfset Session.blank2_hoursA = #NumberFormat(Session.blank2_hours,"999,999.9")#> 
...
(Session.blank2_total_hours*0.10* Session.blank2_cost*1.5)>
 <cfset Session.blank2_contract_price = Session.blank2_overtime_adjustment / Session.gross_margin_diff>
 <!------------------------------------------------------------------------------------------------------------->
...
<cfset Session.blank3_hoursA = #NumberFormat(Session.blank3_hours,"999,999.9")#> 
...
(Session.blank3_total_hours*0.10* Session.blank3_cost*1.5)>
 <cfset Session.blank3_contract_price = Session.blank3_overtime_adjustment / Session.gross_margin_diff>
...
<div id="outerfull">
  <div id="centrecontent">
       ...
       <div class="container-box">
          ...
          <div class="header">Quote Pricing Sheet</div>
        </div>
        <form method="post" action="quote_data_entry.cfm?ID=<cfoutput>#url.id#</cfoutput>">
         <div class="button-box"><a href="dimensions_entry.cfm" class="btn btn-success" target="_blank">Dimensions Entry Sheet</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="btnSumit" type="submit" class="btn btn-primary" id="btnSumit" value="Calculate & Save"/></div>
            
      <div class="container-table">
              <div class="left-table"><!---<cfoutput>
...
#NumberFormat(Session.push_mow_actual_extended,"999,999.999")#
          ...
          <table class="table">
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>Quote Status : #opportunity_state#</td>
              <td></td>
            </tr>
                  <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>Due Date:&nbsp; #dateformat(date_due_utc,"mm/dd/yyyy")#</td>
              <td>&nbsp;</td>
            </tr>
                  <tr>
              <td>Date Created :&nbsp;#dateformat(date_created_utc,"mm/dd/yyyy")# </td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>Date Modified : #dateformat(date_updated_utc,"mm/dd/yyyy")#</td>
              <td>&nbsp;</td>
            </tr>
                  <tr>
              <td>&nbsp;</td>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td align="right"><input name="push_mow_qty" type="text" id="push_mow_qty"   size="5"    value="#Session.push_mow_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="walk_behind_qty" type="text" id="walk_behind_qty"   size="5"   value="#Session.walk_behind_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="ride_mow_qty" type="text" id="ride_mow_qty"   size="5"   value="#Session.ride_mow_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="hard_edge_qty" type="text" id="hard_edge_qty"   size="5"   value="#Session.hard_edge_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="bed_edge_qty" type="text" id="bed_edge_qty"   size="5"   value="#Session.bed_edge_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="Trim_O_qty" type="text" id="Trim_O_qty"   size="5"   value="#Session.Trim_O_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Trim_O_Times" type="text"   size="1" value="#Session.Trim_O_Times#"/></td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="Trim_S_qty" type="text" id="Trim_S_qty"   size="5"   value="#Session.Trim_S_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="trim_S_times" type="text"   size="1" value="#Session.trim_S_times#"/></td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="spraying_qty" type="text" id="spraying_qty"   size="5"   value="#Session.spraying_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="spraying_materials_qty" type="text" id="spraying_materials_qty"   size="5"    value="#Session.spraying_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="weeding_qty" type="text" id="weeding_qty"   size="5"   value="#Session.weeding_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="blowing_qty" type="text" id="blowing_qty"   size="5"   value="#Session.blowing_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="Trash_S_Qty" type="text" id="Trash_S_Qty"   size="5"   value="#Session.Trash_S_Qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Trash_S_Times" type="text"   size="1" value="#Session.Trash_S_Times#"/></td>
                  ...
                  <tr>
                    ...
                    <td align="right"><input name="traveltime_qty" type="text" id="traveltime_qty"   size="5"   value="#Session.traveltime_qty#"/>
                    </td>
                    ...
                    <td align="right">$#NumberFormat(Session.traveltime_contract_price,"999,999.99")#</td>
                      ...
                      <tr>
                          ...
                          <td align="right"><input name="Trash_O_Qty" type="text" id="Trash_O_Qty"   size="5"   value="#Session.Trash_O_Qty#"/>
                        </td>
                          ...
                          <td align="right"><input name="Trash_O_Times" type="text"   size="1" value="#Session.Trash_O_Times#"/></td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="leafrem_qty" type="text" id="leafrem_qty"   size="5"   value="#Session.leafrem_qty#"/>
                        </td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="cleanup_qty" type="text" id="cleanup_qty"   size="5"   value="#Session.cleanup_qty#"/>
                        </td>
                      ...
                      <tr>
                        <td>Turf Pre (G)</td>
                        <td align="right"><input name="turf_preg_qty" type="text" id="turf_preg_qty"   size="5"    value="#Session.turf_preg_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="turf_preg_materials_qty" type="text" id="turf_preg_materials_qty"   size="5"    value="#Session.turf_preg_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                      ...
                      <tr>
                        <td>Turf Pre (L)</td>
                        <td align="right"><input name="turf_prel_qty" type="text" id="turf_prel_qty"   size="5"    value="#Session.turf_prel_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="turf_prel_materials_qty" type="text" id="turf_prel_materials_qty"   size="5"    value="#Session.turf_prel_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="turf_prel_times" type="text" class="form_buttons"    size="1"  value="#Session.turf_prel_times#"/></td>
                      ...
                      <tr>
                        <td>Turf Post</td>
                        <td align="right"><input name="turf_post_qty" type="text" id="turf_post_qty"   size="5"    value="#Session.turf_post_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="turf_post_materials_qty" type="text" id="turf_post_materials_qty"   size="5"    value="#Session.turf_post_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="turf_post_times" type="text" class="form_buttons"    size="1"  value="#Session.turf_post_times#"/></td>
                      ...
                      <tr>
                        <td>Turf Fert</td>
                        <td align="right"><input name="turf_fert_qty" type="text" id="turf_fert_qty"   size="5"    value="#Session.turf_fert_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="turf_fert_materials_qty" type="text" id="turf_fert_materials_qty"   size="5"    value="#Session.turf_fert_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="turf_fert_times" type="text" class="form_buttons"    size="1"  value="#Session.turf_fert_times#"/></td>
                      ...
                      <tr>
                        <td>Turf Lime</td>
                        <td align="right"><input name="turf_lime_qty" type="text" id="turf_lime_qty"   size="5"    value="#Session.turf_lime_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="turf_lime_materials_qty" type="text" id="turf_lime_materials_qty"   size="5"    value="#Session.turf_lime_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="turf_lime_times" type="text" class="form_buttons"    size="1"  value="#Session.turf_lime_times#"/></td>
                      ...
                      <tr>
                        <td>Turf Aer (H)</td>
                        <td align="right"><input name="Turf_Aer_H_qty" type="text" id="Turf_Aer_H_qty"   size="5"    value="#Session.Turf_Aer_H_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Turf_Aer_H_times" type="text" class="form_buttons"    size="1"  value="#Session.Turf_Aer_H_times#"/></td>
                      ...
                      <tr>
                        <td>Turf Aer (T)</td>
                        <td align="right"><input name="Turf_Aer_T_qty" type="text" id="Turf_Aer_T_qty"   size="5"    value="#Session.Turf_Aer_T_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Turf_Aer_T_times" type="text" class="form_buttons"    size="1"  value="#Session.Turf_Aer_T_times#"/></td>
                      ...
                      <tr>
                        <td>Turf  Seed</td>
                        <td align="right"><input name="Turf_Seed_qty" type="text" id="Turf_Seed_qty"   size="5"    value="#Session.Turf_Seed_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Turf_Seed_materials_qty" type="text" id="Turf_Seed_materials_qty"   size="5"    value="#Session.Turf_Seed_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="Turf_Seed_times" type="text" class="form_buttons"    size="1"  value="#Session.Turf_Seed_times#"/></td>
...
<cfoutput>
                  <tr>
                   <td>Turf Nutsedge</td>
                    <td align="right"><input name="Turf_Nutsedge_qty" type="text" id="Turf_Nutsedge_qty"   size="5"    value="#Session.Turf_Nutsedge_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Turf_Nutsedge_cost#</td>
                    ...
                    <td align="right"><input name="Turf_Nutsedge_materials_qty" type="text" id="Turf_Nutsedge_materials_qty"   size="5"    value="#Session.Turf_Nutsedge_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Turf_Nutsedge_times" type="text" class="form_buttons"    size="1"  value="#Session.Turf_Nutsedge_times#"/></td>
                ...
                <cfoutput>
                  <tr>
                   <td>Turf Fungicide</td>
                    <td align="right"><input name="Turf_Fungicide_qty" type="text" id="Turf_Fungicide_qty"   size="5"    value="#Session.Turf_Fungicide_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Turf_Fungicide_cost#</td>
                    ...
                    <td align="right"><input name="Turf_Fungicide_materials_qty" type="text" id="Turf_Fungicide_materials_qty"   size="5"    value="#Session.Turf_Fungicide_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Turf_Fungicide_times" type="text" class="form_buttons"    size="1"  value="#Session.Turf_Fungicide_times#"/></td>
                  ...
                  <tr>
                   <td>Turf Insecticide</td>
                    <td align="right"><input name="Turf_Insecticide_qty" type="text" id="Turf_Insecticide_qty"   size="5"    value="#Session.Turf_Insecticide_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Turf_Insecticide_cost#</td>
                    ...
                    <td align="right"><input name="Turf_Insecticide_materials_qty" type="text" id="Turf_Insecticide_materials_qty"   size="5"    value="#Session.Turf_Insecticide_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Turf_Insecticide_times" type="text" class="form_buttons"    size="1"  value="#Session.Turf_Insecticide_times#"/></td>
                    ...
                    <td align="right">$#NumberFormat(Session.Turf_Insecticide_contract_price,"999,999.99")#</td>
                     ...
                     <cfoutput>
                      <tr>
                        <td>Pruning, T/P</td>
                        <td align="right"><input name="Pruning_TP_qty" type="text" id="Pruning_TP_qty"   size="5"    value="#Session.Pruning_TP_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Pruning_TP_times" type="text" class="form_buttons"    size="1"  value="#Session.Pruning_TP_times#"/></td>
                      ...
                      <tr>
                        <td>Pruning, S</td>
                        <td align="right"><input name="Pruning_S_qty" type="text" id="Pruning_S_qty"   size="5"    value="#Session.Pruning_S_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Pruning_S_times" type="text" class="form_buttons"    size="1"  value="#Session.Pruning_S_times#"/></td>
                      ...
                      <tr>
                        <td>T&amp;S, Fert</td>
                        <td align="right"><input name="TS_Fert_qty" type="text" id="TS_Fert_qty"   size="5"    value="#Session.TS_Fert_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="TS_Fert_materials_qty" type="text" id="TS_Fert_materials_qty"   size="5"    value="#Session.TS_Fert_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="TS_Fert_times" type="text" class="form_buttons"    size="1"  value="#Session.TS_Fert_times#"/></td>
                      ...
                      <tr>
                        <td>T&amp;S, Insect</td>
                        <td align="right"><input name="TS_Insect_qty" type="text" id="TS_Insect_qty"   size="5"    value="#Session.TS_Insect_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="TS_Insect_materials_qty" type="text" id="TS_Insect_materials_qty"   size="5"    value="#Session.TS_Insect_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="TS_Insect_times" type="text" class="form_buttons"    size="1"  value="#Session.TS_Insect_times#"/></td>
                      ...
                      <tr>
                        <td>Mulch, Pre</td>
                        <td align="right"><input name="Mulch_pre_qty" type="text" id="Mulch_pre_qty"   size="5"    value="#Session.Mulch_pre_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Mulch_pre_materials_qty" type="text" id="Mulch_pre_materials_qty"   size="5"    value="#Session.Mulch_pre_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="Mulch_pre_times" type="text" class="form_buttons"    size="1"  value="#Session.Mulch_pre_times#"/></td>
                      ...
                      <tr>
                        <td>Mulch, Edging</td>
                        <td align="right"><input name="Mulch_edging_qty" type="text" id="Mulch_edging_qty"   size="5"    value="#Session.Mulch_edging_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Mulch_edging_times" type="text" class="form_buttons"    size="1"  value="#Session.Mulch_edging_times#"/></td>
                      ...
                      <tr>
                        <td>Mulch, S (dyed)</td>
                        <td align="right"><input name="mulch_s_dyed_qty" type="text" id="mulch_s_dyed_qty"   size="5"    value="#Session.mulch_s_dyed_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="mulch_s_dyed_materials_qty" type="text" id="mulch_s_dyed_materials_qty"   size="5"    value="#Session.mulch_s_dyed_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="mulch_s_dyed_times" type="text" class="form_buttons"    size="1"  value="#Session.mulch_s_dyed_times#"/></td>
                      ...
                      <tr>
                        <td>Mulch, F (dyed)</td>
                        <td align="right"><input name="mulch_f_dyed_qty" type="text" id="mulch_f_dyed_qty"   size="5"    value="#Session.mulch_f_dyed_qty#"/>
                        </td>
                        ...
                        <td align="right">&nbsp;</td>
                        <td align="left">Dyed Mulch</td>
                        <td align="right"><input name="mulch_f_dyed_materials_qty" type="text" id="mulch_f_dyed_materials_qty"   size="5"    value="#Session.mulch_f_dyed_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="mulch_f_dyed_times" type="text" class="form_buttons"    size="1"  value="#Session.mulch_f_dyed_times#"/></td>
                  ...
                  <tr>
                   <td>Mulch, S (reg)</td>
                    <td align="right"><input name="Mulch_S_Reg_qty" type="text" id="Mulch_S_Reg_qty"   size="5"    value="#Session.Mulch_S_Reg_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Mulch_S_Reg_cost#</td>
                    ...
                    <td align="right"><input name="Mulch_S_Reg_materials_qty" type="text" id="Mulch_S_Reg_materials_qty"   size="5"    value="#Session.Mulch_S_Reg_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Mulch_S_Reg_times" type="text" class="form_buttons"    size="1"  value="#Session.Mulch_S_Reg_times#"/></td>
                  ...
                  <tr>
                   <td>Mulch, F&nbsp;(reg)</td>
                    <td align="right"><input name="Mulch_F_Reg_qty" type="text" id="Mulch_F_Reg_qty"   size="5"    value="#Session.Mulch_F_Reg_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Mulch_F_Reg_cost#</td>
                    ...
                    <td align="right">&nbsp;</td>
                    <td align="left">Non-Dyed Mulch</td>
                    <td align="right"><input name="Mulch_F_Reg_materials_qty" type="text" id="Mulch_F_Reg_materials_qty"   size="5"    value="#Session.Mulch_F_Reg_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Mulch_F_Reg_times" type="text" class="form_buttons"    size="1"  value="#Session.Mulch_F_Reg_times#"/></td>
					...
					<cfoutput>
                      <tr>
                        <td>Annuals, S</td>
                        <td align="right"><input name="Annuals_S_qty" type="text" id="Annuals_S_qty"   size="5"    value="#Session.Annuals_S_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Annuals_S_materials_qty" type="text" id="Annuals_S_materials_qty"   size="5"    value="#Session.Annuals_S_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="Annuals_S_times" type="text" class="form_buttons"    size="1"  value="#Session.Annuals_S_times#"/></td>
                    ...
                    <cfoutput>
                      <tr>
                        <td>Annuals, F</td>
                        <td align="right"><input name="Annuals_F_qty" type="text" id="Annuals_F_qty"   size="5"    value="#Session.Annuals_F_qty#"/>
                        </td>
                        ...
                        <td align="right">&nbsp;</td>
                        <td align="left">Flowers (6&quot; pots)</td>
                        <td align="right"><input name="Annuals_F_materials_qty" type="text" id="Annuals_F_materials_qty"   size="5"    value="#Session.Annuals_F_materials_qty#"/>
                        </td>
                        <cfif NOT IsDefined("url.enter_materials_rate")>
                        ...
                        <td align="right"><input name="Annuals_F_times" type="text" class="form_buttons"    size="1"  value="#Session.Annuals_F_times#"/></td>
                      ...
                      <tr>
                        <td>Irrigation, SU</td>
                        <td align="right"><input name="Irrigation_SU_qty" type="text" id="Irrigation_SU_qty"   size="5"    value="#Session.Irrigation_SU_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Irrigation_SU_times" type="text" class="form_buttons"    size="1"  value="#Session.Irrigation_SU_times#"/></td>
                      ...
                      <tr>
                        <td>Irrigation, W</td>
                        <td align="right"><input name="Irrigation_W_qty" type="text" id="Irrigation_W_qty"   size="5"    value="#Session.Irrigation_W_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Irrigation_W_times" type="text" class="form_buttons"    size="1"  value="#Session.Irrigation_W_times#"/></td>
                      ...
                      <tr>
                        <td>Irrigation, I</td>
                        <td align="right"><input name="Irrigation_I_qty" type="text" id="Irrigation_I_qty"   size="5"    value="#Session.Irrigation_I_qty#"/>
                        </td>
                        ...
                        <td align="right"><input name="Irrigation_I_times" type="text" class="form_buttons"    size="1"  value="#Session.Irrigation_I_times#"/></td>
                     ...
                     <cfoutput>
                                   <tr>
                    <td>Irrigation,TM</td>
                    <td align="right"><input name="Irrigation_TM_qty" type="text" id="Irrigation_TM_qty"   size="5"    value="#Session.Irrigation_TM_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Irrigation_TM_cost#</td>
                    ...
                    <td align="right"><input name="Irrigation_TM_times" type="text" class="form_buttons"    size="1"  value="#Session.Irrigation_TM_times#"/></td>
                ...
                <cfoutput>
                    ...
                    <td align="right"><input name="Irrigation_BFI_qty" type="text" id="Irrigation_BFI_qty"   size="5"    value="#Session.Irrigation_BFI_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Irrigation_BFI_cost#</td>
                    ...
                    <td align="right"><input name="Irrigation_BFI_times" type="text" class="form_buttons"    size="1"  value="#Session.Irrigation_BFI_times#"/></td>
                 ...
                 <cfoutput>
                                   <tr>
                    <td>Pond Maint.</td>
                    <td align="right"><input name="Pond_Maint_qty" type="text" id="Pond_Maint_qty"   size="5"    value="#Session.Pond_Maint_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Pond_Maint_cost#</td>
                    ...
                    <td align="right"><input name="Pond_Maint_times" type="text" class="form_buttons"    size="1"  value="#Session.Pond_Maint_times#"/></td>
                  ...
                  <cfoutput>
                    <tr>
                    <td>Trim, Hillside</td>
                    <td align="right"><input name="Trim_Hillside_qty" type="text" id="Trim_Hillside_qty"   size="5"    value="#Session.Trim_Hillside_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Trim_Hillside_cost#</td>
                    ...
                    <td align="right"><input name="Trim_Hillside_times" type="text" class="form_buttons"    size="1"  value="#Session.Trim_Hillside_times#"/></td>
                ...
                <cfoutput>
                  <tr>
                   <td>Pine Tags</td>
                    <td align="right"><input name="Pine_Tags_qty" type="text" id="Pine_Tags_qty"   size="5"    value="#Session.Pine_Tags_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Pine_Tags_cost#</td>
                    ...
                    <td align="right"><input name="Pine_Tags_materials_qty" type="text" id="Pine_Tags_materials_qty"   size="5"    value="#Session.Pine_Tags_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Pine_Tags_times" type="text" class="form_buttons"    size="1"  value="#Session.Pine_Tags_times#"/></td>
                ...
                <cfoutput>
                  <tr>
                   <td>T&S, Hort Oil</td>
                    <td align="right"><input name="TS_hort_oil_qty" type="text" id="TS_hort_oil_qty"   size="5"    value="#Session.TS_hort_oil_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.TS_hort_oil_cost#</td>
                    ...
                    <td align="right">&nbsp;</td>
                    <td align="left">Hort/Dormant Oil
</td>
                    <td align="right"><input name="TS_hort_oil_materials_qty" type="text" id="TS_hort_oil_materials_qty"   size="5"    value="#Session.TS_hort_oil_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="TS_hort_oil_times" type="text" class="form_buttons"    size="1"  value="#Session.TS_hort_oil_times#"/></td>
				...
				<cfoutput>
                                   <tr>
                    <td>Addt'l. Mowing</td>
                    <td align="right"><input name="Addtl_Mowing_qty" type="text" id="Addtl_Mowing_qty"   size="5"    value="#Session.Addtl_Mowing_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Addtl_Mowing_cost#</td>
                    ...
                    <td align="right"><input name="Addtl_Mowing_times" type="text" class="form_buttons"    size="1"  value="#Session.Addtl_Mowing_times#"/></td>
                 ...
                 <tr>
                    <td>Day Porter</td>
                    <td align="right"><input name="Day_Porter_qty" type="text" id="Day_Porter_qty"   size="5"    value="#Session.Day_Porter_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Day_Porter_cost#</td>
                    ...
                    <td align="right"><input name="Day_Porter_times" type="text" class="form_buttons"    size="1"  value="#Session.Day_Porter_times#"/></td>
                 ...
                 <cfoutput>
                                   <tr>
                    <td>Bush Hog</td>
                    <td align="right"><input name="Bush_Hog_qty" type="text" id="Bush_Hog_qty"   size="5"    value="#Session.Bush_Hog_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Bush_Hog_cost#</td>
                    ...
                    <td align="right"><input name="Bush_Hog_times" type="text" class="form_buttons"    size="1"  value="#Session.Bush_Hog_times#"/></td>
                ...
                <cfoutput>
                                   <tr>
                    <td>Lot Sweeping</td>
                    <td align="right"><input name="Lot_Sweeping_qty" type="text" id="Lot_Sweeping_qty"   size="5"    value="#Session.Lot_Sweeping_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Lot_Sweeping_cost#</td>
                    ...
                    <td align="right"><input name="Lot_Sweeping_times" type="text" class="form_buttons"    size="1"  value="#Session.Lot_Sweeping_times#"/></td>
                 ...
                 <cfoutput>
                                   <tr>
                    <td>Trail Maint</td>
                    <td align="right"><input name="Trail_Maint_qty" type="text" id="Trail_Maint_qty"   size="5"    value="#Session.Trail_Maint_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Trail_Maint_cost#</td>
                    ...
                    <td align="right"><input name="Trail_Maint_times" type="text" class="form_buttons"    size="1"  value="#Session.Trail_Maint_times#"/></td>
               ...
               <cfoutput>
                        <tr>
                    <td>Natural Area</td>
                    <td align="right"><input name="Natural_Area_qty" type="text" id="Natural_Area_qty"   size="5"    value="#Session.Natural_Area_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Natural_Area_cost#</td>
                    ...
                    <td align="right"><input name="Natural_Area_times" type="text" class="form_buttons"    size="1"  value="#Session.Natural_Area_times#"/></td>
                 ...
                 <cfoutput>
                    ...
                    <td align="right"><input name="Trash_Receptacle_qty" type="text" id="Trash_Receptacle_qty"   size="5"    value="#Session.Trash_Receptacle_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Trash_Receptacle_cost#</td>
                    ...
                    <td align="right"><input name="Trash_Receptacle_times" type="text" class="form_buttons"    size="1"  value="#Session.Trash_Receptacle_times#"/></td>
                ...
                <cfoutput>
                  <tr>
                   <td>Playground Mulch</td>
                    <td align="right"><input name="Playground_mulch_qty" type="text" id="Playground_mulch_qty"   size="5"    value="#Session.Playground_mulch_qty#"/>
                    </td>
             <td nowrap="nowrap">$#Session.Playground_mulch_cost#</td>
                    ...
                    <td align="right">&nbsp;</td>
                    <td align="left">Dyed Mulch</td>
                    <td align="right"><input name="Playground_mulch_materials_qty" type="text" id="Playground_mulch_materials_qty"   size="5"    value="#Session.Playground_mulch_materials_qty#"/>
                    </td>
                    <cfif NOT IsDefined("url.enter_materials_rate")>
                    ...
                    <td align="right"><input name="Playground_mulch_times" type="text" class="form_buttons"    size="1"  value="#Session.Playground_mulch_times#"/></td>
                   ...
                   <cfoutput>
                           <tr>
                    <td><input name="Blank1_service"  type="text" id="Blank1_service"   size="35"    value="#Session.Blank1_service#"/></td>
                    <td align="right"><input name="Blank1_qty" type="text" id="Blank1_qty"   size="5"    value="#Session.Blank1_qty#"/>
                    </td>
             <td nowrap="nowrap">$  <input name="Blank1_cost" type="text" id="Blank1_cost"   size="5"  value="#Session.Blank1_cost#"/> </td>
                    ...
                    <td align="right"><input name="Blank1_times" type="text" class="form_buttons"    size="1"  value="#Session.Blank1_times#"/></td>
                 ...
                 <cfoutput>
                           <tr>
                    <td><input name="blank2_service"  type="text" id="blank2_service"   size="35"    value="#Session.blank2_service#"/></td>
                    <td align="right"><input name="blank2_qty" type="text" id="blank2_qty"   size="5"    value="#Session.blank2_qty#"/>
                    </td>
             <td nowrap="nowrap">$  <input name="blank2_cost" type="text" id="blank2_cost"   size="5"  value="#Session.blank2_cost#"/> </td>
                    ...
                    <td align="right"><input name="blank2_times" type="text" class="form_buttons"    size="1"  value="#Session.blank2_times#"/></td>
                ...
                <cfoutput>
                           <tr>
                    <td><input name="blank3_service"  type="text" id="blank3_service"   size="35"    value="#Session.blank3_service#"/></td>
                    <td align="right"><input name="blank3_qty" type="text" id="blank3_qty"   size="5"    value="#Session.blank3_qty#"/>
                    </td>
             <td nowrap="nowrap">$  <input name="blank3_cost" type="text" id="blank3_cost"   size="5"  value="#Session.blank3_cost#"/> </td>
                    ...
                    <td align="right"><input name="blank3_times" type="text" class="form_buttons"    size="1"  value="#Session.blank3_times#"/></td>
  ...
  <tr>
    <td>Contract Price</td>
      <td  align="right" nowrap="nowrap">$ <cfoutput>#NumberFormat(Session.total_contract_price,"999,999.99")#</cfoutput></td>
  </tr>
</table>
</td>
    <td  width="100">&nbsp;</td>
  ...
  <tr>
   ...
   <td align="right"><cfoutput>#NumberFormat(gross_margin0 ,"999,999.99")#</cfoutput></td>
	...
	<CFSET net_profit0_percentage = 100*NumberFormat(net_profit0 ,"999999.99")/NumberFormat(Session.total_contract_price,"999999.99")><cfelse><CFSET net_profit0_percentage = 0></cfif>
