...
INSERT INTO equipment_inspections (EQUIPMENT_ID,enter_date, entered_by,inspection_date,
inspection_mileage,inspection_hours)         
VALUES 
('#form.EquipmentID#',CURRENT_TIMESTAMP,'#SESSION.userid#', '#form.inspection_date#',
'#form.inspection_mileage#',   '#form.inspection_hours#')
  </cfquery>
  
   <cfif  form.inspection_hours EQ "">
 <CFSET form.inspection_hours =0>
  </cfif>

  <cfif  form.inspection_mileage EQ "">
 <CFSET form.inspection_mileage =0>
 </cfif>

<cfquery name="update_eq_table" datasource="jrgm"  >
UPDATE equipment SET    last_inspection_date =  '#form.inspection_date#'
  ...
  <div class="page-head">
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        <h1>Enter Inspection Information</h1>
      </div>
      <!-- END PAGE TITLE --> 
      <!-- BEGIN PAGE TOOLBAR -->
      <div class="page-toolbar"> 
        ...
        <li class="active">Enter Inspection Information</li>
      </ul>
      </div>
      <!-- END PAGE TOOLBAR --> 
    </div>
   ...
   <div class="page-content">
	<div class="container-fluid">
			<!-- BEGIN PAGE CONTENT INNER -->	
					<div class="row">
					  <div class="col-md-6">
                     <form method="post" action="inspection_info_equipment.cfm"  >
       ...
       <tbody>
         ...
         <tr>
           ...
           <td><input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="inspection_date" value=""/>
            </td>
         </tr>
       <tr>
         <td>Inspection Hours:</td>
         <td>
           <input name="inspection_hours" class="form-control input-inline input-small" placeholder="Enter hours" type="text" size="8" maxlength="8" />
           </td>
       </tr>
       <tr>
         <td>Inspection Mileage:</td>
         <td><input name="inspection_mileage" class="form-control input-inline input-small" placeholder="Enter mileage"  type="text" size="10" maxlength="10" /></td>
       </tr>
