	...
	<div class="container-fluid">
       ...
       <tbody>
         ...
         <tr>
           ...
           <td><input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="oil_change_date" value=""/>
            </td>
         </tr>
       <tr>
         <td>Oil Changed By:</td>
         <td>
           <select name="employeeID" class="bs-select form-control">
