    ...
    <table width="100%" border="0" cellpadding="0"  >
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="dailysheet_table_top" >
            <tr>
              <td nowrap="nowrap" class="dstable_top1">Date :</td>
              <td nowrap="nowrap" class="dstable_top2"><cfoutput>#DateFormat(ds_date, "mmmm dd, yyyy")#</cfoutput></td>
              <td nowrap="nowrap" class="dstable_top1">DSID :</td>
              <td nowrap="nowrap" class="dstable_top2"><cfoutput query="get_ds">#ID#</cfoutput></td>
              <td class="dstable_top1" >Crew Leader :</td>
              <td class="dstable_top2" ><cfoutput>#get_crew_leader.employeename#</cfoutput></td>
              <td class="dstable_top1">Supervisor :</td>
              <td class="dstable_top2"><cfoutput>#get_supervisor.employeename#</cfoutput></td>
                 <td nowrap="nowrap" class="dstable_top3"><cfif get_ds.ds_approved EQ 1>
          ...
          <cfif ((ds_date LTE  yesterday) OR  ((ds_date EQ  todaydate_DS))  AND timenow GT today_3PM) AND get_open_workers.recordcount  EQ 0>
				...
				<cfif get_ds.ds_approved NEQ 1>
                 <!---    <cfoutput><a href="daily_sheet.cfm?dsid=#get_ds.ID#&email=yes&unapprove=yes" class="redbutton">Approved</a></cfoutput>
                    <cfelse> --->
                    <cfoutput><a href="daily_sheet_edit.cfm?dsid=#get_ds.ID#"  class="dssbutton">Edit </a><!--- <a href="daily_sheet.cfm?dsid=#get_ds.ID#&email=yes&approve=yes" class="greenbutton">Approve</a> ---></cfoutput>
                  </cfif>
                </td>
              </cfif>  
            </tr>
 ...
 --->
       ...
       ORDER BY  ID ASC
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="dailysheet_table">
              <cfoutput>
                <tr>
                  <td   colspan="17" valign="middle" nowrap="nowrap"  class="dstable_headersm1">#get_this_job_name.event_name# - #job_id# - Job Clock ID: #get_this_job.id# <br />
