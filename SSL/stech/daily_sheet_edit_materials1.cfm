...
<div id="outerfull">
    ...
    <div class="centrecontent_inner">
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="dailysheet_table_top" >
        ...
        <tr>
          ...
          <td align="left" nowrap="nowrap" class="dailysheetEditTop" >&nbsp;</td>
          <td align="left" nowrap="nowrap" class="dailysheetEditTop" >Job ID:&nbsp;<cfoutput></cfoutput></td>
  ...
  <tr>
    <td> 
      <p  class="arialfont">Are you sure you want to delete this material from this daily sheet?
        <br />
      </p>
    
      <p  class="arialfont"><cfoutput><a href="daily_sheet_edit_materials1.cfm?ID=#url.matid#&deleteme=yes&matid=#url.matid#&ds_id=#ds_id#" class="YesNoButton">
        Yes</a> 
          &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href="daily_sheet_edit_materials1.cfm?ID=#url.matid#&matid=#url.matid#&ds_id=#ds_id#" class="YesNoButton">No</a> </strong></p> 
           <p  class="redarial"> Choosing yes will delete the material from this daily sheet.
		   </p></cfoutput>  
     </td>
  </tr>
</table>
...
SELECT *  FROM app_materials_list order by item_id
        ...
        <table width="70%" border="0" cellpadding="0" cellspacing="0" >
         ...
         <!---  <tr>
          ...
          <tr>
            <td colspan="2" align="left" nowrap="nowrap"  class="dailysheetEditTop">  <cfoutput>
         <a href="daily_sheet_edit.cfm?dsid=#ds_id#"  class="dssbutton">Back to Daily Sheet</a>  
      <a href="daily_sheet_edit_materials1.cfm?ds_id=#ds_id#&MATID=#get_this_material.ID#&delete=yes"  id="deleteme" class="deletebutton">Delete this material</a></td>
       </cfoutput>
          </tr>
          <cfoutput>
      ...
      <!--- <cfoutput>
        <p><a href="daily_sheet_edit.cfm?dsid=#ds_id#" class="materialsbutton">Back to Daily Sheet</a> </p>
      </cfoutput> ---> </div>
  </div>
  <!-- to clear footer -->
</div>
