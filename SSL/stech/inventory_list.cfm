    ...
    <div class="centrecontent_inner">
      <form action="inventory_list.cfm" method="post">
        <table border="0" cellspacing="0" cellpadding="0" class="search">
          <tr>
            <td class="search-td"><input type="text" name="criteria" class="searchbox" placeholder="Search..." />
...
ORDER by  ID ASC
      ...
      <div class="header"><cfoutput>#Session.branch#</cfoutput> Inventory List <span class="record-count"><cfoutput>#getequipment.recordcount#</cfoutput> Records</span></div>
