   ...
   <cfinclude template="includes/subbar.cfm">
    ...
    <div class="centrecontent_inner">
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="header">Payroll For <cfoutput>#SESSION.screenname#</cfoutput> since <cfoutput>#DateFormat("#payroll_start_date#", "mm/dd/yyyy")#</cfoutput></td>
        </tr>
      </table>
...
ORDER by APP_employees.last_name
       ...
       <cfoutput query="get_employees_with_time">
        <li class="dstable_cl"><a href="payroll_view_employee_detail1.cfm?empid=#get_employees_with_time.Employee_ID#" >#get_employees_with_time.first_name# #get_employees_with_time.last_name# </a></li>
  </cfoutput>
       </ul>
    </div>
    <!--Html-->
