...
ORDER by APP_employees.last_name
      ...
      <ul>
       <cfoutput query="get_employees_with_time">
        <li class="dstable_cl"><a href="payroll_view_employee_detail2.cfm?empid=#get_employees_with_time.Employee_ID#" >#get_employees_with_time.first_name# #get_employees_with_time.last_name# </a></li>
       </cfoutput>
       </ul>
    </div>
    <!--Html-->
