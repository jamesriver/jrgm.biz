...
<cfset tomorrow = dateadd("d",1,somedate)>
 ...
 <cfquery name="get_employees_with_time" datasource="jrgm"  >
		...
		WHERE supervisor = #SESSION.userid#  AND (app_employee_payroll_clock.Time_In > '#DateFormat(pay_period_start, "yyyy-mm-dd")# 00:00:00.000' AND app_employee_payroll_clock.Time_Out < '#DateFormat(pay_period_end_week_plusone, 'yyyy-mm-dd')#')
 ...
 <cfoutput query="app_payroll_periods"> <tr class="job_data">
  ...
  <tr>
    <td>These pay periods have been approved</td>
      ...
      <form action="payroll_view_employee_detail_1week.cfm" method="post">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sortable" >
         <thead> 
          ...
          <cfoutput>
            <tr>
              <td align="left">&nbsp;</td>
              <td><span class="datesm">#DateFormat("#pay_period_start#", "ddd mm/dd/yyyy")#</span></td>
...
SELECT Employee_ID,  time_worked, in_out_status,ds_date 
 ...
 AND in_out_status =2
          ...
          <cfloop query="get_employees_with_time" >
             <cfoutput><tr>
                <td nowrap="nowrap"><a href="payroll_view_employee_detail2.cfm?empid=#get_employees_with_time.Employee_ID#" target="_blank">#get_employees_with_time.first_name# #get_employees_with_time.last_name# </a></td>
              </cfoutput>
