...
<div id="outerfull">
  ...
  <div class="centrecontent_inner">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="header">Notes for <cfif IsDefined("url.employee_ID")><cfoutput query="get_this_employee">#employeename#</cfoutput></cfif> <cfif IsDefined("url.job_ID")><cfoutput query="get_job_info">#locationname#</cfoutput></cfif></td>
        </tr>
      </table>
...
ORDER by Note_Date DESC
      ...
      <ul class="crew">
        <cfif get_job_notes.recordcount EQ 0>
          <li>There are no notes for this <cfif IsDefined("url.employee_ID")>employee</cfif><cfif IsDefined("url.Job_ID")>job</cfif>.</li>
          <cfelse>
     ...
     <cfif IsDefined("url.employee_ID")> <cfoutput> <a href="notes.cfm?work_date=#url.work_date#&employee_id=#employee_id#" class="bluebutton">Add Notes</a></cfoutput> </cfif>
     
          <cfif IsDefined("url.job_ID")> <cfoutput> <a href="notes.cfm?work_date=#url.work_date#&job_ID=#job_ID#" class="bluebutton">Add Notes</a></cfoutput> </cfif>
