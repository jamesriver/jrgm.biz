  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="jobbutton">
        ...
        <a href="https://www.jrgm.biz/ssl/admin/directory.cfm"><img src="https://www.jrgm.biz/ssl/admin/images/directory_icon.png" width="60" height="60" alt="Crews" class="icons" /></a> </td>
