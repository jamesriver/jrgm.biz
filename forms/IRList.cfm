  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="jobbutton">
        ...
        <a href="/ssl/admin/directory.cfm"><img src="/ssl/admin/images/directory_icon.png" width="60" height="60" alt="Crews" class="icons" /></a> </td>
...
<tr>
    ...
    <td align="right"><a href="http://api.jrgm.com/biz/incidentreport_bo.php?id=#IR_ID#" target="_blank">View Report</a></td>
  <cfdirectory action="list" directory="C:\inetpub\websites\jrgm.biz\forms\photos\incident_reports\" name="incident_reports" recurse="true">
...
<cfif  incident_reports.recordcount GT 0>
  <td align="right">
         <a href="photos/incident_reports/#IR_ID#.pdf">  <img src="images/pdf_file.png" width="24" height="24" /> </a>
     </td>
     <cfelse>
       <td align="right">
    -
     ...
     <td align="center"><a href="IRList_delete.cfm?ID=#IR_ID#"><img src="images/del.png" width="12" height="12" /></a></td>
 </tr>
 </cfoutput>
  </tbody>
</table><br />
...
<!--- <cfdirectory action="list" directory="C:\inetpub\websites\jrgm.biz\forms\photos\incident_reports\" name="incident_reports" recurse="true">  <cfquery name="incident_reports" dbtype="query">
    select  * 
    from incident_reports
 </cfquery> 


<br /><br /><cfdump var="#incident_reports#">
 --->   
  </div>  </div>
  <!-- to clear footer -->
</div>
