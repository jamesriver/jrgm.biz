...
<link rel="stylesheet" media="only screen and (max-device-width: 1024px)" href="https://www.jrgm.biz/ssl/admin/css/ipad.css" type="text/css" />
...
//echo $IncidentID . ' ' .  "<br>\n"; 
 ...
 <tr>
    ...
    <td align="center"><a href="IRList_delete.cfm?ID=<?php echo $ID ?>"><img src="images/del.png" width="12" height="12" /></a></td>
 </tr>
<?php
