...
Select * from Form_InjuryReport  ORDER BY CreatedDate DESC
 </cfquery>
 <tbody>
<cfoutput query="get_IR_List">
  <cfif Len(NatureOfInjury) GT 80>
      <cfset NatureOfInjury = Left(NatureOfInjury, 80) & '...'>
  </cfif>
  <tr>
	<td align="center">#IR_ID#</td>
	<td nowrap="nowrap">#InjuryRpt_Date#</td>
	<td align="left" >#InjuryTime#</td>
	<td align="left">#NatureOfInjury#</td>
	<td align="left" >#Employee#</td>
	<td align="left">#Position#</td>
	<td align="left">#Supervisor#</td>
	<td align="left">#Branch#</td>
	<td align="right">#ReportedDate#</td>
	...
	<!---td align="center"><a href="InjuryList_delete.cfm?ID=#IR_ID#"><img src="images/del.png" alt="" width="12" height="12" /></a></td--->
	</tr>
	</cfoutput>
 </tbody>
</table>
