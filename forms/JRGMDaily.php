...
$middlePart .="<tr>";
$middlePart .="<td style='width: 340px;'>";
$middlePart .="Electric connector plug";
$middlePart .="</td>";
$middlePart .="<td style='width: 10px;'>:</td>";
$middlePart .="<td style='width: 170px; text-align: center;'>";
$middlePart .="Fail";
...
$subject = 'DAILY VEHICLE INSPECTION MAIL'; 
$message = $msgBody; 
$headers = 'From: mcandler@jrgm.com' . "\r\n" . 'Reply-To: mcandler@jrgm.com' . "\r\n" . 'X-Mailer: PHP/' .
$headers  = 'MIME-Version: 1.0' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n"; 
phpversion();
mail($to, $subject, $message, $headers, '-fmcandler@jrgm.com');
...
<body>
	<div align="center" class="details_desc"><strong>Thank you. Your form has been submitted</strong></div>
</body>
                ...
                <div class="centrecontent_inner">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <label for="ras_NA">NA</label></div>
                                    ...
                                    <tr>
                                       <td class="performance">Coupler safety pin</td>
                      ...
                      <label for="bas_NA">NA</label> 
                                    ...
                                    <tr>
                                      <td class="performance">Electric connector plug</td>
