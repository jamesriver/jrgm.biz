...
$ReportedTo = trim($_POST['Reported_To']);
$NatureOfIncident = trim($_POST['nid']);

$OwnerName = trim($_POST['Owner_name']);
$OwnerPhoneNo = trim($_POST['Phone_number']);
$OwnerLicenseNo = trim($_POST['License_Other']);
$OwnerTypeOfVehicle = trim($_POST['Vehicle_type']);
$OwnerAddress = trim($_POST['Address']);
$InsuranceInfo = trim($_POST['Insurance']);
$DamegeDesc = trim($_POST['Damage_description']);
...
BO_IsFine='$BO_IsFine', BO_IsPayroll='$BO_IsPayroll', BO_Translator='$BO_Translator', BO_Fine='$BO_Fine', BO_EstimatedLoss='$BO_EstimatedLoss', BO_FinalLoss='$BO_FinalLoss',BO_Update='Complete', LicenseNo='$LicenseNo' , ReportedTo='$ReportedTo' , NatureOfIncident='$NatureOfIncident' , OwnerName='$OwnerName' , OwnerPhoneNo='$OwnerPhoneNo', OwnerLicenseNo='$OwnerLicenseNo' , OwnerTypeOfVehicle='$OwnerTypeOfVehicle' , OwnerAddress='$OwnerAddress' , InsuranceInfo='$InsuranceInfo' , DamegeDesc='$DamegeDesc' , ImmActionTaken='$ImmActionTaken' , EmployeeStatement='$EmployeeStatement' , WitnessStatement='$WitnessStatement' , BO_Injuries='$BO_Injuries',VehicleNumber='$VehicleNumber'  WHERE incidentRpt_ID = '$IncidentID' ";
