...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {    
    ...
    if (isset($_POST['btnSumit'])) {
        ...
        $sql_InserMember = "INSERT INTO Form_InjuryReport([InjuryRpt_ID],[InjuryRpt_Date],[InjuryTime],[Location],[Employee],[ReportedTo],[Position],[ReportedDate],[Supervisor]
               ...
               ,[IIC_OtherDamage],[IIC_FinalExamination],[IIC_ImmediateTreatment],[Branch]) 
        ...
        if ($_FILES['file']['name'][0] != "") {
            ...
            */
            //echo "enter"."<br/>";
            $varstring = str_replace('/', '', $InjuryRpt_Date);
   ...
   if (isset($_POST['btnSumit'])) {
       ...
       $msgBody .= "
       <a href='http://jrgm.biz/forms/injury_bo.php?id=".$InjuryRpt_ID."'>
