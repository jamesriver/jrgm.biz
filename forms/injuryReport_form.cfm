         ...
         <form action="" method="post" id="myform" class="vehicle_inventory" enctype="multipart/form-data" >
           <div id="centrecontent"> 
             ...
             <div class="centrecontent_inner">
               <div class="header"> Injury Report
               ...
               <table width="99%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                       ...
                       <td class="performance"><input type="text" name="today_Date" id="today_Date" size="24" data-bvalidator="required" value="#InjuryRpt_Date#" /></td>
                       <td class="performance"> Time </td>
                       <td class="performance"><input type="time" name="time" id="time" size="24" value="#InjuryTime#" /></td>
                     </tr>
                       <tr>
                       <td class="performance"> Location </td>
                       <td class="performance"><input name="Location" type="text" id="Location" size="24"  data-bvalidator="required" data-bvalidator-msg="Please Enter the Location of the Injury" value="#Location#" /></td>
                       <td class="performance"> Reported To </td>
                       <td class="performance"><input name="Reported_To" type="text" id="Reported_To" size="24"  data-bvalidator="required" data-bvalidator-msg="Who Was the Injury Reported To" value="#ReportedTo#"/></td>
                     </tr>
                       <tr>
                       <td class="performance"> Branch </td>
                       <td class="performance"><select name="Branch_Id" id="Branch_Id" style="width: 250px;" data-bvalidator="required" data-bvalidator-msg="Please Select Branch" onchange="javascript:__doPostBack();">
                           ...
                           <?php
                                          ...
                                          $str     = "
                                              <option value='Corporate' branch='Corporate'";
                                          if (isset($_REQUEST['Branch_Id']))
                           ...
                           <input type="hidden" name="Branch" id="Branch" size="24" readonly="true" value="#Branch#"/></td>
                       <td class="performance"> Date Reported </td>
                       <td class="performance"><input type="text" name="Report_date" id="Report_date" size="24"  data-bvalidator="required"  value="#ReportedDate#"/></td>
                     </tr>
                       <tr>
                       <td class="performance"> Employee </td>
                       <td class="performance"><select name="Employee_Id" id="Employee_Id" style="width: 250px;" data-bvalidator="required" data-bvalidator-msg="Please Enter the Employee Name" onchange="javascript:__doPostBackEmployee();">
                           ...
                           <input type="hidden" name="Employee_Name" id="Employee_Name" value="#Employee#" /></td>
                       <td class="performance"> Time Employee Began Work </td>
                       <td class="performance"><input type="time" name="BeganTime" id="BeganTime" size="24"  value="#BeganTime#"/></td>
                     </tr>
                       <tr>
                       <td class="performance"> Supervisor </td>
                       <td class="performance"><input type="text" name="Supervisor_Name" id="Supervisor_Name" value="#Supervisor#" /></td>
                     </tr>
                       <tr>
                       <td class="performance"> Position </td>
                       <td class="performance"><input type="text" name="Position" id="Position"  size="24" data-bvalidator="required" data-bvalidator-msg="Please Enter the Employee Position" value="#Position#"/></td>
                     </tr>
                     </table></td>
                 </tr>
               </table>
               ...
               <table width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td class="performance"><p><strong>Nature of Injury or Illness. Please be Specific:</strong></p>
                     <p>
                       <textarea name="nid" id="nid" cols="75" rows="5" data-bvalidator="required" data-bvalidator-msg="Please Enter the Nature of the Injury" >#NatureOfInjury#</textarea>
                     </p>
                     <p><strong>What Object Directly Caused Harm to Employee:</strong></p>
                     <p>
                       <textarea name="HarmObject" id="HarmObject" cols="75" rows="5" data-bvalidator="required" data-bvalidator-msg="Please Enter Object Directly Caused Harm to Employee.">#HarmObject#</textarea>
                     </p>
                     <p><strong>Immediate Action Taken:</strong></p>
                     <p>
                       <textarea name="Action_taken" id="Action_taken" cols="75" rows="5" data-bvalidator="required" data-bvalidator-msg="Please Enter the Immediate Action Taken." >#ImmActionTaken#</textarea>
                     </p>
                     <p><strong>Employee Statement:</strong></p>
                     <p>
                       <textarea name="Employee_statement" id="Employee_statement" cols="75" rows="5" data-bvalidator="required" data-bvalidator-msg="Please Enter the Employee Statement." >#EmployeeStatement#</textarea>
                     </p>
                     <p><strong>Witness Statement:</strong></p>
                     <p>
                       <textarea name="Witness_statement" id="Witness_statement" cols="75" rows="5" data-bvalidator="required" data-bvalidator-msg="Please Enter the Witness Statement.">#WitnessStatement#</textarea>
                     </p></td>
                 </tr>
               </table>
               <div class="spacer20"></div>
               <table width="99%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td valign="top"><table width="99%" border="0" cellpadding="0" cellspacing="0">
                       <tr>
                       <td nowrap="nowrap" class="vehicle_inventory"> Employee Address </td>
                       <td colspan="3" align="left" class="vehicle_inventory"><input name="EmployeeAddress" type="text" id="EmployeeAddress" size="75" value="#EmployeeAddress#" /></td>
                     </tr>
                       <tr>
                       <td nowrap="nowrap" class="vehicle_inventory"> Date of Birth </td>
                       <td class="performance"><input type="text" name="EmpDOB" id="EMPDOB" size="24" value="#EmpDOB#" /></td>
                       <td align="left" nowrap="nowrap" class="vehicle_inventory"> Phone Number </td>
                       <td class="performance"><input type="text" name="EmployeePhoneNo" id="EmployeePhoneNo" size="24" value="#EmployeePhoneNo#" /></td>
                     </tr>
                       <tr>
                       <td nowrap="nowrap" class="vehicle_inventory">Employee Gender</td>
                       <td colspan="3" align="left" class="vehicle_inventory"><div class="radio"> <input id="sex_Y" type="radio" name="sex" checked="checked"  value="M"
                                         <!---  <?php
                                             if ($EmployeeSex == "M") {
                           ...
                           <input id="sex_N" type="radio" name="sex" value="F"
                                         <!---  <?php
                                             ...
                                             ?> ---> 
                           />
                           <label for="sex_N"> Female </label>
                         </div></td>
                     </tr>
                       <tr>
                       <td nowrap="nowrap" class="vehicle_inventory"> Date of Hire </td>
                       <td class="performance"><input type="text" name="EmpDOH" id="EMPDOH" size="24" value="#EmpDOH#" /></td>
                       <td align="left" nowrap="nowrap" class="vehicle_inventory">&nbsp;</td>
                       <td class="performance">&nbsp;</td>
                     </tr>
                       <tr>
                       <td nowrap="nowrap" class="vehicle_inventory"> Upload Photos </td>
                       <td colspan="3" align="left" class="vehicle_inventory"><!--- <?php
                           ...
                           <tr class="dstable_subheader">
                               ...
                               <a href="photos/<!--- <?php echo $recordsetImgList->fields["ImageName"]->value?> --->"  > <img src="images/pdf.jpg" width="50px" height="50px" style="text-align:center" /> </a> 
                       ...
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> Were safety features bypassed? </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><div class="radio"> <input id="sf_Y" type="radio" name="SafetyFeature" value="Y"
                                         <!---  <?php
                                             if ($SafetyFeature == "Y") {
                                                echo "checked=\"checked\" ";
                                             }
                           ...
                           <input id="sf_N" type="radio" name="SafetyFeature" value="N"
                                          <!--- <?php
                                             ...
                                             ?> ---> 
                           />
                           <label for="sf_N"> No </label>
                         </div></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> Was employee given information on Panel of Physicians? </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><div class="radio"> <input id="pop_Y" type="radio" name="PanelofPhysicians" value="Y"
                                         <!---  <?php
                           ...
                           <input id="pop_N" type="radio" name="PanelofPhysicians" value="N"
                                         <!---  <?php
                                             ...
                                             ?> ---> 
                           />
                           <label for="pop_N"> No </label>
                         </div></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> Was employee given a medical release form? </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><div class="radio"> <input id="mrf_Y" type="radio" name="MedicalReleaseForm" value="Y"
                                          <!--- <?php
                           ...
                           <input id="mrf_N" type="radio" name="MedicalReleaseForm" value="N"
                                          <!--- <?php
                                             ...
                                             ?> ---> 
                           />
                           <label for="mrf_N"> No </label>
                         </div></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> Was employee doing something other than required duties at time of accident? </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><div class="radio"> <input id="dtoa_Y" type="radio" name="DutiesTOA" value="Y"
                                          <!--- <?php
                                             if ($DutiesTOA == "Y") {
                                                echo "checked=\"checked\" ";
                                             }
                           ...
                           <input id="dtoa_N" type="radio" name="DutiesTOA" value="N"
                                         <!---  <?php
                                             ...
                                             ?> ---> 
                           />
                           <label for="dtoa_N"> No </label>
                         </div></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> If so, what and why? </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><textarea name="DutiesTOAYes" id="DutiesTOAYes" rows="3" cols="45">#DutiesTOAYes#</textarea></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> Could this accident have been prevented? </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><div class="radio"> <input id="ap_Y" type="radio" name="AccidentPrev" value="Y"
                                          <!--- <?php
                                             if ($AccidentPrev == "Y") {
                                                echo "checked=\"checked\" ";
                                             }
                           ...
                           <input id="ap_N" type="radio" name="AccidentPrev" value="N"
                                          <!--- <?php
                                             ...
                                             ?> ---> 
                           />
                           <label for="ap_N"> No </label>
                         </div></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"> Please explain </td>
                       <td colspan="2" align="left" class="vehicle_inventory"><textarea name="Explain" id="Explain" rows="3" cols="45" value="#Explain#"></textarea></td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"><a href="#">Doctor Form</a></td>
                       <td colspan="2" align="left" class="vehicle_inventory">&nbsp;</td>
                     </tr>
                       <tr>
                       <td colspan="2" align="left" class="vehicle_inventory"><a href="#">Medical Papers</a></td>
                       <td colspan="2" align="left" class="vehicle_inventory">&nbsp;</td>
                     </tr>
                       <!--<tr>
               ...
               <br />
               <br />
               <p> <strong> INJURY INVESTIGATION CHECKLIST </strong> </p>
               <div class="checkbox">
                 <input id="check1" type="checkbox" name="mvb" value="check" />
                 <label for="check1">Make a visual check to make sure the scene is protected against further injury.</label>
                 <br/>
               ...
               <div class="checkbox"> <input id="check11" type="checkbox" name="checkpolice" value="check"/>
