                     ...
                     <tr>
                        <td valign="top">
                           <table width="99%" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <td colspan="2" align="left" class="vehicle_inventory">
                              <textarea name="Note" id="Note" rows="3" cols="45" value="<?php echo $Note;?>"></textarea>
                              </td>
                              </tr>
                              <tr>
                                 <td nowrap="nowrap" class="vehicle_inventory">
                                    Upload Files<br /><span class="ui-state-error-text">There is amaximum of 2mb file limit.</span>
                                 </td>
                                 <td colspan="3" align="left" class="vehicle_inventory">
                                    <?php
