    ...
    <form action="" method="POST" id="myform" class="vehicle_inventory"  enctype="multipart/form-data">
                    ...
                    <td valign="top">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                       <tr>
                          ...
                          <td class="performance">
                            #InjuryRpt_Date#
                            <input  type="hidden" id="hdInjuryRpt_Date" name="hdInjuryRpt_Date" value=" #InjuryRpt_Date#"/>
                         </td>
                        </tr>
                        <tr>
                          <td class="performance">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="performance">
                      ...
                      <p>
                        <textarea name="NatureOfInjury" id="NatureOfInjury" cols="75" rows="5">#NatureOfInjury#</textarea>
                      ...
                      <p>
                        <textarea name="HarmObject" id="HarmObject" cols="75" rows="5">#HarmObject#</textarea>
                      </p>
                      <p>
                        <strong>
                      ...
                      <p>
                       <textarea name="Action_taken" id="Action_taken" cols="75" rows="5" >#ImmActionTaken#</textarea>
                      </p>
                      <p>
                        <strong>
                          Employee Statement:
                      ...
                      <p>
                        <textarea name="Employee_statement" id="Employee_statement" cols="75" rows="5">#EmployeeStatement#</textarea>
                      </p>
                      <p>
                        <strong>
                          Witness Statement:
                      ...
                      <p>
                        <textarea name="Witness_statement" id="Witness_statement" cols="75" rows="5">#WitnessStatement#</textarea>
                      </p>
                    </td>
                  </tr>
                </table>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="performance" colspan="3">
                           <input name="EmployeeAddress" type="text" id="EmployeeAddress" size="75" value="#EmployeeAddress#" />
                          </td>
                        </tr>
                        <tr>
                          <td nowrap="nowrap" class="vehicle_inventory">
                          ...
                          <td class="performance">
                           <input type="text" name="EmpDOB" id="EMPDOB" size="24" value="#EmpDOB#" />
                          </td>
                          <td align="left" nowrap="nowrap" class="vehicle_inventory">
                            Phone Number
                          </td>
                          <td align="left" class="vehicle_inventory">
                            <input type="text" name="EmployeePhoneNo" id="EmployeePhoneNo" size="24" value="#EmployeePhoneNo#" />
                          </td>
                        </tr>
                        <tr>
                         <td align="left" nowrap="nowrap" class="vehicle_inventory">
                        ...
                        <tr>
                          ...
                          <td colspan="3" align="left" class="vehicle_inventory">
                            <input type="text" name="EmpDOH" id="EMPDOH" size="24" value="#EmpDOH#" />
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colspan="2" align="left" class="vehicle_inventory">
                            <textarea name="DutiesTOAYes" id="DutiesTOAYes" rows="3" cols="45">#DutiesTOAYes#</textarea>
                          </td>
                        </tr>
                        <tr>
                           <td nowrap="nowrap" class="vehicle_inventory" colspan="2">
                        ...
                        <tr>
                          ...
                          <td colspan="2" align="left" class="vehicle_inventory">
                            <textarea name="Explain" id="Explain" rows="3" cols="45" >#Explain#</textarea>
      ...
      <table width="95%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td class="performance">
            <input type="text" name="BO_WorkerCompNo" id="BO_WorkerCompNo"  value="#BO_WorkerCompNo#" size="24" />
          </td>
        </tr>
        <tr>
          <td class="performance">
        ...
        <tr>
          ...
          <td class="performance">
            <textarea name="BO_ListRestrictions" id="BO_ListRestrictions" rows="5" cols="45">#BO_ListRestrictions#</textarea>
          </td>
        </tr>
        <tr>
          <td class="performance">
        ...
        <tr>
          ...
          <td class="performance">
            <textarea name="BO_Facility" id="BO_Facility" rows="5" cols="45">#BO_Facility#</textarea>
          </td>
        </tr>
        <tr>
          <td class="performance">
          ...
          <td class="performance">
            <input type="text" name="BO_Physician" id="BO_Physician"  value="#BO_Physician#" size="50" />
          </td>
        </tr>
        <tr>
          <td nowrap="nowrap" class="vehicle_inventory">
