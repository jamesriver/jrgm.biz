...
$pdf->displayMultilineContent($Location, 65, 10);
...
$pdf->SetFont('Arial', '', 12);
$pdf->displayMultilineContent($NatureOfInjury, 0, 10);
...
$pdf->SetFont('Arial', '', 12);
$pdf->displayMultilineContent($HarmObject, 0, 10);
...
$pdf->displayMultilineContent($DutiesTOAYes, 0, 10);
...
$pdf->displayMultilineContent($Explain, 0, 10);
...
if($BO_Restrictions != "N") {
    $pdf->Cell(70, 10, "List restrictions");
    $pdf->displayMultilineContent($BO_ListRestrictions, 0, 10);
}

$pdf->Cell(70, 10, "Is employee on light duty?");
...
$pdf->displayMultilineContent($BO_Facility, 0, 10);
