 <CFIF CGI.HTTP_HOST DOES NOT CONTAIN "www.jrgm.biz">
<cflocation url="https://www.jrgm.biz/indexnew.cfm" addtoken="no">
</CFIF>  
...
<div class="logo">
	<a href="indexnew.cfm">
	<span class="logo-header-left">JAMES RIVER</span> <span class="logo-header-right">GROUNDS MANAGEMENT</span>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	 <form action="dologinnew.cfm" method="post">
